...
/obj/item/chems/glass/beaker/vial/random_podchem/Initialize()
	...
	var/reagent_type = pick(/datum/reagent/random, /datum/reagent/toxin/zombie/science, /datum/reagent/retrovirals)
...
/obj/structure/backup_server/attackby(obj/item/W, mob/user, var/click_params)
	if(isCrowbar(W))
		...
		drive.origin_tech = "{'[TECH_DATA]':[rand(4,5)],'[TECH_ENGINEERING]':[rand(4,5)],'[TECH_PHORON]':[rand(4,5)],'[TECH_COMBAT]':[rand(2,5)],'[TECH_ESOTERIC]':[rand(0,6)]}"
