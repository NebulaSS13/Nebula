/datum/job/chief_engineer
	title = "Public Maintenance Director"
	head_position = 1
	...
	alt_titles = list("Public Works Director", "Maintenance Manager")
...
/datum/job/engineer
	...
	alt_titles = list("Civil Engineer", "Public Works Staff", "Electrician", "Firefighter")
