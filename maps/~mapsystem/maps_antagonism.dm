/datum/map
	var/list/potential_theft_targets = list(
		...
		"a captain's jumpsuit"               = /obj/item/clothing/under/jumpsuit/captain,
		...
		"a chief science officer's jumpsuit" = /obj/item/clothing/under/jumpsuit/research_director,
		"a chief engineer's jumpsuit"        = /obj/item/clothing/under/jumpsuit/chief_engineer,
		"a chief medical officer's jumpsuit" = /obj/item/clothing/under/jumpsuit/chief_medical_officer,
		"a head of security's jumpsuit"      = /obj/item/clothing/under/jumpsuit/head_of_security,
		"a head of personnel's jumpsuit"     = /obj/item/clothing/under/jumpsuit/head_of_personnel,
