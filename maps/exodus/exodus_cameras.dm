var/global/const/CHANNEL_COMMAND = "Command"
var/global/const/CHANNEL_ENGINE  = "Engine"
var/global/const/CHANNEL_ENGINEERING_OUTPOST = "Engineering Outpost"
//
// Cameras
//
...
/obj/machinery/camera/network/command
	preset_channels = list(CHANNEL_COMMAND)
	initial_access = list(access_heads)

/obj/machinery/camera/network/crescent
	preset_channels = list(CHANNEL_CRESCENT)

/obj/machinery/camera/network/engine
	preset_channels = list(CHANNEL_ENGINE)
	initial_access = list(access_engine)

/obj/machinery/camera/network/engineering_outpost
	preset_channels = list(CHANNEL_ENGINEERING_OUTPOST)
	initial_access = list(access_engine)
