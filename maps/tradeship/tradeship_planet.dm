...
/datum/map_template/planetoid/neutralia
	...
	mappaths              = list(
		"maps/tradeship/locations/neutralia-1.dmm",
		"maps/tradeship/locations/neutralia-2.dmm",
		"maps/tradeship/locations/neutralia-3.dmm",
		"maps/tradeship/locations/neutralia-4.dmm",
	)
