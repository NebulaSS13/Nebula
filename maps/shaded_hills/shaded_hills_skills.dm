...
/decl/hierarchy/skill/medical/medical
	...
	levels = list(
		...
		"Basic"       = "You are an apprentice healer. You can stop bleeding, perform chest compressions and mouth-to-mouth resuscitation, apply a splint, take someone's pulse, apply trauma and burn treatments. You probably know that antitoxins help poisoning. You've been briefed on the symptoms of common emergencies like a punctured lung, appendicitis, alcohol poisoning, or broken bones, and though you can't treat them, you know that they need a doctor's attention. You can recognize most emergencies as emergencies and safely stabilize and transport a patient.",
...
/decl/hierarchy/skill/medical/anatomy
	...
	levels = list(
		...
		"Trained"     = "You have some training in anatomy. Diagnosing broken bones, damaged ligaments, arrow wounds, and other trauma is straightforward for you. You can splint limbs with a good chance of success and you know how to perform chest compressions and mouth-to-mouth resuscitation. Surgery is still outside your training.<br>- You can do surgery (requires Trained Medicine skill too) but you are very likely to fail at every step. Its speed increases with level.",
