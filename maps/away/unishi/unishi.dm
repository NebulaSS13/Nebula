...
/obj/machinery/power/supermatter/randomsample/Initialize()
	...
	foreign_gas_release_modifier = rand(0, 100000)		//Higher == less foreign gas released by reaction
...
/obj/machinery/power/supermatter/inert
	...
	foreign_gas_release_modifier = 100000000000
