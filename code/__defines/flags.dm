...
#define ITEM_FLAG_STAMP                     BITFLAG(16) // Can this item be used to stamp paperwork? Also requires a "stamp" state in the item icon if you want it to render something.
