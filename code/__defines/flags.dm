...
#define ATOM_FLAG_SHOW_REAGENT_NAME       BITFLAG(7)  // Reagent presentation name is attached to the atom name
#define ATOM_FLAG_CAN_BE_PAINTED          BITFLAG(8)  // Can be painted using a paint sprayer or similar.
#define ATOM_FLAG_SHIELD_CONTENTS         BITFLAG(9)  // Protects contents from some global effects (Solar storms)
#define ATOM_FLAG_INSULATED_CONTAINER     BITFLAG(10) // Set on reagent containers to prevent their contents changing temperature.
