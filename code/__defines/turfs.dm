...
#define TURF_IS_FRAGILE         BITFLAG(7)
#define TURF_ACID_IMMUNE        BITFLAG(8)
#define TURF_IS_WET             BITFLAG(9)

//Used for floor/wall smoothing
#define SMOOTH_SELF      0 // Smooth based on flooring logic.
#define SMOOTH_ALL       1 // Smooth with everything.
#define SMOOTH_WHITELIST 2 // Smooth with none but a whitelist of subtypes
...
#define EXT_EDGE_LAVA          (41 * EXT_LAYER_CONSTANT)
