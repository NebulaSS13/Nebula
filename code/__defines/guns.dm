...
#define CALIBER_ALIEN            "anomalous"
...
//Gun loading types
#define SINGLE_CASING BITFLAG(0) //The gun only accepts ammo_casings. ammo_magazines should never have this as their mag_type.
#define SPEEDLOADER   BITFLAG(1) //Transfers casings from the mag to the gun when used.
#define MAGAZINE      BITFLAG(2) //The magazine item itself goes inside the gun
