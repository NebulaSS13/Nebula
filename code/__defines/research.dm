...
#define MOLES_PER_SHEET 10

#define MATTER_STATE_NONE  -1
#define MATTER_STATE_SOLID  0
#define MATTER_STATE_LIQUID 1
#define MATTER_STATE_GAS    2
#define MATTER_STATE_AFLAME 3
