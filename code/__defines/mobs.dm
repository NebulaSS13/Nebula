...
#define MOB_ICON_NO_LIVING_STATE BITFLAG(0)
#define MOB_ICON_NO_DEAD_STATE   BITFLAG(1)
#define MOB_ICON_NO_REST_STATE   BITFLAG(2)
#define MOB_ICON_NO_SLEEP_STATE  BITFLAG(3)
#define MOB_ICON_NO_GIB_STATE    BITFLAG(4)
#define MOB_ICON_NO_EYES_STATE   BITFLAG(5)
#define MOB_ICON_SKIP_ALL (MOB_ICON_NO_LIVING_STATE|MOB_ICON_NO_DEAD_STATE|MOB_ICON_NO_REST_STATE|MOB_ICON_NO_SLEEP_STATE|MOB_ICON_NO_GIB_STATE|MOB_ICON_NO_EYES_STATE)
