...
#define ACCESS_TYPE_CENTCOM BITFLAG(1)
#define ACCESS_TYPE_STATION BITFLAG(2)
#define ACCESS_TYPE_ANTAG   BITFLAG(3)
#define ACCESS_TYPE_ALL (ACCESS_TYPE_NONE|ACCESS_TYPE_CENTCOM|ACCESS_TYPE_STATION|ACCESS_TYPE_ANTAG)
