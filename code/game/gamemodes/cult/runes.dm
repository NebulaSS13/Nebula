...
/obj/effect/rune/ajorney/cast(var/mob/living/user)
	...
	announce_ghost_joinleave(user.ghostize(CORPSE_CAN_REENTER), 1, "You feel that they had to use some [pick("dark", "black", "blood", "forgotten", "forbidden")] magic to [pick("invade", "disturb", "disrupt", "infest", "taint", "spoil", "blight")] this place!")
