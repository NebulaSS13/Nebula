/obj/item/clothing/jewelry/ring/aura_ring
	var/obj/aura/granted_aura

/obj/item/clothing/jewelry/ring/aura_ring/equipped(var/mob/living/L, var/slot)
	..()
	if(granted_aura && slot == slot_gloves_str)
		L.add_aura(granted_aura)

/obj/item/clothing/jewelry/ring/aura_ring/dropped(var/mob/living/L)
	..()
	if(granted_aura)
		L.remove_aura(granted_aura)

/obj/item/clothing/jewelry/ring/aura_ring/Destroy()
	QDEL_NULL(granted_aura)
	. = ..()

/obj/item/clothing/jewelry/ring/aura_ring/talisman_of_starborn
...
/obj/item/clothing/jewelry/ring/aura_ring/talisman_of_starborn/Initialize()
	. = ..()
	granted_aura = new /obj/aura/starborn()

/obj/item/clothing/jewelry/ring/aura_ring/talisman_of_blueforged
	name = "Talisman of the Blueforged"
	desc = "The gem on this ring is quite peculiar..."
	icon = 'icons/clothing/rings/ring_blue.dmi'

/obj/item/clothing/jewelry/ring/aura_ring/talisman_of_blueforged/Initialize()
	. = ..()
	granted_aura = new /obj/aura/blueforge_aura()

/obj/item/clothing/jewelry/ring/aura_ring/talisman_of_shadowling
...
/obj/item/clothing/jewelry/ring/aura_ring/talisman_of_shadowling/Initialize()
	. = ..()
