...
/datum/antagonist/ninja/equip(var/mob/living/carbon/human/player)
	...
	if(.)
		...
		player.equip_to_slot_or_del(R, BP_L_EAR)
		player.equip_to_slot_or_del(new /obj/item/clothing/under/color/black(player), BP_CHEST)
		player.equip_to_slot_or_del(new /obj/item/flashlight(player), BP_GROIN)
