...
/obj/machinery/icecream_vat/proc/get_ingredient_list(var/type)
	switch(type)
		if(ICECREAM_CHOCOLATE)
			return list(/decl/material/liquid/drink/milk, /decl/material/liquid/water, /decl/material/liquid/nutriment/coco)
		if(ICECREAM_STRAWBERRY)
			return list(/decl/material/liquid/drink/milk, /decl/material/liquid/water, /decl/material/liquid/drink/juice/berry)
		if(ICECREAM_BLUE)
			return list(/decl/material/liquid/drink/milk, /decl/material/liquid/water, /decl/material/liquid/alcohol/bluecuracao)
		if(ICECREAM_CHERRY)
			return list(/decl/material/liquid/drink/milk, /decl/material/liquid/water, /decl/material/liquid/nutriment/cherryjelly)
		if(ICECREAM_BANANA)
			return list(/decl/material/liquid/drink/milk, /decl/material/liquid/water, /decl/material/liquid/drink/juice/banana)
		if(CONE_WAFFLE)
		...
		if(CONE_CHOC)
			...
			return list(/decl/material/liquid/drink/milk, /decl/material/liquid/water)
