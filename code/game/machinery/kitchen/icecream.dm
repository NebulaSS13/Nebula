...
/obj/machinery/icecream_vat/proc/get_ingredient_list(var/type)
	switch(type)
		if(ICECREAM_CHOCOLATE)
			return list(/decl/material/drink/milk, MAT_WATER, /decl/material/nutriment/coco)
		if(ICECREAM_STRAWBERRY)
			return list(/decl/material/drink/milk, MAT_WATER, /decl/material/drink/juice/berry)
		if(ICECREAM_BLUE)
			return list(/decl/material/drink/milk, MAT_WATER, /decl/material/ethanol/singulo)
		if(ICECREAM_CHERRY)
			return list(/decl/material/drink/milk, MAT_WATER, /decl/material/nutriment/cherryjelly)
		if(ICECREAM_BANANA)
			return list(/decl/material/drink/milk, MAT_WATER, /decl/material/drink/juice/banana)
		if(CONE_WAFFLE)
		...
		if(CONE_CHOC)
			...
			return list(/decl/material/drink/milk, MAT_WATER)
