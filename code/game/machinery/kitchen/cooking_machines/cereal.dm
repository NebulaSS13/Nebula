...
/obj/machinery/cooker/cereal/change_product_strings(var/obj/item/chems/food/snacks/product)
	. = ..()
	product.SetName("box of [cooking_obj.name] cereal")

/obj/machinery/cooker/cereal/change_product_appearance(var/obj/item/chems/food/snacks/product)
