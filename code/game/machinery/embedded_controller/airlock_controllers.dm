...
/obj/machinery/embedded_controller/radio/airlock/advanced_airlock_controller/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = NANOUI_FOCUS, var/datum/nanoui/master_ui = null, var/datum/topic_state/state = GLOB.default_state)
	var/data[0]
...
/obj/machinery/embedded_controller/radio/airlock/airlock_controller/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = NANOUI_FOCUS, var/datum/nanoui/master_ui = null, var/datum/topic_state/state = GLOB.default_state)
	var/data[0]
...
/obj/machinery/embedded_controller/radio/airlock/access_controller/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = NANOUI_FOCUS, var/datum/nanoui/master_ui = null, var/datum/topic_state/state = GLOB.default_state)
	var/data[0]
