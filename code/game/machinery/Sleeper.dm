/obj/machinery/sleeper
	...
	var/list/base_chemicals = list("Inaprovaline" = /datum/reagent/inaprovaline, "Soporific" = /datum/reagent/soporific, "Painkillers" = /datum/reagent/painkillers, "Dexalin" = /datum/reagent/dexalin)
