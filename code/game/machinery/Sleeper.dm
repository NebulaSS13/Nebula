/obj/machinery/sleeper
	...
	var/list/base_chemicals = list("Inaprovaline" = /datum/reagent/inaprovaline, "Sedatives" = /datum/reagent/sedatives, "Painkillers" = /datum/reagent/painkillers, "Oxygen" = /datum/reagent/oxygen)
