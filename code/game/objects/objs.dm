...
/obj/proc/get_matter_amount_modifier()
	. = round(w_class * BASE_OBJECT_MATTER_MULTPLIER,0.5) //there was a CEILING() I removed it so that it calculates correctly (modifier was the same for small and normal items)
