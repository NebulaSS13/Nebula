#define RANDOM_SCRUBS new/datum/atom_creator/weighted(list( \
				list(/obj/item/clothing/under/jumpsuit/medical/scrubs, /obj/item/clothing/head/surgery), \
				list(/obj/item/clothing/under/jumpsuit/medical/scrubs/blue, /obj/item/clothing/head/surgery/blue), \
				list(/obj/item/clothing/under/jumpsuit/medical/scrubs/green, /obj/item/clothing/head/surgery/green), \
				list(/obj/item/clothing/under/jumpsuit/medical/scrubs/purple, /obj/item/clothing/head/surgery/purple), \
				list(/obj/item/clothing/under/jumpsuit/medical/scrubs/black, /obj/item/clothing/head/surgery/black), \
				list(/obj/item/clothing/under/jumpsuit/medical/scrubs/lilac, /obj/item/clothing/head/surgery/lilac), \
				list(/obj/item/clothing/under/jumpsuit/medical/scrubs/teal, /obj/item/clothing/head/surgery/teal), \
				list(/obj/item/clothing/under/jumpsuit/medical/scrubs/heliodor, /obj/item/clothing/head/surgery/heliodor), \
				list(/obj/item/clothing/under/jumpsuit/medical/scrubs/navyblue, /obj/item/clothing/head/surgery/navyblue)\
			) \
		)
...
/obj/structure/closet/secure_closet/medical3/WillContain()
	return list(
		...
		/obj/item/clothing/under/jumpsuit/medical,
...
/obj/structure/closet/secure_closet/cmo/WillContain()
	return list(
		...
		/obj/item/clothing/shoes/color/white,
		/obj/item/clothing/under/jumpsuit/chief_medical_officer,
...
/obj/structure/closet/secure_closet/counselor/WillContain()
	return list(
		/obj/item/clothing/under/jumpsuit/psych,
...
/obj/structure/closet/secure_closet/virology/WillContain()
	return list(
		...
		/obj/item/storage/box/masks,
		/obj/item/storage/box/gloves,
		/obj/item/clothing/under/jumpsuit/virologist,
		/obj/item/clothing/shoes/color/white,
