/client/proc/spawn_tanktransferbomb()
	...
	var/p = input("Enter hydrogen amount (mol):","Hydrogen", initial(proto.hydrogen_amt)) as num|null
	if(p == null) return
...
/obj/effect/spawner/newbomb/Initialize()
	...
	var/obj/item/tank/hydrogen/PT = new(V)
	...
	PT.valve_welded = 1
	PT.air_contents.gas[MAT_HYDROGEN] = hydrogen_amt
	PT.air_contents.gas[MAT_CO2] = carbon_amt
	PT.air_contents.total_moles = hydrogen_amt + carbon_amt
	PT.air_contents.temperature = MINIMUM_BURN_TEMPERATURE+1
	PT.air_contents.update_values()

	OT.valve_welded = 1
	OT.air_contents.gas[MAT_OXYGEN] = oxygen_amt
	OT.air_contents.total_moles = oxygen_amt
	OT.air_contents.temperature = MINIMUM_BURN_TEMPERATURE+1
...
/obj/effect/spawner/onetankbomb/Initialize()
	..()
	var/type = pick(/obj/item/tank/hydrogen/onetankbomb, /obj/item/tank/oxygen/onetankbomb)
	new type(src.loc)
