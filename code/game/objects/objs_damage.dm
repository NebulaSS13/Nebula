 ...
 */
/obj/proc/is_damaged()
	return can_take_damage() && (health < get_max_health())

/**
	Returns TRUE if this object can take damage.
 */
/obj/proc/can_take_damage()
	return (health != ITEM_HEALTH_NO_DAMAGE) && (get_max_health() != ITEM_HEALTH_NO_DAMAGE)

/**
	Returns the percentage of health remaining for this object.
 */
/obj/proc/get_percent_health()
	return can_take_damage()? round((health * 100)/get_max_health(), HEALTH_ROUNDING) : 100
