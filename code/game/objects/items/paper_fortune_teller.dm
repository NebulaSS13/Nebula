...
/obj/item/paper_fortune_teller/proc/alternate(var/amount, var/mob/user)
	busy = TRUE
...
/obj/item/paper_fortune_teller/proc/alternate_by_color(var/color_word, var/mob/user)
	alternate(length(color_word), user)

/obj/item/paper_fortune_teller/proc/alternate_by_number(var/number, var/mob/user)
