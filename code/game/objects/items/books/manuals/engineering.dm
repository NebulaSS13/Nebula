...
/obj/item/book/manual/engineering_hacking/Initialize()
	. = ..()
	var/datum/codex_entry/hacking/hacking_entry = SScodex.get_codex_entry("hacking")
	dat = {"<html>
				<head>
				<style>
				h1 {font-size: 18px; margin: 15px 0px 5px;}
