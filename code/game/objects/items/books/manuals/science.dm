...
/obj/item/book/manual/research_and_development
	...
	dat = {"<html>
				...
				<h2>Protolathe</h2>
				This machine is an advanced form of the Autolathe that produce non-circuit designs. Unlike the Autolathe, it can use processed metal, glass, metallic hydrogen, silver, gold, and diamonds along with a variety of chemicals to produce devices.
