/obj/item/stock_parts/circuitboard/pacman
	...
	board_type = "machine"
	origin_tech = "{'" + TECH_DATA + "':3,'" + TECH_POWER + "':3,'" + TECH_PHORON + "':3,'" + TECH_ENGINEERING + "':3}"
	req_components = list(
...
/obj/item/stock_parts/circuitboard/pacman/super
	...
	origin_tech = "{'" + TECH_DATA + "':3,'" + TECH_POWER + "':4,'" + TECH_ENGINEERING + "':4}"
...
/obj/item/stock_parts/circuitboard/pacman/super/potato
	...
	origin_tech = "{'" + TECH_DATA + "':3,'" + TECH_POWER + "':5,'" + TECH_ENGINEERING + "':4}"

/obj/item/stock_parts/circuitboard/pacman/mrs
	name = T_BOARD("MRSPACMAN-type generator")
	build_path = /obj/machinery/power/port_gen/pacman/mrs
	origin_tech = "{'" + TECH_DATA + "':3,'" + TECH_POWER + "':5,'" + TECH_ENGINEERING + "':5}"
