...
/obj/item/grenade/chem_grenade/metalfoam/Initialize()
	...
	B1.reagents.add_reagent_by_id(/decl/material/solid/metal/aluminium, 30)
	B2.reagents.add_reagent_by_id(/decl/material/liquid/foaming_agent, 10)
	B2.reagents.add_reagent_by_id(/decl/material/liquid/acid/polyacid, 10)
...
/obj/item/grenade/chem_grenade/incendiary/Initialize()
	...
	var/obj/item/chems/glass/beaker/B1 = new(src)
	var/obj/item/chems/glass/beaker/B2 = new(src)
	B1.reagents.add_reagent_by_id(/decl/material/solid/metal/aluminium, 15)
	B1.reagents.add_reagent_by_id(/decl/material/liquid/fuel, 15)
	B2.reagents.add_reagent_by_id(/decl/material/solid/metal/aluminium, 15)
	B2.reagents.add_reagent_by_id(/decl/material/liquid/acid, 15)
	detonator = new/obj/item/assembly_holder/timer_igniter(src)
	beakers += B1
	beakers += B2
	update_icon()
...
/obj/item/grenade/chem_grenade/antiweed/Initialize()
	...
	var/obj/item/chems/glass/beaker/B1 = new(src)
	var/obj/item/chems/glass/beaker/B2 = new(src)
	B1.reagents.add_reagent_by_id(/decl/material/liquid/weedkiller, 25)
	B1.reagents.add_reagent_by_id(/decl/material/solid/potassium, 25)
	B2.reagents.add_reagent_by_id(/decl/material/solid/phosphorus, 25)
	B2.reagents.add_reagent_by_id(/decl/material/liquid/nutriment/sugar, 25)
	detonator = new/obj/item/assembly_holder/timer_igniter(src)
	beakers += B1
	beakers += B2
	update_icon()
...
/obj/item/grenade/chem_grenade/cleaner/Initialize()
	...
	var/obj/item/chems/glass/beaker/B1 = new(src)
	var/obj/item/chems/glass/beaker/B2 = new(src)
	B1.reagents.add_reagent_by_id(/decl/material/liquid/surfactant, 40)
	B2.reagents.add_reagent_by_id(/decl/material/liquid/water, 40)
	B2.reagents.add_reagent_by_id(/decl/material/liquid/cleaner, 10)
	detonator = new/obj/item/assembly_holder/timer_igniter(src)
	beakers += B1
	beakers += B2
	update_icon()
...
/obj/item/grenade/chem_grenade/teargas/Initialize()
	...
	B1.reagents.add_reagent_by_id(/decl/material/solid/phosphorus, 40)
	B1.reagents.add_reagent_by_id(/decl/material/solid/potassium, 40)
	B1.reagents.add_reagent_by_id(/decl/material/liquid/capsaicin/condensed, 40)
	B2.reagents.add_reagent_by_id(/decl/material/liquid/nutriment/sugar, 40)
	B2.reagents.add_reagent_by_id(/decl/material/liquid/capsaicin/condensed, 80)
	detonator = new/obj/item/assembly_holder/timer_igniter(src)
	beakers += B1
	beakers += B2
	update_icon()
...
/obj/item/grenade/chem_grenade/water/Initialize()
	...
	var/obj/item/chems/glass/beaker/B1 = new(src)
	var/obj/item/chems/glass/beaker/B2 = new(src)
	B1.reagents.add_reagent_by_id(/decl/material/liquid/water, 40)
	B2.reagents.add_reagent_by_id(/decl/material/liquid/water, 40)
	detonator = new/obj/item/assembly_holder/timer_igniter(src)
	beakers += B1
	beakers += B2
