...
/obj/item/energy/get_autopsy_descriptors()
	. = ..()
	if(active)
		. += "made of pure energy"

/obj/item/energy/can_embed()
	return FALSE
	
/obj/item/energy/Initialize()
	. = ..()
	if(active)
		active = FALSE
		activate()
...
/obj/item/energy/on_update_icon()
	. = ..()
	if(active)
...
/obj/item/energy/proc/activate(mob/living/user)
	if(active)
		return
	active = TRUE
	force = active_force
...
/obj/item/energy/proc/deactivate(mob/living/user)
	if(!active)
		return
	active = FALSE
	force = initial(force)
...
/obj/item/energy/attack_self(mob/living/user)
	if(active)
...
/obj/item/energy/get_storage_cost()
...
/obj/item/energy/axe/deactivate(mob/living/user)
	. = ..()
...
/obj/item/energy/sword/Initialize()
	if(!blade_color)
...
/obj/item/energy/sword/green
	blade_color = "green"

/obj/item/energy/sword/red
	blade_color = "red"

/obj/item/energy/sword/red/activated/Initialize()
	. = ..()
	activate()

/obj/item/energy/sword/blue
	blade_color = "blue"

/obj/item/energy/sword/purple
	blade_color = "purple"

/obj/item/energy/sword/dropped(var/mob/user)
	..()
	if(!istype(loc,/mob))
		deactivate(user)

/obj/item/energy/sword/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack")
	if(.)
...
/obj/item/energy/sword/get_parry_chance(mob/user)
	return active ? ..() : 0
...
/obj/item/energy/sword/pirate/activated/Initialize()
	. = ..()
	activate()
/*
 *Energy Blade
...
/obj/item/energy/blade/Initialize()
	. = ..()
...
/obj/item/energy/blade/Destroy()
	STOP_PROCESSING(SSobj, src)
	. = ..()

/obj/item/energy/blade/is_special_cutting_tool(var/high_power)
	return TRUE

/obj/item/energy/blade/get_storage_cost()
	return ITEM_SIZE_NO_CONTAINER

/obj/item/energy/blade/attack_self(mob/user)
	user.drop_from_inventory(src)

/obj/item/energy/blade/dropped()
	..()
	QDEL_IN(src, 0)

/obj/item/energy/blade/Process()
