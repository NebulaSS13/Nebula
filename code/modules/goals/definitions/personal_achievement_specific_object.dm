...
/datum/goal/achievement/specific_object/food/New()
	...
	blacklisted_objects |= subtypesof(/obj/item/chems/food/snacks/amanita_pie)
	blacklisted_objects |= subtypesof(/obj/item/chems/food/snacks/amanitajelly)
	blacklisted_objects |= subtypesof(/obj/item/chems/food/snacks/canned/caviar/true)
	blacklisted_objects |= subtypesof(/obj/item/chems/food/snacks/old)
	..()
