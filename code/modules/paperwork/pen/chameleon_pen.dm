...
/obj/item/pen/chameleon/verb/set_colour()
	...
	if(selected_type)
		switch(selected_type)
			if("Yellow")
				set_ink_color(COLOR_YELLOW, "yellow")
			if("Green")
				set_ink_color(COLOR_LIME,   "green")
			if("Pink")
				set_ink_color(COLOR_PINK,   "pink")
			if("Blue")
				set_ink_color(COLOR_BLUE,   "blue")
			if("Orange")
				set_ink_color(COLOR_ORANGE, "orange")
			if("Cyan")
				set_ink_color(COLOR_CYAN,   "cyan")
			if("Red")
				set_ink_color(COLOR_RED,    "red")
			if("Invisible")
				set_ink_color(COLOR_WHITE,  "transluscent")
			else
				set_ink_color(COLOR_BLACK,  "black")
