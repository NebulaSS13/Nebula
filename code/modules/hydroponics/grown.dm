...
/obj/item/chems/food/snacks/grown/New(newloc,planttype)
	if(planttype)
		plantname = planttype
	..()
	fill_reagents()

/obj/item/chems/food/snacks/grown/Initialize()
	. = ..()
	if(!SSplants)
...
/obj/item/chems/food/snacks/fruit_slice/New(var/newloc, var/datum/seed/S)
	..(newloc)
