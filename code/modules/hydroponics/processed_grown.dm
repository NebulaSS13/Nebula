/obj/item/chems/food/processed_grown
	abstract_type     = /obj/item/chems/food/processed_grown
...
/obj/item/chems/food/processed_grown/Initialize(mapload, material_key, _seed)
...
/obj/item/chems/food/processed_grown/slice/large/watermelon
	seed              = "watermelon"
	is_spawnable_type = TRUE
...
/obj/item/chems/food/processed_grown/sticks/potato
	seed              = "potato"
	is_spawnable_type = TRUE
	nutriment_type    = /decl/material/liquid/drink/juice/potato
	nutriment_amt     = 2

/obj/item/chems/food/processed_grown/chopped/soy
	seed              = "soybeans"
	is_spawnable_type = TRUE
	nutriment_type    = /decl/material/liquid/drink/milk/soymilk
	nutriment_amt     = 2

/obj/item/chems/food/processed_grown/crushed/garlic
	seed              = "garlic"
	is_spawnable_type = TRUE
