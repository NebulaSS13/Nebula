...
/datum/seed/chili
	...
	chems = list(/decl/material/capsaicin = list(3,5), /decl/material/nutriment = list(1,25))
...
/datum/seed/chili/ice
	...
	mutants = null
	chems = list(/decl/material/frostoil = list(3,5), /decl/material/nutriment = list(1,50))
...
/datum/seed/berry
	...
	chems = list(/decl/material/nutriment = list(1,10), /decl/material/drink/juice/berry = list(10,10))
	kitchen_tag = "berries"
...
/datum/seed/berry/poison
	...
	chems = list(/decl/material/nutriment = list(1), /decl/material/toxin = list(3,5), /decl/material/toxin/poisonberryjuice = list(10,5))
...
/datum/seed/tomato
	...
	chems = list(/decl/material/nutriment = list(1,10), /decl/material/drink/juice/tomato = list(10,10))
	kitchen_tag = "tomato"
...
/datum/seed/tomato/blood
	...
	mutants = list("killer")
	chems = list(/decl/material/nutriment = list(1,10), /decl/material/blood = list(1,5))
...
/datum/seed/tomato/blue
	...
	chems = list(/decl/material/nutriment = list(1,20), /decl/material/lube = list(1,5))
...
/datum/seed/tomato/blue/teleport
	...
	mutants = null
	chems = list(/decl/material/nutriment = list(1,20), /decl/material/ethanol/singulo = list(10,5))
...
/datum/seed/eggplant
	...
	chems = list(/decl/material/nutriment = list(1,10))
...
/datum/seed/apple
	...
	chems = list(/decl/material/nutriment = list(1,10), /decl/material/drink/juice/apple = list(10,10))
	kitchen_tag = "apple"
...
/datum/seed/apple/poison
	name = "poisonapple"
	mutants = null
	chems = list(/decl/material/toxin/cyanide = list(1,5))
...
/datum/seed/ambrosia
	...
	chems = list(/decl/material/nutriment = list(1), /decl/material/psychoactives = list(1,8), /decl/material/burn_meds = list(1,8,1), /decl/material/brute_meds = list(1,10,1), /decl/material/toxin = list(1,10))
...
/datum/seed/ambrosia/deus
	...
	chems = list(
		/decl/material/nutriment = list(1), 
		/decl/material/brute_meds = list(1,8), 
		/decl/material/antidepressants = list(1,8,1), 
		/decl/material/stimulants = list(1,8,1), 
		/decl/material/amphetamines = list(1,10,1), 
		/decl/material/psychoactives = list(1,10)
	)
...
/datum/seed/mushroom
	...
	chems = list(/decl/material/nutriment = list(1,25))
...
/datum/seed/mushroom/plump
	...
	chems = list(/decl/material/nutriment = list(2,10))
...
/datum/seed/mushroom/hallucinogenic
	...
	chems = list(/decl/material/nutriment = list(1,50), /decl/material/psychotropics = list(3,5))
...
/datum/seed/mushroom/hallucinogenic/strong
	...
	mutants = null
	chems = list(/decl/material/nutriment = list(1), /decl/material/sedatives = list(3,3), /decl/material/psychoactives = list(1,25))
...
/datum/seed/mushroom/poison
	...
	chems = list(/decl/material/nutriment = list(1), /decl/material/toxin/amatoxin = list(3,3), /decl/material/psychotropics = list(1,25))
...
/datum/seed/mushroom/poison/death
	...
	mutants = null
	chems = list(/decl/material/nutriment = list(1,50), /decl/material/toxin/amatoxin = list(13,3), /decl/material/psychotropics = list(1,25))
...
/datum/seed/mushroom/corkwood
	...
	chems = list(/decl/material/woodpulp = list(10,1))
	mutants = null
...
/datum/seed/mushroom/glowbell
	...
	chems = list(/decl/material/glowsap = list(1,20))
...
/datum/seed/mushroom/plastic
	...
	mutants = null
	chems = list(/decl/material/toxin/plasticide = list(1,10))
...
/datum/seed/flower
	...
	chems = list(/decl/material/nutriment = list(1,20))
...
/datum/seed/flower/poppy
	...
	chems = list(/decl/material/nutriment = list(1,20), /decl/material/painkillers = list(1,10))
	kitchen_tag = "poppy"
...
/datum/seed/flower/lavender
	...
	chems = list(/decl/material/nutriment = list(1,20), /decl/material/brute_meds = list(1,10))
...
/datum/seed/grapes
	...
	chems = list(/decl/material/nutriment = list(1,10), /decl/material/nutriment/sugar = list(1,5), /decl/material/drink/juice/grape = list(10,10))
...
/datum/seed/grapes/green
	...
	mutants = null
	chems = list(/decl/material/nutriment = list(1,10), /decl/material/burn_meds = list(3,5), /decl/material/drink/juice/grape = list(10,10))
...
/datum/seed/peppercorn
	...
	chems = list(/decl/material/blackpepper = list(10,10))
...
/datum/seed/corn
	...
	chems = list(/decl/material/nutriment = list(1,10), /decl/material/nutriment/cornoil = list(1,10))
	kitchen_tag = "corn"
...
/datum/seed/potato
	...
	chems = list(/decl/material/nutriment = list(1,10), /decl/material/drink/juice/potato = list(10,10))
	kitchen_tag = "potato"
...
/datum/seed/garlic
	...
	seed_name = "garlic"
	display_name = "garlic"
	chems = list(/decl/material/nutriment = list(1,10), /decl/material/drink/juice/garlic = list(10,10))
	kitchen_tag = "garlic"
...
/datum/seed/onion
	...
	seed_name = "onion"
	display_name = "onions"
	chems = list(/decl/material/nutriment = list(1,10), /decl/material/drink/juice/onion = list(10,10))
	kitchen_tag = "onion"
...
/datum/seed/soybean
	...
	chems = list(/decl/material/nutriment = list(1,20), /decl/material/drink/milk/soymilk = list(10,20))
...
/datum/seed/wheat
	...
	chems = list(/decl/material/nutriment = list(1,25), /decl/material/nutriment/flour = list(15,15))
	kitchen_tag = "wheat"
...
/datum/seed/rice
	...
	chems = list(/decl/material/nutriment = list(1,25), /decl/material/nutriment/rice = list(10,15))
	kitchen_tag = "rice"
...
/datum/seed/carrots
	...
	chems = list(/decl/material/nutriment = list(1,20), /decl/material/eyedrops = list(3,5), /decl/material/drink/juice/carrot = list(10,20))
	kitchen_tag = "carrot"
...
/datum/seed/whitebeets
	...
	chems = list(/decl/material/nutriment = list(0,20), /decl/material/nutriment/sugar = list(1,5))
...
/datum/seed/sugarcane
	...
	chems = list(/decl/material/nutriment/sugar = list(4,5))
...
/datum/seed/watermelon
	...
	chems = list(/decl/material/nutriment = list(1,6), /decl/material/drink/juice/watermelon = list(10,6))
...
/datum/seed/pumpkin
	...
	chems = list(/decl/material/nutriment = list(1,6))
	kitchen_tag = "pumpkin"
...
/datum/seed/citrus
	...
	chems = list(/decl/material/nutriment = list(1,20), /decl/material/drink/juice/lime = list(10,20))
	kitchen_tag = "lime"
...
/datum/seed/citrus/lemon
	...
	chems = list(/decl/material/nutriment = list(1,20), /decl/material/drink/juice/lemon = list(10,20))
	kitchen_tag = "lemon"
...
/datum/seed/citrus/orange
	...
	kitchen_tag = "orange"
	chems = list(/decl/material/nutriment = list(1,20), /decl/material/drink/juice/orange = list(10,20))
...
/datum/seed/cocoa
	...
	chems = list(/decl/material/nutriment = list(1,10), /decl/material/nutriment/coco = list(4,5))
...
/datum/seed/cherries
	...
	chems = list(/decl/material/nutriment = list(1,15), /decl/material/nutriment/sugar = list(1,15), /decl/material/nutriment/cherryjelly = list(10,15))
...
/datum/seed/kudzu
	...
	chems = list(/decl/material/nutriment = list(1,50), /decl/material/antitoxins = list(1,25))
...
/datum/seed/shand
	...
	chems = list(/decl/material/brute_meds = list(0,10))
	kitchen_tag = "shand"
...
/datum/seed/mtear
	...
	chems = list(/decl/material/nutriment/honey = list(1,10), /decl/material/burn_meds = list(3,5))
	kitchen_tag = "mtear"
...
/datum/seed/tobacco
	...
	chems = list(/decl/material/tobacco = list(1,10))
...
/datum/seed/tobacco/finetobacco
	...
	chems = list(/decl/material/tobacco/fine = list(1,10))
...
/datum/seed/tobacco/puretobacco //provides the pure nicotine reagent
	...
	chems = list(/decl/material/nicotine = list(1,10))
...
/datum/seed/tobacco/bad
	...
	chems = list(/decl/material/tobacco/bad = list(1,10))
...
/datum/seed/algae
	...
	display_name = "algae"
	chems = list(
		/decl/material/nutriment = list(2,12),
		/decl/material/toxin/bromide = list(3,8)
	)
	kitchen_tag = "algae"
...
/datum/seed/bamboo
	...
	seed_name = "bamboo"
	display_name = "bamboo"
	chems = list(/decl/material/bamboo = list(6,1))
	mutants = null
