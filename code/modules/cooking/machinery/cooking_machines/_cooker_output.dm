...
/obj/item/chems/food/snacks/variable/on_reagent_change()
	return

/obj/item/chems/food/snacks/variable/proc/update_prefix()
	switch(scale)
		if (0 to 0.8)
			prefix = "small"
		if (0.8 to 1.2)
...
/obj/item/chems/food/snacks/proc/get_name_sans_prefix()
	return name

/obj/item/chems/food/snacks/variable/get_name_sans_prefix()
...
/obj/item/chems/food/snacks/variable/cereal
	name = "cereal"
...
/obj/item/chems/food/snacks/variable/cereal/Initialize()
	. =..()
	name = pick(list("flakes", "krispies", "crunch", "pops", "O's", "crisp", "loops", "jacks", "clusters"))

/obj/item/chems/food/snacks/variable/mob
