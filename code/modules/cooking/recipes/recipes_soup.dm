...
/decl/recipe/nettlesoup
	...
	reagents = list(/decl/material/liquid/water = 10, /decl/material/liquid/nutriment/protein/egg = 3)
...
/decl/recipe/slimesoup
	appliance = SAUCEPAN | POT
	reagents = list(/decl/material/liquid/water = 10, /decl/reagent/slimejelly = 5)
	items = list()
...
/decl/recipe/mushroomsoup
	...
	reagents = list(/decl/material/liquid/water = 5, /decl/material/liquid/drink/milk = 5)
	reagent_mix = RECIPE_REAGENT_REPLACE
...
/decl/recipe/chawanmushi
	appliance = SAUCEPAN
	fruit = list("mushroom" = 1)
	reagents = list(/decl/material/liquid/water = 5, /decl/material/liquid/nutriment/soysauce = 5, /decl/material/liquid/nutriment/protein/egg = 6)
	reagent_mix = RECIPE_REAGENT_REPLACE
