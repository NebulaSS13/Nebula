/decl/recipe/friedegg_easy
	...
	result = /obj/item/chems/food/snacks/friedegg/overeasy

/decl/recipe/friedegg
	appliance = SKILLET
	items = list(
		/obj/item/chems/food/snacks/friedegg/overeasy
	)
	result = /obj/item/chems/food/snacks/friedegg

/decl/recipe/poachedegg
	appliance = SKILLET | SAUCEPAN
	reagents = list(/decl/reagent/spacespice = 1, /decl/reagent/sodiumchloride = 1, /decl/reagent/blackpepper = 1, /decl/material/liquid/water = 5)
	items = list(
		/obj/item/chems/food/snacks/egg
	)
	reagent_mix = RECIPE_REAGENT_REPLACE //Get that water outta here
	result = /obj/item/chems/food/snacks/poachedegg
...
/decl/recipe/honeytoast
	...
	result = /obj/item/chems/food/snacks/honeytoast
...
/decl/recipe/bacon_and_eggs
	...
	result = /obj/item/chems/food/snacks/bacon_and_eggs
...
/decl/recipe/ntmuffin
	...
	result = /obj/item/chems/food/snacks/nt_muffin
...
/decl/recipe/muffin
	appliance = OVEN
	reagents = list(/decl/material/liquid/drink/milk = 5, /decl/reagent/sugar = 5)
	reagent_mix = RECIPE_REAGENT_REPLACE
	items = list(
...
/decl/recipe/berrymuffin
	...
	result = /obj/item/chems/food/snacks/berrymuffin
...
/decl/recipe/quiche
	...
	result = /obj/item/chems/food/snacks/sliceable/quiche
