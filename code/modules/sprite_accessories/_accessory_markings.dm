...
/decl/sprite_accessory/marking/tat_tiger_arm/left
	name = "Tattoo (Tiger Left Arm)"
	icon_state = "tat_tiger"
	body_parts = list(BP_L_ARM)

/decl/sprite_accessory/marking/tat_tiger_arm/right
...
/decl/sprite_accessory/marking/tat_bands_arm/right
	name = "Tattoo (Bands Right Arm)"
	icon_state = "bands"
	body_parts = list(BP_R_ARM)

/decl/sprite_accessory/marking/tat_bands_arm/left
	name = "Tattoo (Bands Left Arm)"
	icon_state = "bands"
	body_parts = list(BP_L_ARM)

/decl/sprite_accessory/marking/tat_bands_hand/right
	name = "Tattoo (Bands Right Hand)"
	icon_state = "bands"
	body_parts = list(BP_R_HAND)
/decl/sprite_accessory/marking/tat_bands_hand/left
	name = "Tattoo (Bands Left Hand)"
	icon_state = "bands"
	body_parts = list(BP_L_HAND)
/decl/sprite_accessory/marking/tat_bands_leg/right
	name = "Tattoo (Bands Right Leg)"
	icon_state = "bands"
	body_parts = list(BP_R_LEG)
/decl/sprite_accessory/marking/tat_bands_leg/left
