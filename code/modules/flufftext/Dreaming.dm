...
var/list/dreams = list(
	...
	"the virologist","the roboticist","a chef","the bartender","a chaplain","a librarian","a snaprat",
	"a beach","the holodeck","a smokey room","a voice","the cold","a snaprat","an operating table","the rain","a frog",
	"a lizard","the ai core","a beaker of strange liquid","the supermatter", "a creature built completely of stolen flesh",
	"a snake", "a IPC", "a plant monster", "a being made of light", "the commanding officer", "the executive officer", "the chief of security", "the corporate liason",
