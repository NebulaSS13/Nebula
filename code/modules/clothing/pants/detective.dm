/obj/item/clothing/pants/slacks/outfit/detective
	starting_accessories = list(
		/obj/item/clothing/shirt/button,
		/obj/item/clothing/neck/tie/blue_clip
	)

/obj/item/clothing/pants/slacks/black/outfit/detective
	starting_accessories = list(
		/obj/item/clothing/shirt/button/tan,
		/obj/item/clothing/neck/tie/long/red
	)

/obj/item/clothing/pants/slacks/outfit/detective_black
	starting_accessories = list(
		/obj/item/clothing/shirt/button,
		/obj/item/clothing/neck/tie/long/red,
