...
/obj/item/clothing/under/sl_suit
	...
	icon = 'icons/clothing/under/uniform_service.dmi'
...
/obj/item/clothing/under/dress/dress_green
	...
	icon = 'icons/clothing/under/dresses/dress_green.dmi'

/obj/item/clothing/under/dress/dress_yellow
	name = "green dress"
	desc = "A simple yellow dress."
	icon = 'icons/clothing/under/dresses/dress_yellow.dmi'

/obj/item/clothing/under/dress/dress_orange
	name = "orange dress"
	desc = "A fancy orange gown for those who like to show leg."
	icon = 'icons/clothing/under/dresses/dress_orange.dmi'

/obj/item/clothing/under/dress/dress_pink
	name = "pink dress"
	desc = "A simple, tight fitting pink dress."
	icon = 'icons/clothing/under/dresses/dress_pink.dmi'

/obj/item/clothing/under/dress/dress_purple
	name = "purple dress"
	desc= "A simple, tight fitting purple dress."
	icon = 'icons/clothing/under/dresses/dress_purple.dmi'

/obj/item/clothing/under/dress/dress_saloon
	name = "saloon girl dress"
	desc = "A old western inspired gown for the girl who likes to drink."
	icon = 'icons/clothing/under/dresses/dress_saloon.dmi'

/obj/item/clothing/under/dress/dress_cap
	name = "captain's dress uniform"
	desc = "Feminine fashion for the style concious captain."
	icon = 'icons/clothing/under/uniform_captain_dress.dmi'
	body_parts_covered = SLOT_UPPER_BODY|SLOT_LOWER_BODY|SLOT_ARMS

/obj/item/clothing/under/dress/dress_hop
	name = "head of personnel dress uniform"
	desc = "Feminine fashion for the style concious HoP."
	icon = 'icons/clothing/under/dresses/dress_hop.dmi'
	body_parts_covered = SLOT_UPPER_BODY|SLOT_LOWER_BODY|SLOT_ARMS
...
/obj/item/clothing/under/wedding/bride_orange
	...
	icon = 'icons/clothing/under/dresses/dress_bridal_orange.dmi'
	flags_inv = HIDESHOES

/obj/item/clothing/under/wedding/bride_purple
	name = "purple wedding dress"
	desc = "A big and puffy purple dress."
	icon = 'icons/clothing/under/dresses/dress_bridal_purple.dmi'
	flags_inv = HIDESHOES

/obj/item/clothing/under/wedding/bride_blue
	name = "blue wedding dress"
	desc = "A big and puffy blue dress."
	icon = 'icons/clothing/under/dresses/dress_bridal_blue.dmi'
	flags_inv = HIDESHOES

/obj/item/clothing/under/wedding/bride_red
	name = "red wedding dress"
	desc = "A big and puffy red dress."
	icon = 'icons/clothing/under/dresses/dress_bridal_red.dmi'
	flags_inv = HIDESHOES

/obj/item/clothing/under/wedding/bride_white
	name = "silky wedding dress"
	desc = "A white wedding gown made from the finest silk."
	icon = 'icons/clothing/under/dresses/dress_bridal_white.dmi'
	flags_inv = HIDESHOES
	body_parts_covered = SLOT_UPPER_BODY|SLOT_LOWER_BODY
...
/obj/item/clothing/under/sundress
	...
	icon = 'icons/clothing/under/dresses/dress_sundress.dmi'
	body_parts_covered = SLOT_UPPER_BODY|SLOT_LOWER_BODY
...
/obj/item/clothing/under/hosformalmale
	...
	icon = 'icons/clothing/under/uniform_hos_formal.dmi'
...
/obj/item/clothing/under/serviceoveralls
	...
	icon = 'icons/clothing/under/uniform_mechanic.dmi'
