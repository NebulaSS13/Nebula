...
/obj/item/clothing/head/helmet/space/void/engineering
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/engineering/helmet.dmi'
	armor = list(
...
/obj/item/clothing/suit/space/void/engineering
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/engineering/suit.dmi'
	max_pressure_protection = ENG_VOIDSUIT_MAX_PRESSURE
	siemens_coefficient = 0.3
	armor = list(
		melee = ARMOR_MELEE_RESISTANT,
...
/obj/item/clothing/head/helmet/space/void/mining
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/mining/helmet.dmi'
	armor = list(
		melee = ARMOR_MELEE_RESISTANT,
		bullet = ARMOR_BALLISTIC_MINOR,
		laser = ARMOR_LASER_MINOR,
...
/obj/item/clothing/suit/space/void/mining
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/mining/suit.dmi'
	armor = list(
		melee = ARMOR_MELEE_RESISTANT,
		bullet = ARMOR_BALLISTIC_MINOR,
		laser = ARMOR_LASER_MINOR,
...
/obj/item/clothing/head/helmet/space/void/medical
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/medical/helmet.dmi'
	armor = list(
...
/obj/item/clothing/suit/space/void/medical
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/medical/suit.dmi'
...
/obj/item/clothing/head/helmet/space/void/security
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/sec/helmet.dmi'
	armor = list(
...
/obj/item/clothing/suit/space/void/security
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/sec/suit.dmi'
	armor = list(
		melee = ARMOR_MELEE_MAJOR,
		bullet = ARMOR_BALLISTIC_SMALL,
		laser = ARMOR_LASER_SMALL,
...
/obj/item/clothing/head/helmet/space/void/atmos
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/atmos/helmet.dmi'
	armor = list(
		melee = ARMOR_MELEE_RESISTANT,
		bullet = ARMOR_BALLISTIC_MINOR,
		laser = ARMOR_LASER_MINOR,
...
/obj/item/clothing/suit/space/void/atmos
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/atmos/suit.dmi'
	armor = list(
		melee = ARMOR_MELEE_RESISTANT,
		bullet = ARMOR_BALLISTIC_MINOR,
		laser = ARMOR_LASER_MINOR,
...
/obj/item/clothing/head/helmet/space/void/engineering/alt
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/engineering_alt/helmet.dmi'
	armor = list(
		melee = ARMOR_MELEE_RESISTANT,
		bullet = ARMOR_BALLISTIC_MINOR,
		laser = ARMOR_LASER_MINOR,
...
/obj/item/clothing/suit/space/void/engineering/alt
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/engineering_alt/suit.dmi'
	armor = list(
		melee = ARMOR_MELEE_RESISTANT,
		bullet = ARMOR_BALLISTIC_MINOR,
		laser = ARMOR_LASER_MINOR,
...
/obj/item/clothing/head/helmet/space/void/mining/alt
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/mining_alt/helmet.dmi'
...
/obj/item/clothing/suit/space/void/mining/alt
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/mining_alt/suit.dmi'
...
/obj/item/clothing/head/helmet/space/void/medical/alt
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/medical_alt/helmet.dmi'
	armor = list(
		melee = ARMOR_MELEE_KNIVES,
		laser = ARMOR_LASER_MINOR,
		bomb = ARMOR_BOMB_PADDED,
...
/obj/item/clothing/suit/space/void/medical/alt
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/medical_alt/suit.dmi'
	allowed = list(/obj/item/flashlight,/obj/item/tank,/obj/item/suit_cooling_unit,/obj/item/storage/firstaid,/obj/item/scanner/health,/obj/item/stack/medical)
	armor = list(
		melee = ARMOR_MELEE_KNIVES,
		laser = ARMOR_LASER_MINOR,
...
/obj/item/clothing/head/helmet/space/void/security/alt
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/sec_alt/helmet.dmi'
	armor = list(
...
/obj/item/clothing/suit/space/void/security/alt
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/sec_alt/suit.dmi'
	armor = list(
		melee = ARMOR_MELEE_VERY_HIGH,
		bullet = ARMOR_BALLISTIC_SMALL,
		laser = ARMOR_LASER_SMALL,
...
/obj/item/clothing/head/helmet/space/void/atmos/alt
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/atmos_alt/helmet.dmi'
...
/obj/item/clothing/suit/space/void/atmos/alt
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/atmos_alt/suit.dmi'
...
/obj/item/clothing/head/helmet/space/void/engineering/salvage
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/salvage/helmet.dmi'
	armor = list(
		melee = ARMOR_MELEE_RESISTANT,
		bullet = ARMOR_BALLISTIC_MINOR,
		laser = ARMOR_LASER_SMALL,
...
/obj/item/clothing/suit/space/void/engineering/salvage
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/salvage/suit.dmi'
	armor = list(
		melee = ARMOR_MELEE_RESISTANT,
		bullet = ARMOR_BALLISTIC_MINOR,
		laser = ARMOR_LASER_SMALL,
...
/obj/item/clothing/head/helmet/space/void/pilot
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/pilot/helmet.dmi'
	armor = list(
		melee = ARMOR_MELEE_KNIVES,
		bullet = ARMOR_BALLISTIC_MINOR,
		laser = ARMOR_LASER_MINOR,
...
/obj/item/clothing/suit/space/void/pilot
	...
	on_mob_icon = 'icons/clothing/spacesuit/void/pilot/suit.dmi'
	armor = list(
		melee = ARMOR_MELEE_KNIVES,
		bullet = ARMOR_BALLISTIC_MINOR,
		laser = ARMOR_LASER_MINOR,
