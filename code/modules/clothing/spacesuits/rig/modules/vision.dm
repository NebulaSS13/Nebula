...
/obj/item/rig_module/vision
	...
	matter = list(MAT_STEEL = 100, MAT_GLASS = 200, MAT_PLASTIC = 300)
...
/obj/item/rig_module/vision/meson
	...
	desc = "A layered, translucent visor system for a hardsuit."
	icon_state = "meson"
	origin_tech = "{'" + TECH_MAGNET + "':2,'" + TECH_ENGINEERING + "':5}"
	usable = 0
...
/obj/item/rig_module/vision/nvg
	...
	icon_state = "night"
	origin_tech = "{'" + TECH_MAGNET + "':6,'" + TECH_ENGINEERING + "':6}"
	usable = 0
	...
	matter = list(MAT_PLASTIC = 500, MAT_STEEL = 300, MAT_GLASS = 200, MAT_URANIUM = 200)
...
/obj/item/rig_module/vision/sechud
	...
	origin_tech = "{'" + TECH_MAGNET + "':3,'" + TECH_BIO + "':2,'" + TECH_ENGINEERING + "':5}"
	usable = 0
