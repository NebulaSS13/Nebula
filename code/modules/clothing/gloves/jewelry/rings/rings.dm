...
/obj/item/clothing/gloves/ring/magic/equipped(var/mob/living/carbon/human/H, var/slot)
	..()
	if(istype(H) && slot == SLOT_HANDS)
		H.add_cloaking_source(src)

/obj/item/clothing/gloves/ring/magic/dropped(var/mob/living/carbon/human/H)
	if(!..())
		return 0
