/////////////////////////////////////////
//Standard Rings
/obj/item/clothing/jewelry/ring/engagement
	name = "engagement ring"
	desc = "An engagement ring. It certainly looks expensive."
	icon = 'icons/clothing/rings/ring_diamond.dmi'

/obj/item/clothing/jewelry/ring/engagement/attack_self(mob/user)
...
/obj/item/clothing/jewelry/ring/magic
	name = "magic ring"
	desc = "A strange ring with symbols carved on it in some arcane language."
	icon = 'icons/clothing/rings/ring_magic.dmi'

/obj/item/clothing/jewelry/ring/magic/equipped(var/mob/living/carbon/human/H, var/slot)
	..()
	if(istype(H) && slot == SLOT_HANDS)
		H.add_cloaking_source(src)

/obj/item/clothing/jewelry/ring/magic/dropped(var/mob/living/carbon/human/H)
	if(!..())
		return 0
...
/obj/item/clothing/jewelry/ring/reagent
	atom_flags = ATOM_FLAG_OPEN_CONTAINER
	origin_tech = @'{"materials":2,"esoteric":4}'
	var/tmp/volume = 15

/obj/item/clothing/jewelry/ring/reagent/Initialize(ml, material_key)
	. = ..()
	initialize_reagents()

/obj/item/clothing/jewelry/ring/reagent/initialize_reagents(populate = TRUE)
	if(!reagents)
...
/obj/item/clothing/jewelry/ring/reagent/equipped(var/mob/living/carbon/human/H)
	..()
