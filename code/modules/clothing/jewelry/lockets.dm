...
/obj/item/clothing/jewelry/locket/attack_self(mob/user)
...
/obj/item/clothing/jewelry/locket/on_update_icon()
	. = ..()
	icon_state = get_world_inventory_state()
	if(open && check_state_in_icon("[icon_state]-open", icon))
		icon_state = "[icon_state]-open"

/obj/item/clothing/jewelry/locket/attackby(var/obj/item/O, mob/user)
	if(!open)
