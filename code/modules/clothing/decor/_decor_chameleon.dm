...
/obj/item/clothing/decor/chameleon/Initialize()
	. = ..()
	if(!clothing_choices)
		clothing_choices = generate_chameleon_choices(/obj/item/clothing/decor)

/obj/item/clothing/decor/chameleon/verb/change(picked in clothing_choices)
...
/obj/item/clothing/decor/chameleon/disguise(var/newtype, var/mob/user)
