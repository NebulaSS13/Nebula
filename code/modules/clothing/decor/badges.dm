...
/obj/item/clothing/decor/badge/get_lore_info()
	. = ..()
	. += "<br>Denotes affiliation to <l>[badge_string]</l>."

/obj/item/clothing/decor/badge/proc/set_name(var/new_name)
	stored_name = new_name

/obj/item/clothing/decor/badge/proc/set_desc(var/mob/living/carbon/human/H)

/obj/item/clothing/decor/badge/get_examine_line()
	. = ..()
	. += "  <a href='?src=\ref[src];look_at_me=1'>\[View\]</a>"

/obj/item/clothing/decor/badge/examine(user)
	. = ..()
	if(stored_name)
		to_chat(user,"It reads: [stored_name], [badge_string].")

/obj/item/clothing/decor/badge/attack_self(mob/user)
...
/obj/item/clothing/decor/badge/attack(mob/living/carbon/human/M, mob/living/user)
	if(isliving(user))
...
/obj/item/clothing/decor/badge/PI
 ...
 *Holobadges
 */
/obj/item/clothing/decor/badge/holo
	name = "holobadge"
...
/obj/item/clothing/decor/badge/holo/cord
	icon = 'icons/clothing/accessories/badges/holobadge_cord.dmi'
	slot_flags = SLOT_FACE | SLOT_TIE

/obj/item/clothing/decor/badge/holo/set_name(var/new_name)
	..()
	badge_number = random_id(type,1000,9999)
	name = "[name] ([badge_number])"

/obj/item/clothing/decor/badge/holo/examine(user)
	. = ..()
	if(badge_number)
		to_chat(user,"The badge number is [badge_number].")

/obj/item/clothing/decor/badge/holo/attack_self(mob/user)
	if(!stored_name)
		to_chat(user, "Waving around a holobadge before swiping an ID would be pretty pointless.")
		return
	return ..()

/obj/item/clothing/decor/badge/holo/emag_act(var/remaining_charges, var/mob/user)
	if (emagged)
...
/obj/item/clothing/decor/badge/holo/attackby(var/obj/item/O, var/mob/user)
...
/obj/item/storage/box/holobadge/WillContain()
	return list(
			/obj/item/clothing/decor/badge/holo      = 4,
			/obj/item/clothing/decor/badge/holo/cord = 2
		)

/obj/item/clothing/decor/badge/old
	name = "faded badge"
	desc = "A faded badge, backed with leather. Looks crummy."
	badge_string = "Unknown"

/obj/item/clothing/decor/badge/defenseintel
...
/obj/item/clothing/decor/badge/interstellarintel
...
/obj/item/clothing/decor/badge/press
	name = "press badge"
...
/obj/item/clothing/decor/badge/medal/bronze
	name = "bronze medal"
	desc = "A simple bronze medal."

/obj/item/clothing/decor/badge/medal/iron
	name = "iron medal"
	desc = "A simple iron medal."
	icon = 'icons/clothing/accessories/medals/medal_iron.dmi'

/obj/item/clothing/decor/badge/medal/silver
	name = "silver medal"
	desc = "A simple silver medal."
	icon = 'icons/clothing/accessories/medals/medal_silver.dmi'

/obj/item/clothing/decor/badge/medal/gold
	name = "gold medal"
