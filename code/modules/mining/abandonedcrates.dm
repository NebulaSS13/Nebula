	...
	switch(loot)
		...
		if(67 to 68)
			...
			for(var/i = 0, i < t, ++i)
				...
				new newitem(src)
		if(69 to 70)
			new /obj/item/pick/axe/titanium(src)
		if(71 to 72)
			new /obj/item/pick/drill(src)
		if(73 to 74)
			new /obj/item/pick/hammer/jack(src)
		if(75 to 76)
			new /obj/item/pick/axe/ocp(src)
		if(77 to 78)
			new /obj/item/pick/drill/diamond(src)
		if(79 to 80)
			new /obj/item/pick/axe/plasteel(src)
		if(81 to 82)
