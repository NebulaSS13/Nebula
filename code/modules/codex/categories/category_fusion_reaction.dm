...
/datum/codex_category/fusion_reaction/Initialize()
	...
	for(var/rtype in reactions)
		...
		reaction_info += "Fusion between [p_mat.display_name] and [s_mat.display_name] can be achieved with a plasma temperature of [reaction.minimum_reaction_temperature = 8000] Kelvin or higher." 
