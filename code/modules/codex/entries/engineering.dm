...
/datum/codex_entry/welding_pack
	...
	mechanics_text = "This pack acts as a portable source of fuel. Use a welder or other tool on it to refill its tank - but make sure it's not lit! You can use this kit on a fuel tank or appropriate reagent dispenser to replenish its reserves."
