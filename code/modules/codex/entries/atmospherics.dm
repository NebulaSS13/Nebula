...
/datum/codex_entry/transfer_valve
	...
	antag_text = "With a tank of hot fuel and cold oxygen, this benign little atmospheric device becomes an incredibly deadly bomb. You don't want to be anywhere near it when it goes off."
