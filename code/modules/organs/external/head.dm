...
/obj/item/organ/external/head/proc/get_hair_icon()
	...
	if(owner.f_style)
		...
		if(facial_hair_style?.accessory_is_available(owner, species, bodytype, owner.gender))
	...
	if(owner.h_style)
		...
		if(hair_style?.accessory_is_available(owner, species, bodytype, owner.gender))
