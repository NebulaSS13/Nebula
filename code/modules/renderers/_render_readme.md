...
Minor changes only, huge thanks to Bay and /tg/ for the implementation.

- Trimmed heat and warp effects, primary need for this system is emissive blocking.
- Removed GLOB and did some lazylisting and proc renaming to fit Neb style.
- Moved the core renderer files into `code/modules/renderer` rather than `code/_defines`.
