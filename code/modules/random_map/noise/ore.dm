...
/datum/random_map/noise/ore/ice
	surface_metals = list(
		/decl/material/liquid/water/aspium     = list(RESOURCE_MID_MIN,  RESOURCE_MID_MAX),
		/decl/material/liquid/water/lukrite    = list(RESOURCE_MID_MIN,  RESOURCE_MID_MAX),
		/decl/material/liquid/water/rubenium   = list(RESOURCE_MID_MIN,  RESOURCE_MID_MAX),
		/decl/material/liquid/water/trigarite  = list(RESOURCE_MID_MIN,  RESOURCE_MID_MAX),
		/decl/material/liquid/water/ediroite   = list(RESOURCE_MID_MIN,  RESOURCE_MID_MAX),
