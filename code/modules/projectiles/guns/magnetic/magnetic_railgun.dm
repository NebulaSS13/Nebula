...
/obj/item/gun/magnetic/railgun/tcc // Oppa! Should only be available to TCC shock troops or high-budget mercs.
	...
	initial_cell_type = /obj/item/cell/hyper // Standard power
	initial_capacitor_type = /obj/item/stock_parts/capacitor/adv // 6-8 shots
	...
	origin_tech = "{'combat':6,'materials':3,'magnets':5}"
