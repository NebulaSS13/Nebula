...
/obj/item/gun/hand/pistol/random
	name = "pistol"
...
/obj/item/gun/hand/pistol/random/Initialize()
...
/obj/item/gun/hand/pistol/random/update_base_icon()
	..()
	overlays += image(gun_look.icon, icon_state)
	overlays += image(handle_icon, icon_state)

/obj/item/gun/hand/pistol/random/get_ammo_indicator()
	return gun_look.adjust_ammo_indicator(..(), get_world_inventory_state())

/obj/item/gun/hand/pistol/random/get_safety_indicator()
