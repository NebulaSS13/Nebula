...
/obj/item/gun/projectile/automatic/machine_pistol
	name = "machine pistol"
	desc = "The MP6 Vesper, A fairly common machine pistol. Sometimes refered to as an 'uzi' by the backwater spacers it is often associated with."
...
/obj/item/gun/projectile/automatic/merc_smg
	name = "submachine gun"
	desc = "The C-20r is a lightweight and rapid firing SMG, for when you REALLY need someone dead. Has a 'Per falcis, per pravitas' buttstamp."
