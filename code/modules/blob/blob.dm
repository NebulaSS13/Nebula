/obj/effect/blob
	...
	var/regen_rate = 5
	var/laser_resist = 2	// Special resist for laser based weapons - Emitters or handheld energy weaponry. Damage is divided by this.
...
/obj/effect/blob/bullet_act(var/obj/item/projectile/Proj)
	...
	switch(Proj.damage_type)
		if(BRUTE)
			damage_health(Proj.damage, Proj.damtype)
		if(BURN)
			damage_health(Proj.damage / laser_resist, Proj.damtype)
	return 0
