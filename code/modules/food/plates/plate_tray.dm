...
/obj/item/plate/tray/attack(mob/living/carbon/M, mob/living/carbon/user)
...
/obj/item/plate/tray/metal/attack(mob/living/carbon/M, mob/living/carbon/user) // So metal trays make the fun noise
