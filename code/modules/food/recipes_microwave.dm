...
/datum/recipe/friedegg
	reagents = list(/decl/material/chem/sodiumchloride = 1, /decl/material/chem/blackpepper = 1)
	items = list(
...
/datum/recipe/boiledegg
	reagents = list(/decl/material/gas/water = 10)
	items = list(
		/obj/item/chems/food/snacks/egg
	)
...
/datum/recipe/jellydonut
	reagents = list(/decl/material/chem/drink/juice/berry = 5, /decl/material/chem/nutriment/sugar = 5)
	items = list(
...
/datum/recipe/jellydonut/slime
	reagents = list(/decl/material/chem/toxin/slimejelly = 5, /decl/material/chem/nutriment/sugar = 5)
	items = list(
		/obj/item/chems/food/snacks/dough
	)
...
/datum/recipe/jellydonut/cherry
	reagents = list(/decl/material/chem/nutriment/cherryjelly = 5, /decl/material/chem/nutriment/sugar = 5)
	items = list(
		/obj/item/chems/food/snacks/dough
	)
...
/datum/recipe/donut
	reagents = list(/decl/material/chem/nutriment/sugar = 5)
	items = list(
		/obj/item/chems/food/snacks/dough
	)
...
/datum/recipe/waffles
	reagents = list(/decl/material/chem/nutriment/batter/cakebatter = 20)
	result = /obj/item/chems/food/snacks/waffles

/datum/recipe/pancakesblu
	reagents = list(/decl/material/chem/nutriment/batter = 20)
...
/datum/recipe/bananabread
	fruit = list("banana" = 2)
	reagents = list(/decl/material/chem/drink/milk = 5, /decl/material/chem/nutriment/sugar = 5)
	items = list(
		/obj/item/chems/food/snacks/dough,
		/obj/item/chems/food/snacks/dough,
	)
...
/datum/recipe/muffin
	reagents = list(/decl/material/chem/nutriment/batter/cakebatter = 10)
...
/datum/recipe/soylenviridians
	...
	reagents = list(/decl/material/chem/nutriment/flour = 10)
...
/datum/recipe/cherrypie
	...
	reagents = list(/decl/material/chem/nutriment/sugar = 10)
	items = list(
		/obj/item/chems/food/snacks/sliceable/flatdough,
	)
...
/datum/recipe/chaosdonut
	reagents = list(/decl/material/chem/frostoil = 5, /decl/material/chem/capsaicin = 5, /decl/material/chem/nutriment/sugar = 5)
	items = list(
		/obj/item/chems/food/snacks/dough
	)
...
/datum/recipe/cubancarp
	fruit = list("chili" = 1)
	reagents = list(/decl/material/chem/nutriment/batter = 10)
	items = list(
		/obj/item/chems/food/snacks/fish
	)
...
/datum/recipe/popcorn
	reagents = list(/decl/material/chem/sodiumchloride = 5)
	fruit = list("corn" = 1)
	result = /obj/item/chems/food/snacks/popcorn

/datum/recipe/cookie
	reagents = list(/decl/material/chem/nutriment/batter/cakebatter = 5, /decl/material/chem/nutriment/coco = 5)
...
/datum/recipe/loadedsteak
	reagents = list(/decl/material/chem/nutriment/garlicsauce = 5)
...
/datum/recipe/spacylibertyduff
	reagents = list(/decl/material/gas/water = 10, /decl/material/chem/ethanol/vodka = 5, /decl/material/chem/psychotropics = 5)
	result = /obj/item/chems/food/snacks/spacylibertyduff

/datum/recipe/amanitajelly
	reagents = list(/decl/material/gas/water = 10, /decl/material/chem/ethanol/vodka = 5, /decl/material/chem/toxin/amatoxin = 5)
	result = /obj/item/chems/food/snacks/amanitajelly
	make_food(var/obj/container as obj)
		var/obj/item/chems/food/snacks/amanitajelly/being_cooked = ..(container)
		being_cooked.reagents.clear_reagent(/decl/material/chem/toxin/amatoxin)
		return being_cooked
...
/datum/recipe/wishsoup
	reagents = list(/decl/material/gas/water = 20)
...
/datum/recipe/amanita_pie
	reagents = list(/decl/material/chem/toxin/amatoxin = 5)
	items = list(/obj/item/chems/food/snacks/sliceable/flatdough)
...
/datum/recipe/monkeysdelight
	fruit = list("banana" = 1)
	reagents = list(/decl/material/chem/sodiumchloride = 1, /decl/material/chem/blackpepper = 1, /decl/material/chem/nutriment/flour = 10)
	items = list(
...
/datum/recipe/rofflewaffles
	reagents = list(/decl/material/chem/psychotropics = 5, /decl/material/chem/nutriment/batter/cakebatter = 20)
...
/datum/recipe/slimetoast
	reagents = list(/decl/material/chem/toxin/slimejelly = 5)
	items = list(
		/obj/item/chems/food/snacks/slice/bread,
	)
...
/datum/recipe/jelliedtoast
	reagents = list(/decl/material/chem/nutriment/cherryjelly = 5)
	items = list(
		/obj/item/chems/food/snacks/slice/bread,
	)
...
/datum/recipe/boiledrice
	reagents = list(/decl/material/gas/water = 10, /decl/material/chem/nutriment/rice = 10)
	result = /obj/item/chems/food/snacks/boiledrice

/datum/recipe/chazuke
	reagents = list(/decl/material/chem/nutriment/rice/chazuke = 10)
	result = /obj/item/chems/food/snacks/boiledrice/chazuke

/datum/recipe/katsucurry
	fruit = list("apple" = 1, "carrot" = 1, "potato" = 1)
	reagents = list(/decl/material/gas/water = 10, /decl/material/chem/nutriment/rice = 10, /decl/material/chem/nutriment/flour = 5)
	items = list(
...
/datum/recipe/ricepudding
	reagents = list(/decl/material/chem/drink/milk = 5, /decl/material/chem/nutriment/rice = 10)
...
/datum/recipe/superbiteburger
	fruit = list("tomato" = 1)
	reagents = list(/decl/material/chem/sodiumchloride = 5, /decl/material/chem/blackpepper = 5)
	items = list(
...
/datum/recipe/candiedapple
	fruit = list("apple" = 1)
	reagents = list(/decl/material/gas/water = 10, /decl/material/chem/nutriment/sugar = 5)
...
/datum/recipe/twobread
	reagents = list(/decl/material/chem/ethanol/wine = 5)
	items = list(
		/obj/item/chems/food/snacks/slice/bread,
		/obj/item/chems/food/snacks/slice/bread,
	)
...
/datum/recipe/bloodsoup
	reagents = list(/decl/material/chem/blood = 30)
	result = /obj/item/chems/food/snacks/bloodsoup

/datum/recipe/slimesoup
	reagents = list(/decl/material/gas/water = 10, /decl/material/chem/toxin/slimejelly = 5)
	items = list()
...
/datum/recipe/fatsausage
	reagents = list(/decl/material/chem/blackpepper = 2)
	items = list(
		/obj/item/chems/food/snacks/rawmeatball,
		/obj/item/chems/food/snacks/rawcutlet,
	)
...
/datum/recipe/plumphelmetbiscuitvegan
	fruit = list("plumphelmet" = 1)
	reagents = list(/decl/material/chem/nutriment/flour = 10, /decl/material/gas/water = 10)
	result = /obj/item/chems/food/snacks/plumphelmetbiscuit

/datum/recipe/mushroomsoup
	fruit = list("mushroom" = 1)
	reagents = list(/decl/material/chem/drink/milk = 10)
	result = /obj/item/chems/food/snacks/mushroomsoup

/datum/recipe/chawanmushi
	fruit = list("mushroom" = 1)
	reagents = list(/decl/material/gas/water = 10, /decl/material/chem/nutriment/soysauce = 5)
	items = list(
		/obj/item/chems/food/snacks/egg,
		/obj/item/chems/food/snacks/egg
	)
...
/datum/recipe/validsalad
	...
	make_food(var/obj/container as obj)
		...
		being_cooked.reagents.clear_reagent(/decl/material/chem/toxin)
		return being_cooked

/datum/recipe/cracker
	reagents = list(/decl/material/chem/sodiumchloride = 1)
	items = list(
		/obj/item/chems/food/snacks/doughslice
	)
...
/datum/recipe/stuffing
	reagents = list(/decl/material/gas/water = 10, /decl/material/chem/sodiumchloride = 1, /decl/material/chem/blackpepper = 1)
	items = list(
...
/datum/recipe/mint
	reagents = list(/decl/material/chem/nutriment/sugar = 5, /decl/material/chem/frostoil = 5)
	result = /obj/item/chems/food/snacks/mint

// Cakes.
/datum/recipe/cake
	reagents = list(/decl/material/chem/nutriment/batter/cakebatter = 60)
...
/datum/recipe/cake/birthday
	reagents = list(/decl/material/chem/nutriment/sprinkles = 10)
	result = /obj/item/chems/food/snacks/sliceable/birthdaycake
...
/datum/recipe/cake/chocolatebar
	reagents = list(/decl/material/chem/drink/milk/chocolate = 10, /decl/material/chem/nutriment/coco = 5, /decl/material/chem/nutriment/sugar = 5)
