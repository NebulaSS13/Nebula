...
/datum/nano_module/program/camera_monitor/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = NANOUI_FOCUS, state = GLOB.default_state)
...
/datum/nano_module/program/camera_monitor/proc/can_connect_to_camera(var/obj/machinery/camera/C)
