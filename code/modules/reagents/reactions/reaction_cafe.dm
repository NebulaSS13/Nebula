...
/datum/chemical_reaction/cafe/icesoylatte
	name = "Iced Soy Latte"
	result = /decl/reagent/drink/coffee/icecoffee/soy_latte
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/coffee/soy_latte = 2)
	result_amount = 3
	mix_message = "The ice clinks together in the chilled soy latte."

/datum/chemical_reaction/cafe/icecafelatte
	name = "Iced Cafe Latte"
	result = /decl/reagent/drink/coffee/icecoffee/cafe_latte
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/coffee/cafe_latte = 2)
	result_amount = 3
...
/datum/chemical_reaction/recipe/cafe/mocha_latte
	name = "Mocha Latte"
	result = /decl/reagent/drink/coffee/cafe_latte/mocha
	required_reagents = list(/decl/reagent/drink/coffee/cafe_latte = 2, /decl/reagent/drink/syrup_chocolate = 1)
	result_amount = 3
	mix_message = "The chocolate swirls into the latte."

/datum/chemical_reaction/recipe/cafe/soy_mocha_latte
	name = "Mocha Soy Latte"
	result = /decl/reagent/drink/coffee/soy_latte/mocha
	required_reagents = list(/decl/reagent/drink/coffee/soy_latte = 3, /decl/reagent/drink/syrup_chocolate = 1)
	result_amount = 4
	mix_message = "The chocolate swirls into the latte."

/datum/chemical_reaction/recipe/cafe/ice_mocha_latte
	name = "Iced Mocha Latte"
	result = /decl/reagent/drink/coffee/icecoffee/cafe_latte/mocha
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/coffee/cafe_latte/mocha = 2)
	result_amount = 3
...
/datum/chemical_reaction/recipe/cafe/ice_soy_mocha_latte
	...
	result = /decl/reagent/drink/coffee/icecoffee/soy_latte/mocha
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/coffee/soy_latte/mocha = 2)
	result_amount = 3
	mix_message = "The ice clinks together in the chilled soy mocha latte."

/datum/chemical_reaction/recipe/cafe/pumpkin_latte
	name = "Pumpkin Spice Latte"
	result = /decl/reagent/drink/coffee/cafe_latte/pumpkin
	required_reagents = list(/decl/reagent/drink/coffee/cafe_latte = 2, /decl/reagent/drink/syrup_pumpkin = 1)
	result_amount = 3
...
/datum/chemical_reaction/recipe/cafe/soy_pumpkin_latte
	...
	result = /decl/reagent/drink/coffee/soy_latte/pumpkin
	required_reagents = list(/decl/reagent/drink/coffee/soy_latte = 3, /decl/reagent/drink/syrup_pumpkin = 1)
	result_amount = 4
	mix_message = "The pumpkin spice swirls into the latte."

/datum/chemical_reaction/recipe/cafe/ice_pumpkin_latte
	name = "Iced Pumpkin Spice Latte"
	result = /decl/reagent/drink/coffee/icecoffee/cafe_latte/pumpkin
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/coffee/cafe_latte/pumpkin = 2)
	result_amount = 3
...
/datum/chemical_reaction/recipe/cafe/ice_soy_pumpkin_latte
	...
	result = /decl/reagent/drink/coffee/icecoffee/soy_latte/pumpkin
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/coffee/soy_latte/pumpkin = 2)
	result_amount = 3
...
/datum/chemical_reaction/recipe/cafe/icetea
	name = "Iced Tea"
	result = /decl/reagent/drink/tea/icetea
...
/datum/chemical_reaction/recipe/cafe/sweettea
	name = "Sweet Tea"
	result = /decl/reagent/drink/tea/icetea/sweet
	required_reagents = list(/decl/reagent/drink/tea/icetea = 2, /decl/reagent/nutriment/sugar = 1)
	result_amount = 3
	mix_message = "The ice clinks together in the sweet tea."

/datum/chemical_reaction/recipe/cafe/barongrey
	name = "Baron Grey Tea"
	result = /decl/reagent/drink/tea/barongrey
	required_reagents = list(/decl/reagent/drink/tea = 2, /decl/reagent/drink/juice/orange = 1)
	result_amount = 3
	mix_message = "The juice swirls into the tea."

/datum/chemical_reaction/recipe/cafe/latte_barongrey
	name = "London Fog"
	result = /decl/reagent/drink/tea/barongrey/latte
	required_reagents = list(/decl/reagent/drink/tea/barongrey = 2, /decl/reagent/drink/milk = 1)
	result_amount = 3
	mix_message = "The milk swirls into the tea."

/datum/chemical_reaction/recipe/cafe/soy_latte_barongrey
	name = "Soy London Fog"
	result = /decl/reagent/drink/tea/barongrey/soy_latte
	required_reagents = list(/decl/reagent/drink/tea/barongrey = 2, /decl/reagent/drink/milk/soymilk = 1)
	result_amount = 3
	mix_message = "The soy swirls into the tea."

/datum/chemical_reaction/recipe/cafe/ice_latte_barongrey
	name = "Iced London Fog"
	result = /decl/reagent/drink/tea/icetea/barongrey/latte
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/tea/barongrey/latte = 2)
	result_amount = 3
...
/datum/chemical_reaction/recipe/cafe/ice_soy_latte_barongrey
	...
	result = /decl/reagent/drink/tea/icetea/barongrey/soy_latte
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/tea/barongrey/soy_latte = 2)
	result_amount = 3
	mix_message = "The ice clinks together in the chilled soy london fog."

/datum/chemical_reaction/recipe/cafe/icetea_green
	name = "Iced Green Tea"
	result = /decl/reagent/drink/tea/icetea/green
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/tea/green = 2)
	result_amount = 3
	mix_message = "The ice clinks together in the tea."

/datum/chemical_reaction/recipe/cafe/sweettea_green
	name = "Sweet Green Tea"
	result = /decl/reagent/drink/tea/icetea/green/sweet
	required_reagents = list(/decl/reagent/drink/tea/icetea/green = 2, /decl/reagent/nutriment/sugar = 1)
	result_amount = 3
	mix_message = "The ice clinks together in the sweet tea."

/datum/chemical_reaction/recipe/cafe/maghreb_tea
	name = "Maghrebi tea"
	result = /decl/reagent/drink/tea/icetea/green/sweet/mint
	required_reagents = list(/decl/reagent/drink/tea/icetea/green/sweet = 3)
...
/datum/chemical_reaction/recipe/cafe/icetea_chai
	name = "Iced Chai Tea"
	result = /decl/reagent/drink/tea/icetea/chai
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/tea/chai = 2)
	result_amount = 3
	mix_message = "The ice clinks together in the tea."

/datum/chemical_reaction/recipe/cafe/sweettea_chai
	name = "Iced Chai Tea"
	result = /decl/reagent/drink/tea/icetea/chai/sweet
	required_reagents = list(/decl/reagent/drink/tea/icetea/chai = 2, /decl/reagent/nutriment/sugar = 1)
	result_amount = 3
	mix_message = "The ice clinks together in the sweet tea."

/datum/chemical_reaction/recipe/cafe/latte_chai
	name = "Chai Latte"
	result = /decl/reagent/drink/tea/chai/latte
	required_reagents = list(/decl/reagent/drink/tea/chai = 2, /decl/reagent/drink/milk = 1)
	result_amount = 3
	mix_message = "The milk swirls into the drink."

/datum/chemical_reaction/recipe/cafe/soy_latte_chai
	name = "Chai Soy Latte"
	result = /decl/reagent/drink/tea/chai/soy_latte
	required_reagents = list(/decl/reagent/drink/tea/chai = 2, /decl/reagent/drink/milk/soymilk = 1)
	result_amount = 3
	mix_message = "The milk swirls into the drink."

/datum/chemical_reaction/recipe/cafe/ice_latte_chai
	name = "Iced Chai Latte"
	result = /decl/reagent/drink/tea/icetea/chai/latte
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/tea/chai/latte = 2)
	result_amount = 3
...
/datum/chemical_reaction/recipe/cafe/ice_soy_latte_chai
	...
	result = /decl/reagent/drink/tea/icetea/chai/soy_latte
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/tea/chai/soy_latte = 2)
	result_amount = 3
...
/datum/chemical_reaction/recipe/cafe/icetea_red
	...
	result = /decl/reagent/drink/tea/icetea/red
	required_reagents = list(/decl/reagent/drink/ice = 1, /decl/reagent/drink/tea/red = 2)
	result_amount = 3
	mix_message = "The ice clinks together in the tea."

/datum/chemical_reaction/recipe/cafe/sweettea_red
	name = "Iced Rooibos tea"
	result = /decl/reagent/drink/tea/icetea/red/sweet
	required_reagents = list(/decl/reagent/drink/tea/icetea/red = 2, /decl/reagent/nutriment/sugar = 1)
	result_amount = 3
	mix_message = "The ice clinks together in the sweet tea."
