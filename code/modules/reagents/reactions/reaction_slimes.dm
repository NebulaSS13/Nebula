...
/datum/chemical_reaction/slime/spawn
	name = "Slime Spawn"
	result = null
	required_reagents = list(/decl/material/toxin/phoron = 1)
	result_amount = 1
...
/datum/chemical_reaction/slime/monkey
	name = "Slime Monkey"
	result = null
	required_reagents = list(/decl/material/blood = 1)
	result_amount = 1
	required = /obj/item/slime_extract/grey
...
/datum/chemical_reaction/slime/casp
	...
	result = /decl/material/capsaicin
	required_reagents = list(/decl/material/blood = 1)
	result_amount = 10
...
/datum/chemical_reaction/slime/glow
	name = "Slime Glow"
	result = null
	required_reagents = list(/decl/material/water = 1)
	result_amount = 1
	required = /obj/item/slime_extract/yellow
...
/datum/chemical_reaction/slime/jam
	name = "Slime Jam"
	result = /decl/material/toxin/slimejelly
	required_reagents = list(/decl/material/nutriment/sugar = 1)
	result_amount = 10
	required = /obj/item/slime_extract/purple
