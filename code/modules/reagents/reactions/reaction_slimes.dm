...
/datum/chemical_reaction/slime/spawn
	name = "Slime Spawn"
	result = null
	required_reagents = list(/datum/reagent/enzyme = 1)
	result_amount = 1
	required = /obj/item/slime_extract/grey

/datum/chemical_reaction/slime/spawn/on_reaction(var/datum/reagents/holder)
	..()
	holder.my_atom.visible_message("<span class='warning'>Infused with enzymes, the core begins to quiver and grow, and soon a new baby slime emerges from it!</span>")
...
/datum/chemical_reaction/slime/fire/on_reaction(var/datum/reagents/holder)
	...
	location.assume_gas(MAT_HYDROGEN, 125, 1400)
	location.assume_gas(MAT_OXYGEN,   125, 1400)
...
/datum/chemical_reaction/slime/plasma/on_reaction(var/datum/reagents/holder)
	..()
	var/obj/item/stack/material/mhydrogen/P = new (get_turf(holder.my_atom))
	P.amount = 10
