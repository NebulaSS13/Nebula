...
/datum/chemical_reaction/slime/spawn
	name = "Slime Spawn"
	result = null
	required_reagents = list(/decl/material/chem/toxin/phoron = 1)
	result_amount = 1
...
/datum/chemical_reaction/slime/monkey
	name = "Slime Monkey"
	result = null
	required_reagents = list(/decl/material/chem/blood = 1)
	result_amount = 1
	required = /obj/item/slime_extract/grey
...
/datum/chemical_reaction/slime/frost
	...
	result = /decl/material/chem/frostoil
	required_reagents = list(/decl/material/chem/toxin/phoron = 1)
	result_amount = 10
...
/datum/chemical_reaction/slime/casp
	...
	result = /decl/material/chem/capsaicin
	required_reagents = list(/decl/material/chem/blood = 1)
	result_amount = 10
...
/datum/chemical_reaction/slime/glow
	name = "Slime Glow"
	result = null
	required_reagents = list(/decl/material/gas/water = 1)
	result_amount = 1
	required = /obj/item/slime_extract/yellow
...
/datum/chemical_reaction/slime/jam
	name = "Slime Jam"
	result = /decl/material/chem/toxin/slimejelly
	required_reagents = list(/decl/material/chem/nutriment/sugar = 1)
	result_amount = 10
	required = /obj/item/slime_extract/purple
