/datum/chemical_reaction/antitoxins
	...
	required_reagents = list(/decl/material/silicon = 1, /decl/material/potassium = 1, /decl/material/ammonia = 1)
	result_amount = 3
...
/datum/chemical_reaction/lube
	...
	required_reagents = list(/decl/material/water = 1, /decl/material/silicon = 1, /decl/material/acetone = 1)
	result_amount = 4
...
/datum/chemical_reaction/burn_meds
	...
	required_reagents = list(/decl/material/silicon = 1, /decl/material/carbon = 1)
	result_amount = 2
	log_is_important = 1
...
/datum/chemical_reaction/neuroannealer
	...
	required_reagents = list(/decl/material/acid/hydrochloric = 1, /decl/material/ammonia = 1, /decl/material/antitoxins = 1)
	result_amount = 2

/datum/chemical_reaction/oxy_meds
	name = "Oxygen Deprivation Medication"
	result = /decl/material/oxy_meds
	required_reagents = list(/decl/material/acetone = 1, /decl/material/water = 1, /decl/material/sulfur = 1)
	result_amount = 1

/datum/chemical_reaction/brute_meds
	name = "Anti-Trauma Medication"
	result = /decl/material/brute_meds
	required_reagents = list(/decl/material/adrenaline = 1, /decl/material/carbon = 1)
...
/datum/chemical_reaction/retrovirals
	...
	required_reagents = list(/decl/material/antirads = 1, /decl/material/carbon = 1)
	result_amount = 2

/datum/chemical_reaction/nanitefluid
	name = "Nanite Fluid"
	result = /decl/material/nanitefluid
	required_reagents = list(/decl/material/toxin/plasticide = 1, /decl/material/aluminium = 1, /decl/material/lube = 1)
	catalysts = list(/decl/material/toxin/phoron = 5)
	result_amount = 3
...
/datum/chemical_reaction/eyedrops
	...
	required_reagents = list(/decl/material/carbon = 1, /decl/material/fuel/hydrazine = 1, /decl/material/antitoxins = 1)
	result_amount = 2
...
/datum/chemical_reaction/zombiepowder
	...
	required_reagents = list(/decl/material/toxin/carpotoxin = 5, /decl/material/sedatives = 5, /decl/material/copper = 5)
	result_amount = 2
...
/datum/chemical_reaction/surfactant
	...
	required_reagents = list(/decl/material/fuel/hydrazine = 2, /decl/material/carbon = 2, /decl/material/acid = 1)
	result_amount = 5
...
/datum/chemical_reaction/space_cleaner
	...
	required_reagents = list(/decl/material/ammonia = 1, /decl/material/water = 1)
	result_amount = 2

/datum/chemical_reaction/plantbgone
	name = "Plant-B-Gone"
	result = /decl/material/toxin/plantbgone
	required_reagents = list(/decl/material/toxin = 1, /decl/material/water = 4)
	result_amount = 5
...
/datum/chemical_reaction/antidepressants
	...
	required_reagents = list(/decl/material/hallucinogenics = 1, /decl/material/carbon = 1)
	result_amount = 3
...
/datum/chemical_reaction/methyl_bromide
	...
	result_amount = 3
	result = /decl/material/toxin/methyl_bromide
