...
/datum/chemical_reaction/recipe/food/dough
	name = "Dough"
	required_reagents = list(/decl/reagent/nutriment/protein/egg = 3, /decl/reagent/nutriment/flour = 10, /decl/reagent/water = 10)
...
/datum/chemical_reaction/recipe/food/soydough
	name = "Soy dough"
	required_reagents = list(/decl/reagent/nutriment/plant_protein = 3, /decl/reagent/nutriment/flour = 10, /decl/reagent/water = 10)
	mix_message = "The solution folds and thickens into a large ball of dough."
	obj_result = /obj/item/chems/food/snacks/dough

/datum/chemical_reaction/recipe/food/syntiflesh
	name = "Synthetic Meat"
	required_reagents = list(/decl/reagent/blood = 5, /decl/reagent/toxin/plasticide = 1)
...
/datum/chemical_reaction/recipe/food/chocolate_bar
	name = "Soy Chocolate"
	required_reagents = list(/decl/reagent/drink/milk/soymilk = 2, /decl/reagent/nutriment/coco = 2, /decl/reagent/nutriment/sugar = 2)
...
/datum/chemical_reaction/recipe/food/chocolate_bar2
	name = "Milk Chocolate"
	required_reagents = list(/decl/reagent/drink/milk = 2, /decl/reagent/nutriment/coco = 2, /decl/reagent/nutriment/sugar = 2)
	mix_message = "The solution thickens and hardens into a glossy brown substance."
	obj_result = /obj/item/chems/food/snacks/chocolatebar
