...
/datum/chemical_reaction/recipe/food/cheesewheel
	name = "Cheesewheel"
	required_reagents = list(/decl/material/chem/drink/milk = 40)
...
/datum/chemical_reaction/recipe/food/rawmeatball
	name = "Raw Meatball"
	required_reagents = list(/decl/material/chem/nutriment/protein = 3, /decl/material/chem/nutriment/flour = 5)
	result_amount = 3
...
/datum/chemical_reaction/recipe/food/dough
	name = "Dough"
	required_reagents = list(/decl/material/chem/nutriment/protein/egg = 3, /decl/material/chem/nutriment/flour = 10, /decl/material/gas/water = 10)
...
/datum/chemical_reaction/recipe/food/soydough
	name = "Soy dough"
	required_reagents = list(/decl/material/chem/nutriment/plant_protein = 3, /decl/material/chem/nutriment/flour = 10, /decl/material/gas/water = 10)
	mix_message = "The solution folds and thickens into a large ball of dough."
	obj_result = /obj/item/chems/food/snacks/dough

/datum/chemical_reaction/recipe/food/syntiflesh
	name = "Synthetic Meat"
	required_reagents = list(/decl/material/chem/blood = 5, /decl/material/chem/toxin/plasticide = 1)
...
/datum/chemical_reaction/recipe/food/tofu
	name = "Tofu"
	required_reagents = list(/decl/material/chem/drink/milk/soymilk = 10)
	catalysts = list(/decl/material/chem/enzyme = 5)
...
/datum/chemical_reaction/recipe/food/chocolate_bar
	name = "Soy Chocolate"
	required_reagents = list(/decl/material/chem/drink/milk/soymilk = 2, /decl/material/chem/nutriment/coco = 2, /decl/material/chem/nutriment/sugar = 2)
...
/datum/chemical_reaction/recipe/food/chocolate_bar2
	name = "Milk Chocolate"
	required_reagents = list(/decl/material/chem/drink/milk = 2, /decl/material/chem/nutriment/coco = 2, /decl/material/chem/nutriment/sugar = 2)
	mix_message = "The solution thickens and hardens into a glossy brown substance."
	obj_result = /obj/item/chems/food/snacks/chocolatebar
