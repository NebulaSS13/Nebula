...
/datum/chemical_reaction/recipe/food/cheesewheel
	name = "Cheesewheel"
	required_reagents = list(/decl/material/drink/milk = 40)
...
/datum/chemical_reaction/recipe/food/rawmeatball
	name = "Raw Meatball"
	required_reagents = list(/decl/material/nutriment/protein = 3, /decl/material/nutriment/flour = 5)
	result_amount = 3
...
/datum/chemical_reaction/recipe/food/syntiflesh
	name = "Synthetic Meat"
	required_reagents = list(/decl/material/blood = 5, /decl/material/toxin/plasticide = 1)
...
/datum/chemical_reaction/recipe/food/tofu
	name = "Tofu"
	required_reagents = list(/decl/material/drink/milk/soymilk = 10)
	catalysts = list(/decl/material/enzyme = 5)
...
/datum/chemical_reaction/recipe/food/chocolate_bar
	name = "Soy Chocolate"
	required_reagents = list(/decl/material/drink/milk/soymilk = 2, /decl/material/nutriment/coco = 2, /decl/material/nutriment/sugar = 2)
...
/datum/chemical_reaction/recipe/food/chocolate_bar2
	name = "Milk Chocolate"
	required_reagents = list(/decl/material/drink/milk = 2, /decl/material/nutriment/coco = 2, /decl/material/nutriment/sugar = 2)
	mix_message = "The solution thickens and hardens into a glossy brown substance."
	obj_result = /obj/item/chems/food/snacks/chocolatebar
