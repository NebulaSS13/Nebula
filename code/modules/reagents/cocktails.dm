...
/decl/cocktail/proc/get_presentation_name(var/obj/item/prop)
	. = name
	if(prop?.reagents?.has_reagent(/decl/material/drink/ice) && !(/decl/material/drink/ice in ratios))
		. = "[name], on the rocks"
...
/decl/cocktail/proc/matches(var/obj/item/prop)
	...
	if(!(/decl/material/drink/ice in ratios))
		effective_volume -= REAGENT_VOLUME(prop.reagents, /decl/material/drink/ice)
...
/decl/cocktail/grog
	...
	ratios = list(
		/decl/material/water =       0.5,
		/decl/material/ethanol/rum = 0.2
	)
...
/decl/cocktail/screwdriver
	...
	ratios = list(
		/decl/material/drink/juice/orange = 0.6,
		/decl/material/ethanol/vodka =      0.1
	)
...
/decl/cocktail/tequilla_sunrise
	...
	ratios = list(
		/decl/material/drink/juice/orange = 0.6,
		/decl/material/ethanol/tequilla =   0.1
	)
...
/decl/cocktail/classic_martini
	...
	ratios = list(
		/decl/material/ethanol/gin =      0.4,
		/decl/material/ethanol/vermouth = 0.3
	)
...
/decl/cocktail/vodka_martini
	...
	ratios = list(
		/decl/material/ethanol/vodka =    0.4,
		/decl/material/ethanol/vermouth = 0.3
	)
...
/decl/cocktail/bilk
	...
	ratios = list(
		/decl/material/ethanol/beer = 0.35,
		/decl/material/drink/milk =   0.35
	)
...
/decl/cocktail/black_russian
	...
	ratios = list(
		/decl/material/ethanol/vodka =         0.4,
		/decl/material/ethanol/coffee/kahlua = 0.2
	)
...
/decl/cocktail/white_russian
	...
	ratios = list(
		/decl/material/ethanol/vodka =         0.3,
		/decl/material/ethanol/coffee/kahlua = 0.15,
		/decl/material/drink/milk/cream =      0.15
	)
...
/decl/cocktail/whiskey_cola
	...
	ratios = list(
		/decl/material/ethanol/whiskey = 0.2,
		/decl/material/drink/cola =      0.5
	)
...
/decl/cocktail/bloody_mary
	...
	ratios = list(
		/decl/material/drink/juice/tomato = 0.4,
		/decl/material/ethanol/vodka =      0.15, 
		/decl/material/drink/juice/lime =   0.15
	)
...
/decl/cocktail/livergeist
	...
	ratios = list(
		/decl/material/ethanol/vodka =        0.1,
		/decl/material/ethanol/gin =          0.1,
		/decl/material/ethanol/aged_whiskey = 0.1,
		/decl/material/ethanol/cognac =       0.1,
		/decl/material/drink/juice/lime =     0.1
	)
...
/decl/cocktail/brave_bull
	...
	ratios = list(
		/decl/material/ethanol/tequilla =      0.45,
		/decl/material/ethanol/coffee/kahlua = 0.25
	)
...
/decl/cocktail/phoron_special
	...
	ratios = list(
		/decl/material/ethanol/rum = 0.35,
		/decl/material/ethanol/vermouth = 0.35,
...
/decl/cocktail/beepsky_smash
	...
	ratios = list(
		/decl/material/ethanol/whiskey =  0.4,
		/decl/material/drink/juice/lime = 0.2, 
...
/decl/cocktail/doctor_delight
	...
	ratios = list(
		/decl/material/regenerator =        0.3,
		/decl/material/drink/juice/lime =   0.1, 
		/decl/material/drink/juice/tomato = 0.1, 
		/decl/material/drink/juice/orange = 0.1, 
		/decl/material/drink/milk/cream =   0.1
	)
...
/decl/cocktail/manly_dorf
	...
	ratios = list(
		/decl/material/ethanol/ale =  0.35,
		/decl/material/ethanol/beer = 0.35
	)
...
/decl/cocktail/irish_coffee
	...
	ratios = list(
		/decl/material/drink/coffee =        0.5,
		/decl/material/ethanol/irish_cream = 0.2
	)
...
/decl/cocktail/b52
	...
	ratios = list(
		/decl/material/ethanol/cognac =        0.3,
		/decl/material/ethanol/irish_cream =   0.2,
		/decl/material/ethanol/coffee/kahlua = 0.2
	)
...
/decl/cocktail/margarita
	...
	ratios = list(
		/decl/material/ethanol/tequilla = 0.35,
		/decl/material/drink/juice/lime = 0.35
	)
...
/decl/cocktail/longislandicedtea
	...
	ratios = list(
		/decl/material/drink/cola =       0.2,
		/decl/material/ethanol/rum =      0.1,
		/decl/material/ethanol/vodka =    0.1, 
		/decl/material/ethanol/gin =      0.1, 
		/decl/material/ethanol/tequilla = 0.1	
	)
...
/decl/cocktail/whiskeysoda
	...
	ratios = list(
		/decl/material/ethanol/whiskey = 0.25,
		/decl/material/drink/sodawater = 0.45
	)
...
/decl/cocktail/manhattan
	...
	ratios = list(
		/decl/material/ethanol/whiskey =  0.45,
		/decl/material/ethanol/vermouth = 0.25
	)
...
/decl/cocktail/vodka_tonic
	...
	ratios = list(
		/decl/material/ethanol/vodka = 0.2,
		/decl/material/drink/tonic =   0.5
	)
...
/decl/cocktail/gin_fizz
	...
	ratios = list(
		/decl/material/ethanol/gin =      0.3,
		/decl/material/drink/sodawater =  0.2, 
		/decl/material/drink/juice/lime = 0.2
	)
...
/decl/cocktail/bahama_mama
	...
	ratios = list(
		/decl/material/ethanol/rum =        0.2,
		/decl/material/drink/juice/orange = 0.2,
		/decl/material/drink/juice/lime =   0.2,
		/decl/material/drink/grenadine =    0.1
	)
...
/decl/cocktail/singulo
	...
	ratios = list(
		/decl/material/ethanol/vodka = 0.35,
		/decl/material/ethanol/wine =  0.35,
...
/decl/cocktail/demonsblood
	...
	ratios = list(
		/decl/material/ethanol/rum =      0.2,
		/decl/material/drink/citrussoda = 0.2,
		/decl/material/blood =            0.1,
		/decl/material/drink/cherrycola = 0.2
	)
...
/decl/cocktail/booger
	...
	ratios = list(
		/decl/material/drink/milk/cream =       0.2,
		/decl/material/drink/juice/banana =     0.15, 
		/decl/material/ethanol/rum =            0.2,
		/decl/material/drink/juice/watermelon = 0.15
	)
...
/decl/cocktail/barefoot
	...
	ratios = list(
		/decl/material/ethanol/vermouth =  0.4,
		/decl/material/drink/juice/berry = 0.2, 
		/decl/material/drink/milk/cream =  0.1
	)
...
/decl/cocktail/sbiten
	...
	ratios = list(
		/decl/material/ethanol/mead = 0.6,
		/decl/material/capsaicin =    0.1
	)
...
/decl/cocktail/acidspit
	...
	ratios = list(
		/decl/material/ethanol/wine = 0.7,
		/decl/material/acid
	)
...
/decl/cocktail/changelingsting
	...
	ratios = list(
		/decl/material/ethanol/vodka =      0.4,
		/decl/material/drink/juice/lime =   0.1, 
		/decl/material/drink/juice/lemon =  0.1,
		/decl/material/drink/juice/orange = 0.1
	)
...
/decl/cocktail/snowwhite
	...
	ratios = list(
		/decl/material/ethanol/beer =     0.4,
		/decl/material/drink/lemon_lime = 0.3
	)
...
/decl/cocktail/irishslammer
	...
	ratios = list(
		/decl/material/ethanol/ale =         0.5,
		/decl/material/ethanol/whiskey =     0.1,
		/decl/material/ethanol/irish_cream = 0.1
	)
...
/decl/cocktail/syndicatebomb
	...
	ratios = list(
		/decl/material/ethanol/whiskey = 0.2,
		/decl/material/ethanol/beer =    0.2,
		/decl/material/drink/cola =      0.3
	)
...
/decl/cocktail/hippiesdelight
	...
	ratios = list(
		...
		/decl/material/ethanol/cognac =       0.1,
		/decl/material/drink/juice/lime =     0.1,
		/decl/material/psychotropics =        0.2
	)
...
/decl/cocktail/bananahonk
	...
	ratios = list(
		/decl/material/drink/juice/banana = 0.4,
		/decl/material/drink/milk/cream =   0.2, 
...
/decl/cocktail/ships_surgeon
	...
	ratios = list(
		/decl/material/drink/cherrycola = 0.5,
		/decl/material/ethanol/rum =      0.2
	)
...
/decl/cocktail/vodkacola
	...
	ratios = list(
		/decl/material/ethanol/vodka = 0.5,
		/decl/material/drink/cola =    0.2
	)
...
/decl/cocktail/sawbonesdismay
	...
	ratios = list(
		/decl/material/ethanol/jagermeister = 0.35,
		/decl/material/drink/beastenergy =    0.35
	)
...
/decl/cocktail/patron
	...
	ratios = list(
		/decl/material/ethanol/tequilla = 0.7,
...
/decl/cocktail/rewriter
	...
	ratios = list(
		/decl/material/drink/coffee =     0.35,
		/decl/material/drink/citrussoda = 0.35
	)
...
/decl/cocktail/goldschlager
	...
	ratios = list(
		/decl/material/ethanol/vodka = 0.7,
		/decl/material/gold
	)
...
/decl/cocktail/browndwarf
	...
	ratios = list(
		/decl/material/drink/hot_coco =   0.4, 
		/decl/material/drink/citrussoda = 0.3
	)
...
/decl/cocktail/snowball
	...
	ratios = list(
		/decl/material/drink/ice =              0.3,
		/decl/material/drink/coffee =           0.2,
		/decl/material/drink/juice/watermelon = 0.2
	)
