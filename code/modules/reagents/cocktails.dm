...
/decl/cocktail/proc/get_presentation_name(var/obj/item/prop)
	. = name
	if(prop?.reagents?.has_reagent(/decl/material/gas/water/ice) && !(/decl/material/gas/water/ice in ratios))
		. = "[name], on the rocks"
...
/decl/cocktail/proc/matches(var/obj/item/prop)
	...
	if(!(/decl/material/gas/water/ice in ratios))
		effective_volume -= REAGENT_VOLUME(prop.reagents, /decl/material/gas/water/ice)
...
/decl/cocktail/grog
	...
	ratios = list(
		/decl/material/gas/water =       0.5,
		/decl/material/chem/ethanol/rum = 0.2
	)
...
/decl/cocktail/screwdriver
	...
	ratios = list(
		/decl/material/chem/drink/juice/orange = 0.6,
		/decl/material/chem/ethanol/vodka =      0.1
	)
...
/decl/cocktail/tequilla_sunrise
	...
	ratios = list(
		/decl/material/chem/drink/juice/orange = 0.6,
		/decl/material/chem/ethanol/tequilla =   0.1
	)
...
/decl/cocktail/classic_martini
	...
	ratios = list(
		/decl/material/chem/ethanol/gin =      0.4,
		/decl/material/chem/ethanol/vermouth = 0.3
	)
...
/decl/cocktail/vodka_martini
	...
	ratios = list(
		/decl/material/chem/ethanol/vodka =    0.4,
		/decl/material/chem/ethanol/vermouth = 0.3
	)
...
/decl/cocktail/allies_cocktail
	...
	ratios = list(
		/decl/material/chem/ethanol/vermouth = 0.3,
		/decl/material/chem/ethanol/vodka =    0.1,
		/decl/material/chem/ethanol/gin =      0.3
	)
...
/decl/cocktail/bilk
	...
	ratios = list(
		/decl/material/chem/ethanol/beer = 0.35,
		/decl/material/chem/drink/milk =   0.35
	)
...
/decl/cocktail/gin_and_tonic
	...
	ratios = list(
		/decl/material/chem/drink/tonic = 0.4,
		/decl/material/chem/ethanol/gin = 0.3
	)
...
/decl/cocktail/cuba_libre
	...
	ratios = list(
		/decl/material/chem/ethanol/rum = 0.2,
		/decl/material/chem/drink/cola =  0.5
	)
...
/decl/cocktail/black_russian
	...
	ratios = list(
		/decl/material/chem/ethanol/vodka =         0.4,
		/decl/material/chem/ethanol/coffee/kahlua = 0.2
	)
...
/decl/cocktail/white_russian
	...
	ratios = list(
		/decl/material/chem/ethanol/vodka =         0.3,
		/decl/material/chem/ethanol/coffee/kahlua = 0.15,
		/decl/material/chem/drink/milk/cream =      0.15
	)
...
/decl/cocktail/whiskey_cola
	...
	ratios = list(
		/decl/material/chem/ethanol/whiskey = 0.2,
		/decl/material/chem/drink/cola =      0.5
	)
...
/decl/cocktail/bloody_mary
	...
	ratios = list(
		/decl/material/chem/drink/juice/tomato = 0.4,
		/decl/material/chem/ethanol/vodka =      0.15, 
		/decl/material/chem/drink/juice/lime =   0.15
	)
...
/decl/cocktail/livergeist
	...
	ratios = list(
		/decl/material/chem/ethanol/vodka =        0.1,
		/decl/material/chem/ethanol/gin =          0.1,
		/decl/material/chem/ethanol/aged_whiskey = 0.1,
		/decl/material/chem/ethanol/cognac =       0.1,
		/decl/material/chem/drink/juice/lime =     0.1
	)
...
/decl/cocktail/brave_bull
	...
	ratios = list(
		/decl/material/chem/ethanol/tequilla =      0.45,
		/decl/material/chem/ethanol/coffee/kahlua = 0.25
	)
...
/decl/cocktail/phoron_special
	...
	ratios = list(
		/decl/material/chem/ethanol/rum = 0.35,
		/decl/material/chem/ethanol/vermouth = 0.35,
...
/decl/cocktail/beepsky_smash
	...
	ratios = list(
		/decl/material/chem/ethanol/whiskey =  0.4,
		/decl/material/chem/drink/juice/lime = 0.2, 
		/decl/material/iron =             0.1
	)
...
/decl/cocktail/doctor_delight
	...
	ratios = list(
		/decl/material/chem/regenerator =        0.3,
		/decl/material/chem/drink/juice/lime =   0.1, 
		/decl/material/chem/drink/juice/tomato = 0.1, 
		/decl/material/chem/drink/juice/orange = 0.1, 
		/decl/material/chem/drink/milk/cream =   0.1
	)
...
/decl/cocktail/manly_dorf
	...
	ratios = list(
		/decl/material/chem/ethanol/ale =  0.35,
		/decl/material/chem/ethanol/beer = 0.35
	)
...
/decl/cocktail/irish_coffee
	...
	ratios = list(
		/decl/material/chem/drink/coffee =        0.5,
		/decl/material/chem/ethanol/irish_cream = 0.2
	)
...
/decl/cocktail/b52
	...
	ratios = list(
		/decl/material/chem/ethanol/cognac =        0.3,
		/decl/material/chem/ethanol/irish_cream =   0.2,
		/decl/material/chem/ethanol/coffee/kahlua = 0.2
	)
...
/decl/cocktail/margarita
	...
	ratios = list(
		/decl/material/chem/ethanol/tequilla = 0.35,
		/decl/material/chem/drink/juice/lime = 0.35
	)
...
/decl/cocktail/longislandicedtea
	...
	ratios = list(
		/decl/material/chem/drink/cola =       0.2,
		/decl/material/chem/ethanol/rum =      0.1,
		/decl/material/chem/ethanol/vodka =    0.1, 
		/decl/material/chem/ethanol/gin =      0.1, 
		/decl/material/chem/ethanol/tequilla = 0.1	
	)
...
/decl/cocktail/whiskeysoda
	...
	ratios = list(
		/decl/material/chem/ethanol/whiskey = 0.25,
		/decl/material/chem/drink/sodawater = 0.45
	)
...
/decl/cocktail/manhattan
	...
	ratios = list(
		/decl/material/chem/ethanol/whiskey =  0.45,
		/decl/material/chem/ethanol/vermouth = 0.25
	)
...
/decl/cocktail/vodka_tonic
	...
	ratios = list(
		/decl/material/chem/ethanol/vodka = 0.2,
		/decl/material/chem/drink/tonic =   0.5
	)
...
/decl/cocktail/gin_fizz
	...
	ratios = list(
		/decl/material/chem/ethanol/gin =      0.3,
		/decl/material/chem/drink/sodawater =  0.2, 
		/decl/material/chem/drink/juice/lime = 0.2
	)
...
/decl/cocktail/bahama_mama
	...
	ratios = list(
		/decl/material/chem/ethanol/rum =        0.2,
		/decl/material/chem/drink/juice/orange = 0.2,
		/decl/material/chem/drink/juice/lime =   0.2,
		/decl/material/chem/drink/grenadine =    0.1
	)
...
/decl/cocktail/singulo
	...
	ratios = list(
		/decl/material/chem/ethanol/vodka = 0.35,
		/decl/material/chem/ethanol/wine =  0.35,
...
/decl/cocktail/demonsblood
	...
	ratios = list(
		/decl/material/chem/ethanol/rum =      0.2,
		/decl/material/chem/drink/citrussoda = 0.2,
		/decl/material/chem/blood =            0.1,
		/decl/material/chem/drink/cherrycola = 0.2
	)
...
/decl/cocktail/booger
	...
	ratios = list(
		/decl/material/chem/drink/milk/cream =       0.2,
		/decl/material/chem/drink/juice/banana =     0.15, 
		/decl/material/chem/ethanol/rum =            0.2,
		/decl/material/chem/drink/juice/watermelon = 0.15
	)
...
/decl/cocktail/antifreeze
	...
	ratios = list(
		/decl/material/chem/ethanol/vodka =    0.3,
		/decl/material/chem/drink/milk/cream = 0.2, 
		/decl/material/gas/water/ice =        0.2
	)
...
/decl/cocktail/barefoot
	...
	ratios = list(
		/decl/material/chem/ethanol/vermouth =  0.4,
		/decl/material/chem/drink/juice/berry = 0.2, 
		/decl/material/chem/drink/milk/cream =  0.1
	)
...
/decl/cocktail/sbiten
	...
	ratios = list(
		/decl/material/chem/ethanol/mead = 0.6,
		/decl/material/chem/capsaicin =    0.1
	)
...
/decl/cocktail/acidspit
	...
	ratios = list(
		/decl/material/chem/ethanol/wine = 0.7,
...
/decl/cocktail/changelingsting
	...
	ratios = list(
		/decl/material/chem/ethanol/vodka =      0.4,
		/decl/material/chem/drink/juice/lime =   0.1, 
		/decl/material/chem/drink/juice/lemon =  0.1,
		/decl/material/chem/drink/juice/orange = 0.1
	)
...
/decl/cocktail/neurotoxin
	...
	ratios = list(
		...
		/decl/material/chem/ethanol/cognac =       0.1,
		/decl/material/chem/drink/juice/lime =     0.1,
		/decl/material/chem/sedatives =            0.1
	)
...
/decl/cocktail/snowwhite
	...
	ratios = list(
		/decl/material/chem/ethanol/beer =     0.4,
		/decl/material/chem/drink/lemon_lime = 0.3
	)
...
/decl/cocktail/irishslammer
	...
	ratios = list(
		/decl/material/chem/ethanol/ale =         0.5,
		/decl/material/chem/ethanol/whiskey =     0.1,
		/decl/material/chem/ethanol/irish_cream = 0.1
	)
...
/decl/cocktail/syndicatebomb
	...
	ratios = list(
		/decl/material/chem/ethanol/whiskey = 0.2,
		/decl/material/chem/ethanol/beer =    0.2,
		/decl/material/chem/drink/cola =      0.3
	)
...
/decl/cocktail/devilskiss
	...
	ratios = list(
		/decl/material/chem/ethanol/rum =           0.4,
		/decl/material/chem/blood =                 0.1, 
		/decl/material/chem/ethanol/coffee/kahlua = 0.2
	)
...
/decl/cocktail/hippiesdelight
	...
	ratios = list(
		...
		/decl/material/chem/ethanol/cognac =       0.1,
		/decl/material/chem/drink/juice/lime =     0.1,
		/decl/material/chem/psychotropics =        0.2
	)
...
/decl/cocktail/bananahonk
	...
	ratios = list(
		/decl/material/chem/drink/juice/banana = 0.4,
		/decl/material/chem/drink/milk/cream =   0.2, 
...
/decl/cocktail/ships_surgeon
	...
	ratios = list(
		/decl/material/chem/drink/cherrycola = 0.5,
		/decl/material/chem/ethanol/rum =      0.2
	)
...
/decl/cocktail/vodkacola
	...
	ratios = list(
		/decl/material/chem/ethanol/vodka = 0.5,
		/decl/material/chem/drink/cola =    0.2
	)
...
/decl/cocktail/sawbonesdismay
	...
	ratios = list(
		/decl/material/chem/ethanol/jagermeister = 0.35,
		/decl/material/chem/drink/beastenergy =    0.35
	)
...
/decl/cocktail/patron
	...
	ratios = list(
		/decl/material/chem/ethanol/tequilla = 0.7,
...
/decl/cocktail/rewriter
	...
	ratios = list(
		/decl/material/chem/drink/coffee =     0.35,
		/decl/material/chem/drink/citrussoda = 0.35
	)
...
/decl/cocktail/goldschlager
	...
	ratios = list(
		/decl/material/chem/ethanol/vodka = 0.7,
		/decl/material/gold
	)
...
/decl/cocktail/browndwarf
	...
	ratios = list(
		/decl/material/chem/drink/hot_coco =   0.4, 
		/decl/material/chem/drink/citrussoda = 0.3
	)
...
/decl/cocktail/snowball
	...
	ratios = list(
		/decl/material/gas/water/ice =              0.3,
		/decl/material/chem/drink/coffee =           0.2,
		/decl/material/chem/drink/juice/watermelon = 0.2
	)
