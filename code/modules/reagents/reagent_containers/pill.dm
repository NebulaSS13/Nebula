...
/obj/item/chems/pill/antitox/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/antitoxins, 25)
...
/obj/item/chems/pill/tox/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/toxin, 50)
	color = reagents.get_color()
...
/obj/item/chems/pill/cyanide/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/toxin/cyanide, 50)
...
/obj/item/chems/pill/adminordrazine/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/adminordrazine, 1)
...
/obj/item/chems/pill/stox/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/sedatives, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/burn_meds/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/burn_meds, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/painkillers/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/painkillers, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/adrenaline/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/adrenaline, 30)
	color = reagents.get_color()
...
/obj/item/chems/pill/oxygen/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/oxy_meds, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/brute_meds/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/brute_meds, 20)
	color = reagents.get_color()
...
/obj/item/chems/pill/happy/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/psychoactives, 15)
	reagents.add_reagent(/decl/material/chem/nutriment/sugar, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/zoom/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/narcotics, 5)
	reagents.add_reagent(/decl/material/chem/antidepressants, 5)
	reagents.add_reagent(/decl/material/chem/stimulants, 5)
...
/obj/item/chems/pill/gleam/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/glowsap/gleam, 10)
	color = reagents.get_color()
...
/obj/item/chems/pill/antibiotics/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/antibiotics, 10)
	color = reagents.get_color()
...
/obj/item/chems/pill/stimulants/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/stimulants, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/antidepressants/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/antidepressants, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/antirads/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/antirads, 7)
	color = reagents.get_color()
...
/obj/item/chems/pill/antirad/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/antirads, 5)
	reagents.add_reagent(/decl/material/chem/antitoxins, 10)
...
/obj/item/chems/pill/detergent/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/ammonia, 30)
...
/obj/item/chems/pill/pod/cream_soy/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/drink/milk/soymilk, 5)
	color = reagents.get_color()
...
/obj/item/chems/pill/pod/mint/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/drink/syrup/mint, 1) //mint is used as a catalyst in all reactions as of writing
	color = reagents.get_color()
