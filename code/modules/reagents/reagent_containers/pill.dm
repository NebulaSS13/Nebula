...
/obj/item/chems/pill/antitox/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/antitoxins, 25)
...
/obj/item/chems/pill/tox/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/toxin, 50)
	color = reagents.get_color()
...
/obj/item/chems/pill/cyanide/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/toxin/cyanide, 50)
...
/obj/item/chems/pill/adminordrazine/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/adminordrazine, 1)
...
/obj/item/chems/pill/stox/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/sedatives, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/burn_meds/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/burn_meds, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/painkillers/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/painkillers, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/adrenaline/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/adrenaline, 30)
	color = reagents.get_color()
...
/obj/item/chems/pill/oxygen/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/oxy_meds, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/antitoxins/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/antitoxins, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/brute_meds/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/brute_meds, 20)
	color = reagents.get_color()
...
/obj/item/chems/pill/happy/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/psychoactives, 15)
	reagents.add_reagent(/decl/material/nutriment/sugar, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/zoom/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/narcotics, 5)
	reagents.add_reagent(/decl/material/antidepressants, 5)
	reagents.add_reagent(/decl/material/stimulants, 5)
...
/obj/item/chems/pill/gleam/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/glowsap/gleam, 10)
	color = reagents.get_color()
...
/obj/item/chems/pill/antibiotics/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/antibiotics, 10)
	color = reagents.get_color()
...
/obj/item/chems/pill/stimulants/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/stimulants, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/antidepressants/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/antidepressants, 15)
	color = reagents.get_color()
...
/obj/item/chems/pill/antirads/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/antirads, 7)
	color = reagents.get_color()
...
/obj/item/chems/pill/antirad/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/antirads, 5)
	reagents.add_reagent(/decl/material/antitoxins, 10)
...
/obj/item/chems/pill/pod/cream_soy/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/drink/milk/soymilk, 5)
	color = reagents.get_color()
...
/obj/item/chems/pill/pod/orange/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/drink/juice/orange, 5)
	color = reagents.get_color()
...
/obj/item/chems/pill/pod/mint/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/drink/syrup/mint, 1) //mint is used as a catalyst in all reactions as of writing
	color = reagents.get_color()
