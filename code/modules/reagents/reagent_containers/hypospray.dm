...
/obj/item/chems/hypospray/autoinjector
	...
	var/list/starts_with = list(/decl/material/chem/adrenaline = 5)
...
/obj/item/chems/hypospray/autoinjector/antirad
	...
	starts_with = list(/decl/material/chem/antirads = 5)

/obj/item/chems/hypospray/autoinjector/hallucinogenics
	name = "autoinjector"
	band_color = COLOR_DARK_GRAY
	starts_with = list(/decl/material/chem/hallucinogenics = 5)
