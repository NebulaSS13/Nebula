...
/obj/item/chems/drinks/cans/thirteenloko
	...
	starting_reagents = list(/decl/material/liquid/ethanol/thirteenloko)
...
/obj/item/chems/drinks/cans/dr_gibb
	...
	icon_state = "dr_gibb"
	center_of_mass = @"{'x':16,'y':10}"
	starting_reagents = list(/decl/material/liquid/drink/cherrycola)
...
/obj/item/chems/drinks/cans/starkist
	...
	icon_state = "starkist"
	center_of_mass = @"{'x':16,'y':10}"
	starting_reagents = list(/decl/material/liquid/drink/orangecola)
...
/obj/item/chems/drinks/cans/lemon_lime
	...
	center_of_mass = @"{'x':16,'y':10}"
	starting_reagents = list(/decl/material/liquid/drink/lemon_lime)
...
/obj/item/chems/drinks/cans/iced_tea
	...
	starting_reagents = list(
		/decl/material/liquid/drink/tea/black = 35,
		/decl/material/solid/ice = 5,
	)
...
/obj/item/chems/drinks/cans/tonic
	...
	icon_state = "tonic"
	center_of_mass = @"{'x':16,'y':10}"
	starting_reagents = list(/decl/material/liquid/drink/tonic)
...
/obj/item/chems/drinks/cans/sodawater
	...
	center_of_mass = @"{'x':16,'y':10}"
	starting_reagents = list(/decl/material/liquid/drink/sodawater)
...
/obj/item/chems/drinks/cans/beastenergy
	...
	starting_reagents = list(/decl/material/liquid/drink/beastenergy)
...
/obj/item/chems/drinks/cans/syndicolax
	...
	center_of_mass = @"{'x':16,'y':10}"
	starting_reagents = list(/decl/material/liquid/drink/juice/potato)
...
/obj/item/chems/drinks/cans/artbru
	...
	icon_state = "art_bru"
	center_of_mass = @"{'x':16,'y':10}"
	starting_reagents = list(/decl/material/liquid/drink/juice/turnip)
...
/obj/item/chems/drinks/glass2/square/bodaplus
	...
	center_of_mass = @"{'x':16,'y':10}"
	starting_reagents = list(/decl/material/liquid/drink/sodawater = 15)

/obj/item/chems/drinks/glass2/square/bodaplus/initialize_reagents(populate = TRUE)
	if(populate)
		var/reag = pick(list(
		...
		LAZYINSERT(starting_reagents, 15, reag)
	. = ..()
...
/obj/item/chems/drinks/cans/speer
	...
	icon_state = "beercan"
	center_of_mass = @"{'x':16,'y':10}"
	starting_reagents = list(/decl/material/liquid/ethanol/beer/good)
...
/obj/item/chems/drinks/cans/ale
	...
	icon_state = "alecan"
	center_of_mass = @"{'x':16,'y':10}"
	starting_reagents = list(/decl/material/liquid/ethanol/ale)
