...
/obj/item/chems/glass/bottle/toxin/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/toxin, 60)
	update_icon()
...
/obj/item/chems/glass/bottle/cyanide/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/toxin/cyanide, 30) //volume changed to match chloral
	update_icon()
...
/obj/item/chems/glass/bottle/sedatives/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/sedatives, 60)
	update_icon()
...
/obj/item/chems/glass/bottle/mutagenics/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/mutagenics, 60)
	update_icon()
...
/obj/item/chems/glass/bottle/adminordrazine/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/adminordrazine, 60)
	update_icon()
...
/obj/item/chems/glass/bottle/capsaicin/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/capsaicin, 60)
	update_icon()
...
/obj/item/chems/glass/bottle/frostoil/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/frostoil, 60)
	update_icon()
