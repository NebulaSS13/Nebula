...
/obj/item/chems/syringe/ld50_syringe/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/toxin/heartstopper, 60)
	mode = SYRINGE_INJECT
	update_icon()
...
/obj/item/chems/syringe/adrenaline/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/adrenaline, 15)
	mode = SYRINGE_INJECT
	update_icon()
...
/obj/item/chems/syringe/antibiotic/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/antibiotics, 15)
	mode = SYRINGE_INJECT
	update_icon()
...
/obj/item/chems/syringe/drugs/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/psychoactives, 5)
	reagents.add_reagent(/decl/material/hallucinogenics, 5)
	reagents.add_reagent(/decl/material/presyncopics, 5)
	mode = SYRINGE_INJECT
	update_icon()
...
/obj/item/chems/syringe/steroid/Initialize()
	...
	reagents.add_reagent(/decl/material/amphetamines, 10)
