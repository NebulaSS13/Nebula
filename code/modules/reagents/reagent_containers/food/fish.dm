/obj/item/chems/food/snacks/fish
	...
	bitesize = 6
	nutriment_amt = 6
	nutriment_type = /decl/material/nutriment/protein
	var/fish_type = "fish"
...
/obj/item/chems/food/snacks/fish/attackby(var/obj/item/W, var/mob/user)
	if(is_sharp(W) && (locate(/obj/structure/table) in loc))
		...
		var/toxin_amt = REAGENT_VOLUME(reagents, /decl/material/toxin/carpotoxin)
		if(toxin_amt && !prob(user.skill_fail_chance(SKILL_COOKING, 100, SKILL_PROF)))
			reagents.remove_reagent(/decl/material/toxin/carpotoxin, toxin_amt)
...
/obj/item/chems/food/snacks/fish/poison/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/toxin/carpotoxin, 6)
...
/obj/item/chems/food/snacks/fish/mollusc
	...
	fish_type = "mollusc"
	nutriment_type = /decl/material/nutriment/slime_meat
