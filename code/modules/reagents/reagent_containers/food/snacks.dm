...
/obj/item/chems/food/snacks
	...
	var/dry = 0
	var/nutriment_amt = 0
	var/nutriment_type = /decl/reagent/nutriment // Used to determine which base nutriment type is spawned for this item.
...
/obj/item/chems/food/snacks/egg/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein/egg, 3)
...
/obj/item/chems/food/snacks/egg/lizard/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein/egg, 5)
...
/obj/item/chems/food/snacks/friedegg/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 3)
	reagents.add_reagent(/decl/reagent/sodiumchloride, 1)
	reagents.add_reagent(/decl/reagent/blackpepper, 1)
...
/obj/item/chems/food/snacks/boiledegg/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 2)
...
/obj/item/chems/food/snacks/tofu/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/plant_protein, 6)
...
/obj/item/chems/food/snacks/hugemushroomslice/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/psychotropics, 3)
...
/obj/item/chems/food/snacks/bearmeat/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 12)
...
/obj/item/chems/food/snacks/spider/Initialize()
	. = ..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 9)
...
/obj/item/chems/food/snacks/xenomeat/Initialize()
	...
	reagents.add_reagent(/decl/reagent/acid/polyacid,6)
...
/obj/item/chems/food/snacks/fatsausage/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 8)
...
/obj/item/chems/food/snacks/donkpocket
	...
	nutriment_amt = 2
	var/warm = 0
	var/list/heated_reagents = list(/decl/reagent/regenerator = 5)
...
/obj/item/chems/food/snacks/brainburger/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 6)
	reagents.add_reagent(/decl/reagent/neuroannealer, 6)
...
/obj/item/chems/food/snacks/roburger/Initialize()
	.=..()
	if(prob(5))
		reagents.add_reagent(/decl/reagent/nanitefluid, 2)
...
/obj/item/chems/food/snacks/roburgerbig/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nanitefluid, 100)
...
/obj/item/chems/food/snacks/pie/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/banana_cream,5)
...
/obj/item/chems/food/snacks/berryclafoutis/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/drink/juice/berry, 5)
...
/obj/item/chems/food/snacks/soylentgreen/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 10)
...
/obj/item/chems/food/snacks/amanita_pie/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/toxin/amatoxin, 3)
	reagents.add_reagent(/decl/reagent/psychotropics, 1)
...
/obj/item/chems/food/snacks/badrecipe/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/toxin, 1)
	reagents.add_reagent(/decl/reagent/carbon, 3)
...
/obj/item/chems/food/snacks/loadedsteak/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 2)
	reagents.add_reagent(/decl/reagent/nutriment/garlicsauce, 2)
...
/obj/item/chems/food/snacks/spacylibertyduff/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/psychotropics, 6)
...
/obj/item/chems/food/snacks/amanitajelly/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/toxin/amatoxin, 6)
	reagents.add_reagent(/decl/reagent/psychotropics, 3)
...
/obj/item/chems/food/snacks/slimesoup/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/toxin/slimejelly, 5)
...
/obj/item/chems/food/snacks/clownstears/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/drink/juice/banana, 5)
	reagents.add_reagent(/decl/reagent/water, 10)
...
/obj/item/chems/food/snacks/mysterysoup/Initialize()
	...
	switch(rand(1,10))
		if(1)
			...
			reagents.add_reagent(/decl/reagent/capsaicin, 3)
			reagents.add_reagent(/decl/reagent/drink/juice/tomato, 2)
		if(2)
			reagents.add_reagent(/decl/reagent/nutriment, 6)
		...
		if(5)
			...
			reagents.add_reagent(/decl/reagent/drink/juice/banana, 10)
		if(6)
			reagents.add_reagent(/decl/reagent/nutriment, 6)
			reagents.add_reagent(/decl/reagent/blood, 10)
		if(7)
			reagents.add_reagent(/decl/reagent/toxin/slimejelly, 10)
			reagents.add_reagent(/decl/reagent/water, 10)
		if(8)
		...
		if(9)
			reagents.add_reagent(/decl/reagent/nutriment, 5)
			reagents.add_reagent(/decl/reagent/drink/juice/tomato, 10)
		if(10)
			reagents.add_reagent(/decl/reagent/nutriment, 6)
			reagents.add_reagent(/decl/reagent/drink/juice/tomato, 5)
			reagents.add_reagent(/decl/reagent/eyedrops, 5)
...
/obj/item/chems/food/snacks/enchiladas/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 6)
	reagents.add_reagent(/decl/reagent/capsaicin, 6)
...
/obj/item/chems/food/snacks/baguette
	...
	nutriment_amt = 6
	bitesize = 3
	nutriment_type = /decl/reagent/nutriment/bread
...
/obj/item/chems/food/snacks/toastedsandwich/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 3)
	reagents.add_reagent(/decl/reagent/carbon, 2)
...
/obj/item/chems/food/snacks/rofflewaffles/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/psychotropics, 8)
...
/obj/item/chems/food/snacks/jelliedtoast/cherry/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/cherryjelly, 5)
...
/obj/item/chems/food/snacks/nanopasta/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nanitefluid, 10)
...
/obj/item/chems/food/snacks/carrotfries/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/eyedrops, 3)
...
/obj/item/chems/food/snacks/superbiteburger/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 25)
...
/obj/item/chems/food/snacks/sliceable/meatbread/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 20)
...
/obj/item/chems/food/snacks/sliceable/bananabread/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/banana_cream, 20)
...
/obj/item/chems/food/snacks/sliceable/carrotcake
	...
	nutriment_amt = 25
	bitesize = 2
	nutriment_type = /decl/reagent/nutriment/bread/cake

/obj/item/chems/food/snacks/sliceable/carrotcake/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/eyedrops, 10)
...
/obj/item/chems/food/snacks/sliceable/braincake/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 25)
	reagents.add_reagent(/decl/reagent/neuroannealer, 10)
...
/obj/item/chems/food/snacks/sliceable/birthdaycake/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/sprinkles, 10)
...
/obj/item/chems/food/snacks/sliceable/pizza/margherita/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 5)
	reagents.add_reagent(/decl/reagent/drink/juice/tomato, 6)
...
/obj/item/chems/food/snacks/sliceable/pizza/meatpizza/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 34)
	reagents.add_reagent(/decl/reagent/nutriment/barbecue, 6)
...
/obj/item/chems/food/snacks/sliceable/pizza/vegetablepizza/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 5)
	reagents.add_reagent(/decl/reagent/nutriment/ketchup, 6)
	reagents.add_reagent(/decl/reagent/eyedrops, 12)
...
//	.=..()
//	reagents.add_reagent(/decl/reagent/nutriment/protein, 1)
...
/obj/item/chems/food/snacks/classichotdog/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 16)
...
/obj/item/chems/food/snacks/canned/tomato/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/drink/juice/tomato, 12)
...
/obj/item/chems/food/snacks/canned/spinach/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment, 5,
						/decl/reagent/adrenaline, 5,
						/decl/reagent/amphetamines, 5,
						/decl/reagent/iron, 5)
...
/obj/item/chems/food/snacks/caviar/true/Initialize()
	. = ..()
	reagents.add_reagent(/decl/reagent/nutriment/protein, 4)
	reagents.add_reagent(/decl/reagent/toxin/carpotoxin, 1)
...
/obj/item/chems/food/snacks/liquidfood/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/iron, 3)
...
/obj/item/chems/food/snacks/candy/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/sugar, 3)
...
/obj/item/chems/food/snacks/candy/donor/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment, 10)
	reagents.add_reagent(/decl/reagent/nutriment/sugar, 3)
...
/obj/item/chems/food/snacks/candy_corn/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment, 4)
	reagents.add_reagent(/decl/reagent/nutriment/sugar, 2)
...
/obj/item/chems/food/snacks/chocolatebar/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/sugar, 2)
	reagents.add_reagent(/decl/reagent/nutriment/coco, 2)
...
/obj/item/chems/food/snacks/donut/normal/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/nutriment/sprinkles, 1)
...
/obj/item/chems/food/snacks/venus/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/capsaicin = 5)
...
/obj/item/chems/food/snacks/oort/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/frostoil = 5)
...
/obj/item/chems/food/snacks/weebonuts/Initialize()
	.=..()
	reagents.add_reagent(/decl/reagent/capsaicin = 1)
