/obj/item/chems/food/sliceable/pizza
	...
	abstract_type = /obj/item/chems/food/sliceable/pizza
...
/obj/item/chems/food/sliceable/pizza/proc/ruin()
	if(!ruined)
		ruined = TRUE
		name = "ruined [name]"
		update_icon()

/obj/item/chems/food/sliceable/pizza/on_update_icon()
	. = ..()
...
/obj/item/chems/food/slice/pizza
	icon = 'icons/obj/food/pizzas/pizza_slices.dmi'
	filling_color = "#baa14c"
	bitesize = 2
	center_of_mass = @'{"x":18,"y":13}'
	abstract_type = /obj/item/chems/food/slice/pizza
