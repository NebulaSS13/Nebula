...
/obj/item/chems/food/loadedsteak/Initialize()
	. = ..()
	reagents.add_reagent_by_id(/decl/material/liquid/nutriment/protein, 2)
	reagents.add_reagent_by_id(/decl/material/liquid/nutriment/garlicsauce, 2)
...
/obj/item/chems/food/spider/Initialize()
	. = ..()
	reagents.add_reagent_by_id(/decl/material/liquid/nutriment/protein, 9)
...
/obj/item/chems/food/xenomeat/Initialize()
	...
	reagents.add_reagent_by_id(/decl/material/liquid/acid/polyacid,6)
...
/obj/item/chems/food/organ/Initialize()
	. = ..()
	reagents.add_reagent_by_id(/decl/material/liquid/nutriment/protein, rand(3,5))
	reagents.add_reagent_by_id(/decl/material/liquid/bromide, rand(1,3))
