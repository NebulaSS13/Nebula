...
/obj/item/chems/food/jerky/Initialize()
	. = ..()
	if(meat_name)
		set_meat_name(meat_name)

/obj/item/chems/food/jerky/proc/set_meat_name(new_meat_name)
...
/obj/item/chems/food/jerky/cutlet/set_meat_name(new_meat_name)
	. = ..()
	SetName("[name] stick")
