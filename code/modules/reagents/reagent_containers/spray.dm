...
/obj/item/chems/spray/afterattack(atom/A, mob/user, proximity)
	...
	if(reagents.has_reagent(/decl/material/chem/acid))
		log_and_message_admins("fired sulphuric acid from \a [src].", user)
	if(reagents.has_reagent(/decl/material/chem/acid/polyacid))
...
/obj/item/chems/spray/cleaner/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/cleaner, volume)
...
/obj/item/chems/spray/antiseptic/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/antiseptic, volume)
...
/obj/item/chems/spray/hair_remover/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/toxin/hair_remover, volume)
...
/obj/item/chems/spray/pepper/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/capsaicin/condensed, 60)
...
/obj/item/chems/spray/plantbgone/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/toxin/plantbgone, 100)
