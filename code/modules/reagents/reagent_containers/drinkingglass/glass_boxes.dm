...
/obj/item/storage/box/glasses
	name = "box of glasses"
	var/glass_type = /obj/item/chems/food/drinks/glass2
	can_hold = list(/obj/item/chems/food/drinks/glass2)
