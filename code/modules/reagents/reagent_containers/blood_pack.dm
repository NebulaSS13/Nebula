...
/obj/item/chems/ivbag/nanoblood/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/chem/nanoblood, volume)
...
/obj/item/chems/ivbag/blood/Initialize()
	...
	if(blood_type)
		...
		reagents.add_reagent(/decl/material/chem/blood, volume, list("donor" = null, "blood_DNA" = null, "blood_type" = blood_type, "trace_chem" = null))
