...
/obj/item/chems/ivbag/nanoblood/Initialize()
	. = ..()
	reagents.add_reagent(/decl/material/nanoblood, volume)
...
/obj/item/chems/ivbag/blood/Initialize()
	...
	if(blood_type)
		...
		reagents.add_reagent(/decl/material/blood, volume, list("donor" = null, "blood_DNA" = null, "blood_type" = blood_type, "trace_chem" = null))
