...
/decl/material/chem/drink/affect_blood(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	M.adjustToxLoss(removed) // Probably not a good idea; not very deadly though

/decl/material/chem/drink/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	if(nutrition)
...
/decl/material/chem/drink/juice/banana
	name = "banana juice"
...
/decl/material/chem/drink/juice/berry
	name = "berry juice"
...
/decl/material/chem/drink/juice/carrot
	name = "carrot juice"
...
/decl/material/chem/drink/juice/carrot/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
	M.reagents.add_reagent(/decl/material/chem/eyedrops, removed * 0.2)

/decl/material/chem/drink/juice/grape
	name = "grape juice"
...
/decl/material/chem/drink/juice/lemon
	name = "lemon juice"
...
/decl/material/chem/drink/juice/lime/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
...
/decl/material/chem/drink/juice/orange/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
	M.adjustOxyLoss(-2 * removed)

/decl/material/chem/toxin/poisonberryjuice // It has more in common with toxins than drinks... but it's a juice
...
/decl/material/chem/drink/juice/potato
	name = "potato juice"
...
/decl/material/chem/drink/juice/garlic
	name = "garlic juice"
...
/decl/material/chem/drink/juice/onion
	name = "onion juice"
...
/decl/material/chem/drink/juice/tomato
	name = "tomato juice"
...
/decl/material/chem/drink/juice/tomato/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
...
/decl/material/chem/drink/juice/turnip
	name = "turnip juice"
...
/decl/material/chem/drink/juice/apple
	name = "apple juice"
...
/decl/material/chem/drink/juice/pear
	name = "pear juice"
...
/decl/material/chem/drink/milk/chocolate
	name = "chocolate milk"
...
/decl/material/chem/drink/milk/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
	M.heal_organ_damage(0.5 * removed, 0)
	holder.remove_reagent(/decl/material/chem/capsaicin, 10 * removed)

/decl/material/chem/drink/milk/cream
	name = "cream"
...
/decl/material/chem/drink/milk/soymilk
	name = "soy milk"
...
/decl/material/chem/drink/coffee/Initialize()
	. = ..()
	var/list/syrups = decls_repository.get_decls_of_subtype(/decl/material/chem/drink/syrup)
	for(var/stype in syrups)
		var/inserted
		var/decl/material/chem/drink/syrup/syrup = syrups[stype]
		for(var/i = 1 to length(flavour_modifiers))
			var/decl/material/chem/drink/syrup/osyrup = flavour_modifiers[i]
...
/decl/material/chem/drink/coffee/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
	if(adj_temp > 0)
		holder.remove_reagent(/decl/material/chem/frostoil, 10 * removed)
...
/decl/material/chem/drink/coffee/affect_blood(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
	M.add_chemical_effect(CE_PULSE, 2)

/decl/material/chem/drink/coffee/affect_overdose(var/mob/living/carbon/M, var/alien, var/datum/reagents/holder)
	M.make_jittery(5)
	M.add_chemical_effect(CE_PULSE, 1)

/decl/material/chem/drink/coffee/build_presentation_name_from_reagents(var/obj/item/prop, var/supplied)

	var/is_flavoured
	for(var/decl/material/chem/drink/syrup/syrup in flavour_modifiers)
		if(prop.reagents.has_reagent(syrup.type))
			is_flavoured = TRUE
			. = "[.][syrup.coffee_modifier] "

	var/milk =  REAGENT_VOLUME(prop.reagents, /decl/material/chem/drink/milk)
	var/soy =   REAGENT_VOLUME(prop.reagents, /decl/material/chem/drink/milk/soymilk)
	var/cream = REAGENT_VOLUME(prop.reagents, /decl/material/chem/drink/milk/cream)
	var/chai =  REAGENT_VOLUME(prop.reagents, /decl/material/chem/drink/tea/chai) ? "dirty " : ""
	if(!soy && !milk && !cream)
		if(is_flavoured)
...
/decl/material/chem/drink/grapesoda
	name = "grape soda"
...
/decl/material/chem/drink/citrusseltzer
	name = "citrus seltzer"
...
/decl/material/chem/drink/orangecola
	name = "orange cola"
...
/decl/material/chem/drink/milkshake
	name = "milkshake"
...
/decl/material/chem/drink/mutagencola/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
...
/decl/material/chem/drink/grenadine
...
/decl/material/chem/drink/hell_ramen/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
	M.bodytemperature += 10 * TEMPERATURE_DAMAGE_COEFFICIENT

/decl/material/chem/drink/tea/build_presentation_name_from_reagents(var/obj/item/prop, var/supplied)
	. = supplied || glass_name
	if(prop.reagents.has_reagent(/decl/material/chem/nutriment/sugar) || prop.reagents.has_reagent(/decl/material/chem/nutriment/honey))
		. = "sweet [.]"
	if(prop.reagents.has_reagent(/decl/material/chem/drink/syrup/mint))
		. = "mint [.]"
	. = ..(prop, .)

/decl/material/chem/drink/tea/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
	M.adjustToxLoss(-0.5 * removed)
...
/decl/material/chem/drink/tea/black/build_presentation_name_from_reagents(var/obj/item/prop, var/supplied)
	if(prop.reagents.has_reagent(/decl/material/chem/drink/juice/orange))
		if(prop.reagents.has_reagent(/decl/material/chem/drink/milk))
			. = "London Fog"
		else if(prop.reagents.has_reagent(/decl/material/chem/drink/milk/soymilk))
			. = "soy London Fog"
		else
			. = "Baron Grey"
	. = ..(prop, .)
...
/decl/material/chem/drink/tea/chai
	name = "chai"
...
/decl/material/chem/drink/tea/chai/build_presentation_name_from_reagents(var/obj/item/prop, var/supplied)
	if(prop.reagents.has_reagent(/decl/material/chem/drink/milk))
		. = "chai latte"
	else if(prop.reagents.has_reagent(/decl/material/chem/drink/milk))
		. = "soy chai latte"
	. = ..(prop, .)

/decl/material/chem/drink/tea/red
	name = "redbush tea"
...
/decl/material/chem/drink/syrup
	var/coffee_priority
	var/coffee_modifier

/decl/material/chem/drink/syrup/Initialize()
	. = ..()
	if(!coffee_modifier)
		coffee_modifier = taste_description

/decl/material/chem/drink/syrup/mint
...
/decl/material/chem/drink/syrup/chocolate
...
/decl/material/chem/drink/syrup/caramel
	name = "caramel syrup"
...
/decl/material/chem/drink/syrup/vanilla
	name = "vanilla syrup"
...
/decl/material/chem/drink/syrup/pumpkin
...
/decl/material/chem/drink/gingerbeer
	name = "ginger beer"
...
/decl/material/chem/drink/beastenergy
	name = "Beast Energy"
...
/decl/material/chem/drink/beastenergy/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
	M.drowsyness = max(0, M.drowsyness - 7)
	M.make_jittery(2)
	M.add_chemical_effect(CE_PULSE, 1)

/decl/material/chem/drink/kefir
	name = "kefir"
