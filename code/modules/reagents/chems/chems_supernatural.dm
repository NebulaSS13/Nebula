...
/decl/material/water/holywater/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	..()
...
/decl/material/water/holywater/Topic(href, href_list)
	. = ..()
...
/decl/material/water/holywater/touch_turf(var/turf/T, var/amount, var/datum/reagents/holder)
	if(REAGENT_VOLUME(holder, type) >= 5)
		T.holy = 1
	return
