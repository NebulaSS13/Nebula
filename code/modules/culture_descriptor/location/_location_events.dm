...
/decl/location_event/research_breakthrough/announce(var/decl/cultural_info/location)
	. = "A major breakthough in the field of [pick("supermatter research","super-compressed materials","nano-augmentation","bluespace research","volatile power manipulation")] \
