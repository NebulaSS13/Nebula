...
var/global/list/admin_verbs_admin = list(
	...
	/datum/admins/proc/view_txt_log,	//shows the server log (main) for today,
	...
	/client/proc/getserverlog,			//allows us to fetch server logs (main) for other days,
...
//	/client/proc/toggle_hear_deadcast,	//toggles whether we hear deadchat,
	/client/proc/investigation_panel,		//various admintools for investigation,
