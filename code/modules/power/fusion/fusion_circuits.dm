...
/obj/item/stock_parts/circuitboard/kinetic_harvester
	...
	board_type = "machine"
	origin_tech = "{'" + TECH_DATA + "':4,'" + TECH_ENGINEERING + "':4,'" + TECH_MATERIAL + "':4}"
	req_components = list(
...
/obj/item/stock_parts/circuitboard/fusion_fuel_compressor
	...
	board_type = "machine"
	origin_tech = "{'" + TECH_POWER + "':3,'" + TECH_ENGINEERING + "':4,'" + TECH_MATERIAL + "':4}"
	req_components = list(
							/obj/item/stock_parts/manipulator/pico = 2,
...
/obj/item/stock_parts/circuitboard/fusion_core
	...
	board_type = "machine"
	origin_tech = "{'" + TECH_BLUESPACE + "':2,'" + TECH_MAGNET + "':4,'" + TECH_POWER + "':4}"
	req_components = list(
							/obj/item/stock_parts/manipulator/pico = 2,
