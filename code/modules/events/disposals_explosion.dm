...
/datum/event/disposals_explosion/announce()
	command_announcement.Announce("Pressure readings indicate an imminent explosion in \the [get_area(bursting_pipe).proper_name] disposal systems. Piping sections may be damaged.", "[location_name()] Atmospheric Monitoring System", zlevels = affecting_z)
