...
/datum/event/rogue_drone/start()
	...
	if(prob(25))
		...
		num = rand(2,6)
	for(var/i=0, i<num, i++)
		var/mob/living/critter/hostile/retaliate/malf_drone/D = new(get_turf(pick(possible_spawns)))
		drones_list.Add(D)
		if(prob(25))
...
/datum/event/rogue_drone/end()
	var/num_recovered = 0
	for(var/mob/living/critter/hostile/retaliate/malf_drone/D in drones_list)
