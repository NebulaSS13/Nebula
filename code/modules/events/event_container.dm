...
/datum/event_container/mundane
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Economic News",					/datum/event/location_event/mundane_news,		300),
...
/datum/event_container/major
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Rogue Singularity",				/datum/event/rogue_singularity/,	0,	list(ASSIGNMENT_COMMAND = 50))
	)
