...
/obj/item/vampiric/proc/bloodcall(var/mob/living/carbon/human/M)
	...
	if(istype(M))
		...
		var/obj/item/organ/external/E = pick(M.get_external_organs())
		M.apply_damage(rand(5, 10), BRUTE, E.organ_tag)
		to_chat(M, "<span class='warning'>The skin on your [E.name] feels like it's ripping apart, and a stream of blood flies out.</span>")
