...
/datum/genetics/side_effect/genetic_burn/finish(mob/living/carbon/human/H)
	if(!H.reagents.has_reagent(/decl/material/chem/oxy_meds))
...
/datum/genetics/side_effect/bone_snap/finish(mob/living/carbon/human/H)
	if(!H.reagents.has_reagent(/decl/material/chem/brute_meds))
...
/datum/genetics/side_effect/confuse
	...
	finish(mob/living/carbon/human/H)
		if(!H.reagents.has_reagent(/decl/material/chem/antitoxins))
			H.confused += 100
