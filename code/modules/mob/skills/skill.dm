...
/decl/hierarchy/skill/research/devices
	...
	levels = list( "Unskilled"			= "You know how to use the technology that was present in whatever society you grew up in. You know how to tell when something is malfunctioning, but you have to call tech support to get it fixed.",
						...
						"Trained"			= "You can build or repair an exosuit or cyborg chassis, use advanced fabricators and analyzers, and build prosthetic limbs. You can safely transfer a brain interface into a cyborg chassis.<br>- You can attach robotic limbs. Its speed increases with level.",
