...
/mob/living/carbon/human/monkey/punpun/Initialize(mapload, species_name, datum/mob_snapshot/supplied_appearance)
	..()
...
/mob/living/carbon/human/blank/Initialize(mapload, species_name, datum/mob_snapshot/supplied_appearance)
