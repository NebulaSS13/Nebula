...
/datum/deity_item/blood_crafting/firecrafting
	...
	recipes = list(/obj/item/clothing/jewelry/ring/aura_ring/talisman_of_starborn = 70,
							/obj/item/clothing/jewelry/ring/aura_ring/talisman_of_blueforged = 70,
							/obj/item/clothing/jewelry/ring/aura_ring/talisman_of_shadowling = 70
							)