...
/mob/living/critter/mushroom/Initialize()
	. = ..()
	harvest_time = world.time
	total_mushrooms++

/mob/living/critter/mushroom/verb/spawn_spores()
...
/mob/living/critter/mushroom/death(gibbed, deathmessage, show_dead_message)
...
/mob/living/critter/mushroom/proc/spore_explode()
	if(!seed)
		return
	if(world.time < harvest_time + min_explode_time)
		return
