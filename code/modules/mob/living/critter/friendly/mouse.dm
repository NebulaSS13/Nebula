...
/mob/living/critter/mouse/lay_down()
	..()
	icon_state = resting ? "mouse_[body_color]_sleep" : "mouse_[body_color]"

/mob/living/critter/mouse/Initialize()
	verbs += /mob/living/proc/ventcrawl
	verbs += /mob/living/proc/hide
	if(name == initial(name))
		name = "[name] ([sequential_id(/mob/living/critter/mouse)])"
	real_name = name
	if(!body_color)
...
/mob/living/critter/mouse/proc/splat()
	icon_dead = "mouse_[body_color]_splat"
	adjustBruteLoss(maxHealth)  // Enough damage to kill
	src.death()

/mob/living/critter/mouse/Crossed(AM)
	if( ishuman(AM) )
		if(!stat)
			var/mob/M = AM
...
/mob/living/critter/mouse/white
	body_color = "white"
	icon_state = "mouse_white"

/mob/living/critter/mouse/gray
	body_color = "gray"
	icon_state = "mouse_gray"

/mob/living/critter/mouse/brown
	body_color = "brown"
	icon_state = "mouse_brown"

//TOM IS ALIVE! SQUEEEEEEEE~K :)
/mob/living/critter/mouse/brown/Tom
	name = "Tom"
	desc = "Jerry the cat is not amused."

/mob/living/critter/mouse/brown/Tom/Initialize()
	. = ..()
