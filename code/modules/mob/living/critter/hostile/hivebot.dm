/mob/living/critter/hostile/hivebot
	...
	icon = 'icons/mob/critter/hivebot.dmi'
	icon_state = "basic"
	icon_living = "basic"
	icon_dead = "basic"
	health = 55
...
/mob/living/critter/hostile/hivebot/rapid
	ranged = 1
	rapid = 1

/mob/living/critter/hostile/hivebot/strong
...
/mob/living/critter/hostile/hivebot/death()
	..(null, "blows apart!")
...
*/
/mob/living/critter/hostile/hivebot/tele
	name = "beacon"
	...
	var/bot_type = /mob/living/critter/hostile/hivebot
	var/bot_amt = 10
	var/spawn_delay = 100
	var/spawn_time = 0

/mob/living/critter/hostile/hivebot/tele/Initialize()
	. = ..()
...
/mob/living/critter/hostile/hivebot/tele/proc/warpbots()
...
/mob/living/critter/hostile/hivebot/tele/FindTarget()
	if(..() && !spawn_time)
...
/mob/living/critter/hostile/hivebot/tele/Life()
	. = ..()
	if(. && spawn_time && spawn_time <= world.time)
		warpbots()

/mob/living/critter/hostile/hivebot/tele/strong
	bot_type = /mob/living/critter/hostile/hivebot/strong

/mob/living/critter/hostile/hivebot/tele/range
	bot_type = /mob/living/critter/hostile/hivebot/range

/mob/living/critter/hostile/hivebot/tele/rapid
	bot_type = /mob/living/critter/hostile/hivebot/rapid
...
/mob/living/critter/hostile/hivebot/mega
	...
	icon = 'icons/mob/critter/megabot.dmi'
	icon_state = "megabot"
	icon_living = "megabot"
...
/mob/living/critter/hostile/hivebot/mega/Initialize()
	. = ..()
	switch_mode(ATTACK_MODE_ROCKET)

/mob/living/critter/hostile/hivebot/mega/Life()
	. = ..()
	if(!.)
		return
...
/mob/living/critter/hostile/hivebot/mega/emp_act(severity)
	. = ..()
	if(severity >= 1)
		deactivate()

/mob/living/critter/hostile/hivebot/mega/on_update_icon()
	if(stat != DEAD)
		if(deactivated)
...
/mob/living/critter/hostile/hivebot/mega/proc/switch_mode(var/new_mode)
...
/mob/living/critter/hostile/hivebot/mega/proc/deactivate()
...
/mob/living/critter/hostile/hivebot/mega/proc/reactivate()
...
/mob/living/critter/hostile/hivebot/mega/OpenFire(target_mob)
	if(num_shots <= 0)
...
/mob/living/critter/hostile/hivebot/mega/Shoot(target, start, user, bullet)
	..()
	num_shots--
