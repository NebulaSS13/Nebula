...
/mob/living/critter/hostile/retaliate/parrot
	...
	icon = 'icons/mob/critter/parrot.dmi'
...
/mob/living/critter/hostile/retaliate/parrot/Initialize()
	. = ..()
	if(!ears)
	...
	verbs.Add(/mob/living/critter/hostile/retaliate/parrot/proc/steal_from_ground, \
			  /mob/living/critter/hostile/retaliate/parrot/proc/steal_from_mob, \
			  /mob/living/critter/hostile/retaliate/parrot/verb/drop_held_item_player, \
			  /mob/living/critter/hostile/retaliate/parrot/proc/perch_player)

	update_icon()

/mob/living/critter/hostile/retaliate/parrot/death(gibbed, deathmessage, show_dead_message)
	if(held_item)
...
/mob/living/critter/hostile/retaliate/parrot/Stat()
	. = ..()
	stat("Held Item", held_item)

/mob/living/critter/hostile/retaliate/parrot/on_update_icon()
 ...
 * Inventory
 */
/mob/living/critter/hostile/retaliate/parrot/show_inv(mob/user)
...
/mob/living/critter/hostile/retaliate/parrot/DefaultTopicState()
	return GLOB.physical_state

/mob/living/critter/hostile/retaliate/parrot/OnTopic(mob/user, href_list)
...
/mob/living/critter/hostile/retaliate/parrot/attack_hand(mob/user)
	. = ..()
...
//Mobs with objects
/mob/living/critter/hostile/retaliate/parrot/attackby(var/obj/item/O, var/mob/user)
	..()
...
//Bullets
/mob/living/critter/hostile/retaliate/parrot/bullet_act(var/obj/item/projectile/Proj)
	..()
	if(!stat && !client)
		if(parrot_state == PARROT_PERCH)
			parrot_sleep_dur = parrot_sleep_max //Reset it's sleep timer if it was perched
...
/mob/living/critter/hostile/retaliate/parrot/do_delayed_life_action()
	..()
...
/mob/living/critter/hostile/retaliate/parrot/movement_delay()
	if(client && stat == CONSCIOUS && parrot_state != "parrot_fly")
		icon_state = "[icon_set]_fly"
	..()

/mob/living/critter/hostile/retaliate/parrot/proc/search_for_item()
...
/mob/living/critter/hostile/retaliate/parrot/proc/search_for_perch()
...
/mob/living/critter/hostile/retaliate/parrot/proc/search_for_perch_and_item()
	for(var/atom/movable/AM in view(src))
...
/mob/living/critter/hostile/retaliate/parrot/proc/give_up()
	enemies = list()
	LoseTarget()
 ...
 */
/mob/living/critter/hostile/retaliate/parrot/proc/steal_from_ground()
...
/mob/living/critter/hostile/retaliate/parrot/proc/drop_held_item(var/drop_gently = 1)
	set name = "Drop held item"
	set category = "Parrot"
	set desc = "Drop the item you're holding."
 ...
 * Sub-types
 */
/mob/living/critter/hostile/retaliate/parrot/Poly
	name = "Poly"
...
/mob/living/critter/hostile/retaliate/parrot/Poly/Initialize()
	ears = new /obj/item/radio/headset/headset_eng(src)
	available_channels = list(":e")
	. = ..()

/mob/living/critter/hostile/retaliate/parrot/say(var/message)
...
/mob/living/critter/hostile/retaliate/parrot/hear_say(var/message, var/verb = "says", var/decl/language/language = null, var/alt_name = "",var/italics = 0, var/mob/speaker = null)
	if(prob(50))
		parrot_hear(message)
	..()
...
/mob/living/critter/hostile/retaliate/parrot/hear_radio(var/message, var/verb="says", var/decl/language/language=null, var/part_a, var/part_b, var/part_c, var/mob/speaker = null, var/hard_to_hear = 0)
	if(prob(50) && available_channels.len)
		parrot_hear("[pick(available_channels)] [message]")
	..()


/mob/living/critter/hostile/retaliate/parrot/proc/parrot_hear(var/message="")
	if(!message || stat)
		return
	speech_buffer.Add(message)

/mob/living/critter/hostile/retaliate/parrot/proc/can_pick_up(obj/item/I)
