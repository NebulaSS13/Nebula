/mob/living/critter/hostile/retaliate/jelly
	name = "zeq"
...
/mob/living/critter/hostile/retaliate/jelly/Initialize()
	. = ..()
	if(gets_random_color)
		color = color_rotation(round(rand(0,360),20))

/mob/living/critter/hostile/retaliate/jelly/alt
	icon_state = "jelly-alt"
	icon_living = "jelly-alt"
	icon_dead = "jelly-alt_dead"

//megajellyfish
/mob/living/critter/hostile/retaliate/jelly/mega
	name = "zeq queen"
	...
	var/jelly_scale = 3
	var/split_type = /mob/living/critter/hostile/retaliate/jelly/mega/half
	var/static/megajelly_color

/mob/living/critter/hostile/retaliate/jelly/mega/Initialize()
	. = ..()
...
/mob/living/critter/hostile/retaliate/jelly/mega/death()
	if(split_type)
		jelly_split()
	else
		..()

/mob/living/critter/hostile/retaliate/jelly/mega/proc/jelly_split()
	visible_message(SPAN_MFAUNA("\The [src] rumbles briefly before splitting into two!"))
	var/kidnum = 2
	for(var/i = 0 to kidnum)
		var/mob/living/critter/child = new split_type(get_turf(src))
...
/mob/living/critter/hostile/retaliate/jelly/mega/half
	name = "zeq duchess"
	...
	can_escape = TRUE
	jelly_scale = 1.5
	split_type = /mob/living/critter/hostile/retaliate/jelly/mega/quarter

/mob/living/critter/hostile/retaliate/jelly/mega/quarter
	name = "zeqling"
	...
	jelly_scale = 0.75
	can_escape = FALSE
	split_type = /mob/living/critter/hostile/retaliate/jelly/mega/fourth

/mob/living/critter/hostile/retaliate/jelly/mega/fourth
	name = "zeqetta"
	desc = "A tiny jellyfish-like creature."
	health = 40
	maxHealth = 40
	jelly_scale = 0.375
	split_type = /mob/living/critter/hostile/retaliate/jelly/mega/eighth

/mob/living/critter/hostile/retaliate/jelly/mega/eighth
	name = "zeqttina"
