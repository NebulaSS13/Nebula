/mob/living/critter/hostile/retaliate/goose
	...
	icon = 'icons/mob/critter/goose.dmi'
	icon_state = "goose"
	icon_living = "goose"
...
/mob/living/critter/hostile/retaliate/goose/Retaliate()
	..()
	if(stat == CONSCIOUS)
		enrage(enrage_potency)

/mob/living/critter/hostile/retaliate/goose/on_update_icon()
	if(stat == DEAD)
...
/mob/living/critter/hostile/retaliate/goose/death(gibbed, deathmessage, show_dead_message)
	. = ..()
	update_icon()

/mob/living/critter/hostile/retaliate/goose/proc/enrage(var/potency)
...
/mob/living/critter/hostile/retaliate/goose/dire
	name = "dire goose"
