...
/mob/living/critter/hostile/retaliate/malf_drone
	name = "combat drone"
...
/mob/living/critter/hostile/retaliate/malf_drone/Initialize()
	. = ..()
	if(prob(5))
...
/mob/living/critter/hostile/retaliate/malf_drone/Process_Spacemove()
	return 1

/mob/living/critter/hostile/retaliate/malf_drone/proc/Haywire()
...
/mob/living/critter/hostile/retaliate/malf_drone/ListTargets()
	if(hostile_drone)
...
/mob/living/critter/hostile/retaliate/malf_drone/Life()
...
//ion rifle!
/mob/living/critter/hostile/retaliate/malf_drone/emp_act(severity)
	health -= rand(3,15) * (severity + 1)
	disabled = rand(150, 600)
	hostile_drone = 0
	walk(src,0)

/mob/living/critter/hostile/retaliate/malf_drone/death()
	..(null,"suddenly breaks apart.", "You have been destroyed.")
	qdel(src)

/mob/living/critter/hostile/retaliate/malf_drone/Destroy()
