/mob/living/critter/hostile/retaliate/parrot/space
	name = "space parrot"
...
/mob/living/critter/hostile/retaliate/parrot/space/Initialize()
	. = ..()
...
/mob/living/critter/hostile/retaliate/parrot/space/AttackingTarget()
	. = ..()
...
/mob/living/critter/hostile/retaliate/parrot/space/can_perform_ability(mob/living/carbon/human/H)
	. = ..()
	if(!.)
		return FALSE
	if(!Adjacent(H))
...
//subtypes
/mob/living/critter/hostile/retaliate/parrot/space/lesser
...
/mob/living/critter/hostile/retaliate/parrot/space/megafauna
	name = "giant parrot"
