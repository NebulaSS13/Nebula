...
/mob/living/critter/hostile/retaliate/goat/king/get_natural_weapon()
...
/mob/living/critter/hostile/retaliate/goat/king/phase2
...
/mob/living/critter/hostile/retaliate/goat/king/phase2/Initialize()
	. = ..()
...
/mob/living/critter/hostile/retaliate/goat/guard
	name = "honour guard"
...
/mob/living/critter/hostile/retaliate/goat/guard/master
...
/mob/living/critter/hostile/retaliate/goat/king/Retaliate()
	..()
	if(stat == CONSCIOUS && prob(5))
		visible_message(SPAN_WARNING("The [src] bellows indignantly, with a judgemental gleam in his eye."))

/mob/living/critter/hostile/retaliate/goat/king/phase2/Retaliate()
	set waitfor = FALSE
	..()
	if(spellscast < 5)
		if(prob(5) && move_to_delay != 1) //speed buff
			...
			new /mob/living/critter/hostile/retaliate/goat/guard/master(get_step(src,pick(GLOB.cardinal)))
			new /mob/living/critter/hostile/retaliate/goat/guard(get_step(src,pick(GLOB.cardinal)))
			new /mob/living/critter/hostile/retaliate/goat/guard(get_step(src,pick(GLOB.cardinal)))
...
/mob/living/critter/hostile/retaliate/goat/king/phase2/proc/phase3_transition()
	phase3 = TRUE
	spellscast = 0
	health = 750
	new /obj/item/grenade/flashbang/instant(src.loc)
...
/mob/living/critter/hostile/retaliate/goat/king/phase2/on_update_icon()
	if(phase3)
...
/mob/living/critter/hostile/retaliate/goat/king/phase2/Life()
	. = ..()
	if(!.)
		return FALSE
...
/mob/living/critter/hostile/retaliate/goat/king/proc/OnDeath()
	...
	new /mob/living/critter/hostile/retaliate/goat/king/phase2(src.loc)
	qdel(src)

/mob/living/critter/hostile/retaliate/goat/king/phase2/OnDeath()
	QDEL_NULL(boss_theme)
	if(phase3)
...
/mob/living/critter/hostile/retaliate/goat/king/death()
	..()
	OnDeath()

/mob/living/critter/hostile/retaliate/goat/king/phase2/Destroy()
	QDEL_NULL(boss_theme)
	. = ..()

/mob/living/critter/hostile/retaliate/goat/king/AttackingTarget()
	. = ..()
...
/mob/living/critter/hostile/retaliate/goat/king/phase2/AttackingTarget()
	. = ..()
	if(current_damtype != BRUTE)
		special_attacks++
	
/mob/living/critter/hostile/retaliate/goat/king/Process_Spacemove()
	return 1