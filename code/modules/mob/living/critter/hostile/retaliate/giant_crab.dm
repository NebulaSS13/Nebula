/mob/living/critter/hostile/retaliate/giant_crab
	name = "giant crab"
...
/mob/living/critter/hostile/retaliate/giant_crab/Initialize() //embiggen
	. = ..()
	set_scale(1.5)

/mob/living/critter/hostile/retaliate/giant_crab/Destroy()
	. = ..()
	victim = null

/mob/living/critter/hostile/retaliate/giant_crab/attack_hand(mob/user)
	. = ..()
	if(ishuman(user))
		reflect_unarmed_damage(user, BRUTE, "armoured carapace")

/mob/living/critter/hostile/retaliate/giant_crab/Life()
	. = ..()
	if(!.)
		return
...
/mob/living/critter/hostile/retaliate/giant_crab/do_delayed_life_action()
	..()
	process_grab()

/mob/living/critter/hostile/retaliate/giant_crab/AttackingTarget()
	. = ..()
	if(ishuman(.))
...
/mob/living/critter/hostile/retaliate/giant_crab/can_perform_ability(mob/living/carbon/human/H)
	. = ..()
	if(!.)
		return FALSE
	if(!Adjacent(H))
...
/mob/living/critter/hostile/retaliate/giant_crab/proc/process_grab()
...
/mob/living/critter/hostile/retaliate/giant_crab/proc/release_grab()
	if(victim)
