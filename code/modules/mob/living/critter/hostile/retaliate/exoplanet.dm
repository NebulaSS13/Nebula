...
/mob/living/critter/hostile/retaliate/beast
	var/hunger = 0
	var/list/prey = list()

/mob/living/critter/hostile/retaliate/beast/ListTargets(var/dist = 7)
	var/list/see = ..()
	if(see.len)
		return see
	if(prey.len)
...
/mob/living/critter/hostile/retaliate/beast/Life()
	. = ..()
	if(!.)
		return FALSE
	hunger++
	if(hunger < 100) //stop hunting when satiated
		...
		for(var/mob/living/critter/S in range(src,1))
			if(S == src)
				continue
			if(S.stat != DEAD)
				continue
...
/mob/living/critter/proc/name_species()
...
/mob/living/critter/hostile/retaliate/beast/samak
	name = "samak"
...
/mob/living/critter/hostile/retaliate/beast/samak/alt
...
/mob/living/critter/hostile/retaliate/beast/diyaab
	name = "diyaab"
...
/mob/living/critter/hostile/retaliate/beast/shantak
	name = "shantak"
...
/mob/living/critter/hostile/retaliate/beast/shantak/alt
...
/mob/living/critter/hostile/retaliate/royalcrab
	name = "cragenoy"
...
/mob/living/critter/hostile/retaliate/beast/charbaby
	name = "charbaby"
...
/mob/living/critter/hostile/retaliate/beast/charbaby/attack_hand(mob/user)
	. = ..()
	if(ishuman(user))
		reflect_unarmed_damage(user, BURN, "amorphous mass")

/mob/living/critter/hostile/retaliate/beast/charbaby/AttackingTarget()
	. = ..()
...
/mob/living/critter/hostile/retaliate/beast/shantak/lava
