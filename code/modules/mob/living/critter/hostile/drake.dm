/mob/living/critter/hostile/drake
	name = "drake"
	desc = "A large reptilian creature, with vicious looking claws."
	icon = 'icons/mob/critter/drake.dmi'
	icon_state = "drake"
	icon_living = "drake"
...
/mob/living/critter/hostile/drake/lava_act(datum/gas_mixture/air, temperature, pressure)
	return

/mob/living/critter/hostile/drake/can_perform_ability()
	. = ..()
	if(!.)
		return FALSE
	if(!target_mob)
...
/mob/living/critter/hostile/drake/AttackingTarget()
	. = ..()
	if(empowered_attack)
		depower()
		return
...
/mob/living/critter/hostile/drake/get_natural_weapon()
	if(empowered_attack)
		if(!tailwhip)
			tailwhip = new(src)
		return tailwhip
...
/mob/living/critter/hostile/drake/proc/empower()
...
/mob/living/critter/hostile/drake/proc/vent_gas()
...
/mob/living/critter/hostile/drake/proc/depower()
