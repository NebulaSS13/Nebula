...
/mob/living/critter/hostile/vagrant
	name = "creature"
...
/mob/living/critter/hostile/vagrant/Process_Spacemove()
	return 1

/mob/living/critter/hostile/vagrant/bullet_act(var/obj/item/projectile/Proj)
...
/mob/living/critter/hostile/vagrant/death(gibbed)
	. = ..()
	if(. && !gibbed)
		gib()

/mob/living/critter/hostile/vagrant/Life()
	. = ..()
	if(!.)
		return FALSE
	if(gripping)
	...
	if(stance == HOSTILE_STANCE_IDLE && !cloaked)
		...
		update_icon()
	if(health == maxHealth)
		new/mob/living/critter/hostile/vagrant(src.loc)
		new/mob/living/critter/hostile/vagrant(src.loc)
		gib()
		return

/mob/living/critter/hostile/vagrant/on_update_icon()
...
/mob/living/critter/hostile/vagrant/AttackingTarget()
	. = ..()
	if(ishuman(.))
...
/mob/living/critter/hostile/vagrant/swarm/Initialize()
	. = ..()
	if(prob(75)) new/mob/living/critter/hostile/vagrant(loc)
	if(prob(50)) new/mob/living/critter/hostile/vagrant(loc)
