/mob/living/critter/faithful_hound
	name = "spectral hound"
...
/mob/living/critter/faithful_hound/death()
	new /obj/item/ectoplasm (get_turf(src))
	..(null, "disappears!")
	qdel(src)

/mob/living/critter/faithful_hound/Destroy()
	allowed_mobs.Cut()
	return ..()

/mob/living/critter/faithful_hound/do_delayed_life_action()
	..()
...
/mob/living/critter/faithful_hound/hear_say(var/message, var/verb = "says", var/decl/language/language = null, var/alt_name = "", var/italics = 0, var/mob/speaker = null, var/sound/speech_sound, var/sound_vol)
