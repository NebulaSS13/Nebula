/mob/living/critter/hostile/pirate
	name = "Pirate"
...
/mob/living/critter/hostile/pirate/ranged
	name = "Pirate Gunner"
...
/mob/living/critter/hostile/pirate/death(gibbed, deathmessage, show_dead_message)
