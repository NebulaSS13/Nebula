/mob/living/critter/hostile/leech
	name = "megaleech"
	desc = "A green leech the size of a common snake."
	icon = 'icons/mob/critter/megaleech.dmi'
	icon_state = "leech"
	icon_living = "leech"
...
/mob/living/critter/hostile/leech/Life()
	. = ..()
	if(!.)
		return FALSE
...
/mob/living/critter/hostile/leech/AttackingTarget()
	. = ..()
	if(ishuman(.) && belly <= 75)
...
/obj/structure/leech_spawner/proc/burst(var/mob/living/carbon/victim)
	...
	for(var/i in 1 to 12)
		new /mob/living/critter/hostile/leech(get_turf(src))
