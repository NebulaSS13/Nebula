/mob/living/critter/hostile/commanded/bear
	name = "bear"
...
/mob/living/critter/hostile/commanded/bear/hit_with_weapon(obj/item/O, mob/living/user, var/effective_force, var/hit_zone)
	. = ..()
	if(.)
		src.emote("roars in rage!")

/mob/living/critter/hostile/commanded/bear/attack_hand(mob/M)
	..()
	if(M.a_intent == I_HURT)
		src.emote("roars in rage!")

/mob/living/critter/hostile/commanded/bear/listen()
	if(stance != COMMANDED_MISC) //cant listen if its booty shakin'
		..()

//WE DANCE!
/mob/living/critter/hostile/commanded/bear/misc_command(var/mob/speaker,var/text)
	stay_command()
