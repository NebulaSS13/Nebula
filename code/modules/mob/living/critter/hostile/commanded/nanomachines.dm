...
/mob/living/critter/hostile/commanded/nanomachine
	name = "swarm"
...
/mob/living/critter/hostile/commanded/nanomachine/Life()
	regen_time++
...
/mob/living/critter/hostile/commanded/nanomachine/death(gibbed, deathmessage, show_dead_message)
	..(null, "dissipates into thin air", "You have been destroyed.")
	qdel(src)

/mob/living/critter/hostile/commanded/nanomachine/proc/move_to_heal()
	if(!target_mob)
		return 0
...
/mob/living/critter/hostile/commanded/nanomachine/proc/heal()
...
/mob/living/critter/hostile/commanded/nanomachine/misc_command(var/mob/speaker,var/text)
