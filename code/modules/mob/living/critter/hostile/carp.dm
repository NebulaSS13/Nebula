/mob/living/critter/hostile/carp
	...
	icon = 'icons/mob/critter/carp.dmi'
...
/mob/living/critter/hostile/carp/Initialize()
	. = ..()
	carp_randomify()
	update_icon()

/mob/living/critter/hostile/carp/proc/carp_randomify()
...
/mob/living/critter/hostile/carp/Process_Spacemove()
	return 1	//No drifting in space for space carp!	//original comments do not steal

/mob/living/critter/hostile/carp/FindTarget()
	. = ..()
	if(.)
