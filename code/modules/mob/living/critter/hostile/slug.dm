...
/mob/living/critter/hostile/slug
	name = "slug"
...
/mob/living/critter/hostile/slug/proc/check_friendly_species(var/mob/living/carbon/human/H)
	if(isliving(H))
		var/mob/living/M = H
...
/mob/living/critter/hostile/slug/ListTargets(var/dist = 7)
	var/list/L = list()
...
/mob/living/critter/hostile/slug/get_scooped(var/mob/living/carbon/grabber)
...
/mob/living/critter/hostile/slug/proc/attach(var/mob/living/carbon/human/H)
...
/mob/living/critter/hostile/slug/AttackingTarget()
	. = ..()
...
/mob/living/critter/hostile/slug/Life()
	. = ..()
...
/obj/item/holder/slug/attack(var/mob/target, var/mob/user)
	var/mob/living/critter/hostile/slug/V = contents[1]
