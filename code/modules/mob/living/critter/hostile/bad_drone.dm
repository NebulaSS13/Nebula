/mob/living/critter/hostile/rogue_drone
...
/mob/living/critter/hostile/rogue_drone/Initialize()
	. = ..()
	name = "[initial(name)] ([random_id(type,100,999)])"

/mob/living/critter/hostile/rogue_drone/ValidTarget(var/atom/A)
	. = ..()
	if(.)
...
/mob/living/critter/hostile/rogue_drone/death(gibbed, deathmessage, show_dead_message)
	.=..()
	if(corpse)
		new corpse (loc)
	qdel(src)