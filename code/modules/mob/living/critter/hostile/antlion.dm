/mob/living/critter/hostile/antlion
	name = "antlion"
	desc = "A large insectoid creature."
	icon = 'icons/mob/critter/antlion.dmi'
...
/mob/living/critter/hostile/antlion/Life()
	. = ..()
...
/mob/living/critter/hostile/antlion/can_perform_ability()
	. = ..()
	if(!.)
		return FALSE
	if(!target_mob)
...
/mob/living/critter/hostile/antlion/proc/vanish()
...
/mob/living/critter/hostile/antlion/proc/diggy()
...
/mob/living/critter/hostile/antlion/proc/emerge()
...
/mob/living/critter/hostile/antlion/proc/process_healing()
	if(!incapacitated() && healing)
		var/old_health = health
		if(old_health < maxHealth)
			health = old_health + heal_amount

/mob/living/critter/hostile/antlion/proc/prep_burrow(var/new_bool)
	stop_automated_movement = new_bool
	stop_automation = new_bool
	healing = new_bool

/mob/living/critter/hostile/antlion/mega
	name = "antlion queen"
...
/mob/living/critter/hostile/antlion/mega/Initialize()
	. = ..()
	set_scale(1.5)