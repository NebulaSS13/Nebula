/mob/living/critter/hostile/syndicate
...
/mob/living/critter/hostile/syndicate/death(gibbed, deathmessage, show_dead_message)
...
/mob/living/critter/hostile/syndicate/melee
...
/mob/living/critter/hostile/syndicate/melee/attackby(var/obj/item/O, var/mob/user)
	if(O.force)
		if(prob(80))
			var/damage = O.force
			if (O.damtype == PAIN)
...
/mob/living/critter/hostile/syndicate/melee/bullet_act(var/obj/item/projectile/Proj)
	if(!Proj)	return
	if(prob(65))
...
/mob/living/critter/hostile/syndicate/melee/space
	min_gas = null
	max_gas = null
	minbodytemp = 0
...
/mob/living/critter/hostile/syndicate/ranged
	ranged = 1
	rapid = 1
...
/mob/living/critter/hostile/syndicate/ranged/space
...
/mob/living/critter/hostile/viscerator
	name = "viscerator"
	desc = "A small, twin-bladed machine capable of inflicting very deadly lacerations."
	icon = 'icons/mob/critter/critter.dmi'
...
/mob/living/critter/hostile/viscerator/death(gibbed, deathmessage, show_dead_message)
