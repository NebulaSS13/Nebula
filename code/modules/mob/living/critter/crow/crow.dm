/obj/item/storage/messenger
	...
	icon = 'icons/mob/critter/crow.dmi'
	icon_state = "messenger_bag"
	storage_slots = 7
	w_class = ITEM_SIZE_SMALL
	max_w_class = ITEM_SIZE_SMALL

/mob/living/critter/crow
	name = "crow"
...
/mob/living/critter/crow/Initialize()
	. = ..()
	messenger_bag = new(src)
	update_icon()

/mob/living/critter/crow/GetIdCard()
	return access_card

/mob/living/critter/crow/show_inv(var/mob/user)
...
/mob/living/critter/crow/DefaultTopicState()
	return GLOB.physical_state

/mob/living/critter/crow/OnTopic(mob/user, href_list)
	if(!ishuman(user))
		return ..()
...
/mob/living/critter/crow/examine(mob/user)
	. = ..()
	if(Adjacent(src))
		if(messenger_bag)
...
/mob/living/critter/crow/on_update_icon()
	..()
	overlays -= "bag"
	overlays -= "bag_dead"
	if(messenger_bag)
...
/mob/living/critter/crow/cyber
	name = "cybercrow"
	desc = "A large cybercrow. k4w k4w."
	speak_emote = list("beeps")

/mob/living/critter/crow/cyber/on_update_icon()
	..()
	overlays -= "cyber"
	overlays -= "cyber_dead"
	if(icon_state != icon_dead)
