/mob/living/critter/construct
	...
	mob_swap_flags = HUMAN|CRITTER|SLIME|MONKEY
...
/mob/living/critter/construct/cultify()
	return

/mob/living/critter/construct/Initialize()
	. = ..()
	name = text("[initial(name)] ([random_id(/mob/living/critter/construct, 1000, 9999)])")
	real_name = name
...
/mob/living/critter/construct/death(gibbed, deathmessage, show_dead_message)
	new /obj/item/ectoplasm (src.loc)
	..(null,"collapses in a shattered heap.","The bonds tying you to this mortal plane have been severed.")
	ghostize()
	qdel(src)

/mob/living/critter/construct/on_update_icon()
	overlays.Cut()
	..()
	add_glow()

/mob/living/critter/construct/attack_animal(var/mob/user)
	if(istype(user, /mob/living/critter/construct/builder))
		if(health < maxHealth)
			adjustBruteLoss(-5)
...
/mob/living/critter/construct/examine(mob/user)
	. = ..(user)
...
/mob/living/critter/construct/armoured
	name = "Juggernaut"
...
/mob/living/critter/construct/armoured/Life()
	weakened = 0
	if ((. = ..()))
		return 

/mob/living/critter/construct/armoured/bullet_act(var/obj/item/projectile/P)
...
/mob/living/critter/construct/wraith
	name = "Wraith"
	real_name = "Wraith"
...
/mob/living/critter/construct/builder
	name = "Artificer"
	real_name = "Artificer"
...
/mob/living/critter/construct/behemoth
	name = "Behemoth"
	real_name = "Behemoth"
...
/mob/living/critter/construct/harvester
	name = "Harvester"
	real_name = "Harvester"
...
////////////////Glow//////////////////
/mob/living/critter/construct/proc/add_glow()
...
/mob/living/critter/construct/Life()
	. = ..()
	if(.)
		if(fire)
...
/mob/living/critter/construct/behemoth/Life()
	. = ..()
	if(healths)
		switch(health)
...
/mob/living/critter/construct/builder/Life()
	. = ..()
	if(healths)
		switch(health)
...
/mob/living/critter/construct/wraith/Life()
	. = ..()
	if(healths)
		switch(health)
...
/mob/living/critter/construct/harvester/Life()
	. = ..()
	if(healths)
		switch(health)
