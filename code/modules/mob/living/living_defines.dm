/mob/living
	...
	var/mob_icon_state_flags = (MOB_ICON_NO_LIVING_STATE | MOB_ICON_NO_DEAD_STATE | MOB_ICON_NO_REST_STATE | MOB_ICON_NO_SLEEP_STATE | MOB_ICON_NO_GIB_STATE | MOB_ICON_NO_EYES_STATE)
