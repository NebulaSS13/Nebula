/mob/living/bot/medbot
	...
	var/treatment_brute = /datum/reagent/regenerator
	var/treatment_oxy = /datum/reagent/regenerator
	var/treatment_fire = /datum/reagent/regenerator
	var/treatment_tox = /datum/reagent/regenerator
