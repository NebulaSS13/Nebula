...
/decl/natural_attack/proc/padded_by_user_gear(var/mob/living/user)
...
/decl/natural_attack/proc/resolve_to_soft_variant(var/mob/living/user)
	. = src
...
/decl/natural_attack/proc/is_usable(var/mob/living/user, var/mob/target, var/zone)
...
/decl/natural_attack/proc/apply_effects(var/mob/living/user,var/mob/living/target,var/attack_damage,var/zone)
...
/decl/natural_attack/proc/show_attack(var/mob/living/user, var/mob/living/target, var/zone, var/attack_damage)
...
/decl/natural_attack/proc/handle_eye_attack(var/mob/living/user, var/mob/living/target)
...
/decl/natural_attack/bite/is_usable(var/mob/living/user, var/mob/living/target, var/zone)
...
/decl/natural_attack/punch/show_attack(var/mob/living/user, var/mob/living/target, var/zone, var/attack_damage)
...
/decl/natural_attack/kick/is_usable(var/mob/living/user, var/mob/living/target, var/zone)
	if(zone == BP_HEAD || zone == BP_EYES || zone == BP_MOUTH)
		zone = BP_CHEST
	. = ..()

/decl/natural_attack/kick/get_unarmed_damage(var/mob/living/user)
	var/obj/item/clothing/shoes = user.get_equipped_item(slot_shoes_str)
	if(!istype(shoes))
		return damage
	return damage + (shoes ? shoes.force : 0)

/decl/natural_attack/kick/show_attack(var/mob/living/user, var/mob/living/target, var/zone, var/attack_damage)
...
/decl/natural_attack/stomp/is_usable(var/mob/living/user, var/mob/living/target, var/zone)
	if(!istype(target))
		return FALSE
...
/decl/natural_attack/stomp/get_unarmed_damage(var/mob/living/user)
	var/obj/item/clothing/shoes = user.get_equipped_item(slot_shoes_str)
	return damage + (shoes ? shoes.force : 0)

/decl/natural_attack/stomp/show_attack(var/mob/living/user, var/mob/living/target, var/zone, var/attack_damage)
...
/decl/natural_attack/light_strike/kick/is_usable(var/mob/living/user, var/mob/living/target, var/zone)
	if(zone == BP_HEAD || zone == BP_EYES || zone == BP_MOUTH)
		zone = BP_CHEST
	. = ..()
