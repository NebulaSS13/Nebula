...
/mob/living/carbon/slime/get_digestion_product()
	return /decl/material/chem/toxin/slimejelly
...
/mob/living/carbon/slime/movement_delay()
	...
	if(reagents)
		if(reagents.has_reagent(/decl/material/chem/amphetamines)) // Stimulants slows slimes down
			tally *= 2

		if(reagents.has_reagent(/decl/material/chem/frostoil)) // Frostoil also makes them move VEEERRYYYYY slow
			tally *= 5
