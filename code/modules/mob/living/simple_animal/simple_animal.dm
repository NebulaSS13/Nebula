/mob/living/simple_animal
	...
	//Atmos effect - Yes, you can make creatures that require specific gasses to survive. N2O is a trace gas and handled separately, hence why it isn't here. It'd be hard to add it. Hard and me don't mix (Yes, yes make all the dick jokes you want with that.) - Errorage
	var/list/min_gas = list(MAT_OXYGEN = 5)
	var/list/max_gas = list(MAT_CO2 = 5)
