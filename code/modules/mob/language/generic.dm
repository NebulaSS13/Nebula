...
/decl/language/noise
	name = "Noise"
	desc = "Noises"
	language_flags = LANG_FLAG_RESTRICTED|LANG_FLAG_NONGLOBAL|LANG_FLAG_INNATE|LANG_FLAG_NO_TALK_MSG|LANG_FLAG_NO_STUTTER
...
/decl/language/noise/format_message(message, verb)
	return "<span class='message'>[format_message_no_verb(message)]</span>"
...
/decl/language/sign
	...
	colour = "say_quote"
	language_key = "sign"
	language_flags = LANG_FLAG_SIGNLANG | LANG_FLAG_NO_STUTTER | LANG_FLAG_NONVERBAL
	shorthand = "HS"
