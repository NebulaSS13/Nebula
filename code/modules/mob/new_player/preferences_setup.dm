...
/datum/preferences/proc/dress_preview_mob(var/mob/living/human/dummy/mannequin)
	...
	if((equip_preview_mob & EQUIP_PREVIEW_JOB) && previewJob)
		...
		var/datum/mil_branch/branch = global.using_map.mil_branches.get_branch(branches[previewJob.title])
		var/datum/mil_rank/rank = global.using_map.mil_branches.get_rank(branches[previewJob.title], ranks[previewJob.title])
