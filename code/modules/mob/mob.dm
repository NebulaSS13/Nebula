...
/mob/proc/get_authentification_rank(if_no_id = "No id", if_no_job = "No job")
...
/mob/proc/get_assignment(if_no_id = "No id", if_no_job = "No job")
	var/obj/item/card/id/id = GetIdCard()
	if(istype(id))
...
/mob/proc/get_authentification_name(if_no_id = "Unknown")
	var/obj/item/card/id/id = GetIdCard()
	if(istype(id))
