...
/datum/species
	...
	var/poison_types = list(MATERIAL_PHORON = TRUE, MATERIAL_CHLORINE = TRUE) // Noticeably poisonous air - ie. updates the toxins indicator on the HUD.
	var/exhale_type = MATERIAL_CO2                          // Exhaled gas type.
