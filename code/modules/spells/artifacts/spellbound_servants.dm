...
/datum/spellbound_type/apprentice
	...
	equipment = list(/obj/item/clothing/head/wizard = BP_HEAD,
					/obj/item/clothing/under/color/lightpurple = BP_CHEST,
					/obj/item/clothing/shoes/sandal = slot_shoes_str,
					/obj/item/staff = BP_R_HAND,
					/obj/item/spellbook/apprentice = BP_L_HAND,
					/obj/item/clothing/suit/wizrobe = BP_BODY)
...
/datum/spellbound_type/servant/caretaker
	...
	equipment = list(/obj/item/clothing/under/caretaker = BP_CHEST,
...
/datum/spellbound_type/servant/champion
	...
	equipment = list(/obj/item/clothing/under/bluetunic = BP_CHEST,
...
/datum/spellbound_type/servant/familiar
	...
	equipment = list(/obj/item/clothing/head/bandana/familiarband = BP_HEAD,
					/obj/item/clothing/under/familiargarb = BP_CHEST)
...
/datum/spellbound_type/servant/fiend/equip_servant(var/mob/living/carbon/human/H)
	if(H.gender == MALE)
		equipment = list(/obj/item/clothing/under/lawyer/fiendsuit = BP_CHEST,
						/obj/item/clothing/shoes/dress/devilshoes = slot_shoes_str)
		spells += /spell/toggle_armor/fiend
	else
		equipment = list(/obj/item/clothing/under/devildress = BP_CHEST,
					/obj/item/clothing/shoes/dress/devilshoes = slot_shoes_str)
...
/datum/spellbound_type/servant/infiltrator/equip_servant(var/mob/living/carbon/human/H)
	if(H.gender == MALE)
		equipment = list(/obj/item/clothing/under/lawyer/infil = BP_CHEST,
						/obj/item/clothing/shoes/dress/infilshoes = slot_shoes_str)
		spells += /spell/toggle_armor/infiltrator
	else
		equipment = list(/obj/item/clothing/under/lawyer/infil/fem = BP_CHEST,
					/obj/item/clothing/shoes/dress/infilshoes = slot_shoes_str)
...
/datum/spellbound_type/servant/overseer
	...
	equipment = list(/obj/item/clothing/under/grimhoodie = BP_CHEST,
