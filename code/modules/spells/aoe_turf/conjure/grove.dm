...
/datum/seed/merlin_tear
	...
	chems = list(/decl/material/brute_meds = list(3,7), /decl/material/burn_meds = list(3,7), /decl/material/antitoxins = list(3,7), /decl/material/regenerator = list(3,7), /decl/material/neuroannealer = list(1,2), /decl/material/eyedrops = list(1,2))
	kitchen_tag = "berries"
