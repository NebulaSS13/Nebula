...
/obj/structure/textiles/spinning_wheel/twisting_bench/attackby(obj/item/W, mob/user)
	if(istype(W, /obj/item/chems/food/butchery/offal) && !istype(W, /obj/item/chems/food/butchery/offal/small))
...
/obj/structure/textiles/spinning_wheel/twisting_bench/can_process(obj/item/thing)
	return istype(thing, /obj/item/chems/food/butchery/offal/small) && istype(thing.material, accepts_gut_material)
