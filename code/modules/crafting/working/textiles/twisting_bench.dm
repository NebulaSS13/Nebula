/obj/structure/working/spinning_wheel/twisting_bench
	name                     = "twisting bench"
...
/obj/structure/working/spinning_wheel/twisting_bench/can_process(obj/item/thing)
	return istype(thing, /obj/item/food/butchery/offal/small) && istype(thing.material, accepts_gut_material)

/obj/structure/working/spinning_wheel/twisting_bench/is_thread_material(decl/material/mat)
	return istype(mat, accepts_gut_material)

/obj/structure/working/spinning_wheel/twisting_bench/ebony
