...
/obj/item/integrated_circuit/passive/power/chemical_cell
	...
	extended_desc = "This is effectively an internal beaker. It will consume and produce power from chemical fuel, carbon,\
	...
	spawn_flags = IC_SPAWN_DEFAULT|IC_SPAWN_RESEARCH
	var/volume = 60
	var/list/fuel = list(/datum/reagent/fuel = 15000, /datum/reagent/carbon = 10000, /datum/reagent/ethanol = 10000, /datum/reagent/nutriment = 8000)
	var/multi = 1
	var/lfwb =TRUE
