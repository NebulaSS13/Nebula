...
/turf/simulated/floor/glass/on_update_icon()
	underlays.Cut()
	. = ..()
	...
	if(base_turf == /turf/space)
		var/image/I = image(icon = 'icons/turf/space.dmi', icon_state = "white")
		I.plane = SPACE_PLANE
		add_overlay(I)
	else if(base_turf != /turf/simulated/open)
		var/image/I = image(base_turf)
		I.plane = OPENTURF_MAX_PLANE - 1
		add_overlay(I)

/turf/simulated/floor/glass/is_open()
	return TRUE
