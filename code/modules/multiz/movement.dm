...
/mob/living/carbon/human/apply_fall_damage(var/turf/landing)
	...
	take_damage(rand(min_damage, max_damage), target_zone = BP_HEAD, armor_pen = 50)
	take_damage(rand(min_damage, max_damage), target_zone = BP_CHEST, armor_pen = 50)
	take_damage(rand(min_damage, max_damage), target_zone = BP_GROIN, armor_pen = 75)
	take_damage(rand(min_damage, max_damage), target_zone = BP_L_LEG, armor_pen = 100)
	take_damage(rand(min_damage, max_damage), target_zone = BP_R_LEG, armor_pen = 100)
	take_damage(rand(min_damage, max_damage), target_zone = BP_L_FOOT, armor_pen = 100)
	take_damage(rand(min_damage, max_damage), target_zone = BP_R_FOOT, armor_pen = 100)
	take_damage(rand(min_damage, max_damage), target_zone = BP_L_ARM, armor_pen = 75)
	take_damage(rand(min_damage, max_damage), target_zone = BP_R_ARM, armor_pen = 75)
