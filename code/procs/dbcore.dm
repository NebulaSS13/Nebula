...
/*
var/global/DB_SERVER = "" // This is the location of your MySQL server (localhost is USUALLY fine)
var/global/DB_PORT = 3306 // This is the port your MySQL server is running on (3306 is the default)
*/
...
/DBConnection/proc/SelectDB(database_name,dbi)
	...
	return Connect("[dbi?"[dbi]":"dbi:mysql:[database_name]:[sql_address]:[sql_port]"]",user,password)
