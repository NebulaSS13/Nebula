...
/crew_sensor_modifier/proc/may_process_crew_data(var/mob/living/human/H, var/obj/item/clothing/under/C, var/turf/pos)
	return holder && may_process_proc ? call(holder, may_process_proc)(H, C, pos) : TRUE

/crew_sensor_modifier/proc/process_crew_data(var/mob/living/human/H, var/obj/item/clothing/under/C, var/turf/pos, var/list/crew_data)
