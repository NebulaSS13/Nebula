...
/datum/wires/suit_cycler/CanUse(var/mob/living/L)
...
/datum/wires/suit_cycler/GetInteractWindow(mob/user)
	var/obj/machinery/suit_cycler/S = holder
	. += ..()
...
/datum/wires/suit_cycler/UpdatePulsed(var/index)
	var/obj/machinery/suit_cycler/S = holder
	switch(index)
...
/datum/wires/suit_cycler/UpdateCut(var/index, var/mended)
	var/obj/machinery/suit_cycler/S = holder
	switch(index)
		if(SUIT_STORAGE_WIRE_SAFETY)
			S.safeties = mended
