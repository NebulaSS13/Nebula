...
/datum/extension/storage/slide_projector/remove_from_storage(mob/user, obj/item/W, atom/new_location, NoUpdate)
	. = ..()
...
/datum/extension/storage/slide_projector/handle_item_insertion(mob/user, obj/item/W, atom/new_location, NoUpdate)
	. = ..()
	var/obj/item/slide_projector/projector = holder
