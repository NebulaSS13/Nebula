/datum/trader
	...
	*/
	...
	var/static/list/blacklisted_types = list(
		...
		/obj/item/disk/secret_project = TRADER_BLACKLIST_ALL,
		/obj/item/documents = TRADER_BLACKLIST_ALL,
		/obj/item/drain,
		/obj/item/drill_head,
		/obj/item/ducttape,
		/obj/item/ecletters,
		...
		/obj/item/holder = TRADER_BLACKLIST_ALL,
		/obj/item/holo,
		...
		/obj/item/book/manual = TRADER_BLACKLIST_ALL
	)
