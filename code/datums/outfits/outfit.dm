...
/decl/hierarchy/outfit/proc/equip_id(var/mob/living/equipping, var/rank, var/alt_title, var/datum/job/job)
	if(!id_slot || !id_type)
		return
...
/decl/hierarchy/outfit/proc/equip_pda(var/mob/living/carbon/human/equipping)
