...
/proc/game_log(category, text)
	direct_output(global.world_main_log, "\[[time_stamp_system()]] [game_id] [category]: [text][log_end]")
...
/proc/log_qdel(text)
	to_file(global.world_qdel_log, "\[[time_stamp_system()]\] [global.game_id] QDEL: [text][global.log_end]")
