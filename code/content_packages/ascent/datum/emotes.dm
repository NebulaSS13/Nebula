...
/decl/emote/audible/ascent_purr
	...
	emote_sound = 'code/content_packages/ascent/sounds/ascent1.ogg'

/decl/emote/audible/ascent_hiss
	key ="hiss"
	emote_message_3p = "USER hisses."
	emote_sound = 'code/content_packages/ascent/sounds/razorweb.ogg'

/decl/emote/audible/ascent_snarl
	key = "snarl"
	emote_message_3p = "USER snarls."
	emote_sound = 'code/content_packages/ascent/sounds/razorweb_hiss.ogg'
