/datum/species/mantid
	...
	icobase =                 'code/content_packages/ascent/icons/species/body/alate/body.dmi'
	deform =                  'code/content_packages/ascent/icons/species/body/alate/body.dmi'
	damage_overlays =         'code/content_packages/ascent/icons/species/body/alate/damage_mask.dmi'
	blood_mask =              'code/content_packages/ascent/icons/species/body/alate/blood_mask.dmi'
	organs_icon =             'code/content_packages/ascent/icons/species/body/organs.dmi'
	...
	speech_chance = 100
	speech_sounds = list(
		'code/content_packages/ascent/sounds/ascent1.ogg',
		'code/content_packages/ascent/sounds/ascent2.ogg',
		'code/content_packages/ascent/sounds/ascent3.ogg',
		'code/content_packages/ascent/sounds/ascent4.ogg',
		'code/content_packages/ascent/sounds/ascent5.ogg',
		'code/content_packages/ascent/sounds/ascent6.ogg'
	)
...
/datum/species/mantid/gyne
	...
	genders =                 list(FEMALE)
	icobase =                 'code/content_packages/ascent/icons/species/body/gyne/body.dmi'
	deform =                  'code/content_packages/ascent/icons/species/body/gyne/body.dmi'
	icon_template =           'code/content_packages/ascent/icons/species/body/gyne/template.dmi'
	damage_overlays =         'code/content_packages/ascent/icons/species/body/gyne/damage_mask.dmi'
	blood_mask =              'code/content_packages/ascent/icons/species/body/gyne/blood_mask.dmi'
...
/datum/species/serpentid
	...
	icobase = 'code/content_packages/ascent/icons/species/body/serpentid/body.dmi'
	deform = 'code/content_packages/ascent/icons/species/body/serpentid/body.dmi'
	preview_icon = 'code/content_packages/ascent/icons/species/body/serpentid/preview.dmi'
	blood_mask = 'code/content_packages/ascent/icons/species/body/serpentid/blood_mask.dmi'
	...
	switch(H.skin_state)
		...
		if(SKIN_THREAT)
			...
			if(!threat_image)
				...
				var/icon/I = new('code/content_packages/ascent/icons/species/body/serpentid/threat.dmi', "threat")
