...
// Specifically modern real-world concepts.
/decl/content_package/modern_earth
	credits_adjectives =    list("SOCRATIC")
	credits_holidays =      list("CHRISTMAS", "EASTER", "WEEKEND", "THURSDAY")
	credits_topics =        list("ANCIENT CHINESE MEDICINE", "STRING THEORY")
