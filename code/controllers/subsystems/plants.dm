...
/datum/controller/subsystem/processing/plants/proc/create_random_seed(var/survive_on_station)
	...
	if(survive_on_station)
		...
		if(seed.chems && !isnull(seed.chems[MAT_ACID_POLYTRINIC]))
			seed.chems[MAT_ACID_POLYTRINIC] = null // Eating through the hull will make these plants completely inviable, albeit very dangerous.
