...
/datum/controller/subsystem/processing/plants/proc/create_random_seed(var/survive_on_station)
	...
	if(survive_on_station)
		...
		if(seed.chems && !isnull(seed.chems[/decl/material/chem/acid/polyacid]))
			seed.chems[/decl/material/chem/acid/polyacid] = null // Eating through the hull will make these plants completely inviable, albeit very dangerous.
