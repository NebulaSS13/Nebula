...
/spell/targeted/heal_target/sacrifice
	...
	ability_icon_state = "gen_dissolve"
...
/spell/targeted/revoke
	...
	invocation_type = SpI_SHOUT
	range = 1
	ability_icon_state = "heal_revoke"
