...
/decl/ability/wizard/conjure/cast(list/targets, mob/user)
...
/decl/ability/wizard/conjure/proc/conjure_animation(var/atom/movable/overlay/animation, var/turf/target)
	qdel(animation)

/decl/ability/wizard/conjure/proc/apply_vars(atom/summoned_object, mob/caster)
