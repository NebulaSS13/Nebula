...
/datum/spellbound_type/apprentice
	...
	equipment = list(/obj/item/clothing/head/wizard = slot_head_str,
					...
					/obj/item/staff/crystal = BP_R_HAND,
...
/datum/spellbound_type/servant/overseer
	...
	equipment = list(
		...
		/obj/item/paper/contract/wizard/xray                    = BP_L_HAND,
		/obj/item/paper/contract/wizard/telepathy               = BP_R_HAND
	)
	spells = list(
