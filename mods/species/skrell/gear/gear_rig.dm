...
/obj/item/rig/skrell
	...
	icon = 'mods/species/skrell/icons/rigs/standard/rig.dmi'
...
/obj/item/rig/skrell/eng
	...
	icon = 'mods/species/skrell/icons/rigs/engineering/rig.dmi'
...
/obj/item/clothing/head/helmet/space/rig/skrell/eng
	icon = 'mods/species/skrell/icons/rigs/engineering/helmet.dmi'
/obj/item/clothing/suit/space/rig/skrell/eng
	icon = 'mods/species/skrell/icons/rigs/engineering/chest.dmi'
/obj/item/clothing/shoes/magboots/rig/skrell/eng
	icon = 'mods/species/skrell/icons/rigs/engineering/boots.dmi'
/obj/item/clothing/gloves/rig/skrell/eng
	icon = 'mods/species/skrell/icons/rigs/engineering/gloves.dmi'
...
/obj/item/rig/skrell/med
	...
	icon = 'mods/species/skrell/icons/rigs/medical/rig.dmi'
	initial_modules = list(
		/obj/item/rig_module/vision,
...
/obj/item/clothing/head/helmet/space/rig/skrell/med
	icon = 'mods/species/skrell/icons/rigs/medical/helmet.dmi'
/obj/item/clothing/suit/space/rig/skrell/med
	icon = 'mods/species/skrell/icons/rigs/medical/chest.dmi'
/obj/item/clothing/shoes/magboots/rig/skrell/med
	icon = 'mods/species/skrell/icons/rigs/medical/boots.dmi'
/obj/item/clothing/gloves/rig/skrell/med
	icon = 'mods/species/skrell/icons/rigs/medical/gloves.dmi'
...
/obj/item/rig/skrell/sec
	...
	icon = 'mods/species/skrell/icons/rigs/combat/rig.dmi'
	armor = list(
...
/obj/item/clothing/head/helmet/space/rig/skrell/sec
	icon = 'mods/species/skrell/icons/rigs/combat/helmet.dmi'
/obj/item/clothing/suit/space/rig/skrell/sec
	icon = 'mods/species/skrell/icons/rigs/combat/chest.dmi'
/obj/item/clothing/shoes/magboots/rig/skrell/sec
	icon = 'mods/species/skrell/icons/rigs/combat/boots.dmi'
/obj/item/clothing/gloves/rig/skrell/sec
	icon = 'mods/species/skrell/icons/rigs/combat/gloves.dmi'
...
/obj/item/rig/skrell/cmd
	...
	icon = 'mods/species/skrell/icons/rigs/command/rig.dmi'
	armor = list(
		ARMOR_MELEE = ARMOR_MELEE_MAJOR,
		ARMOR_BULLET = ARMOR_BALLISTIC_AP,
		ARMOR_LASER = ARMOR_LASER_RIFLES,
...
/obj/item/clothing/head/helmet/space/rig/skrell/cmd
	icon = 'mods/species/skrell/icons/rigs/command/helmet.dmi'
/obj/item/clothing/suit/space/rig/skrell/cmd
	icon = 'mods/species/skrell/icons/rigs/command/chest.dmi'
/obj/item/clothing/shoes/magboots/rig/skrell/cmd
	icon = 'mods/species/skrell/icons/rigs/command/boots.dmi'
/obj/item/clothing/gloves/rig/skrell/cmd
	icon = 'mods/species/skrell/icons/rigs/command/gloves.dmi'
...
/obj/item/rig_module/device/welder/skrell
	...
	device = /obj/item/fuelled_tool/welding/electric
	usable = TRUE
	selectable = TRUE