...
/decl/background_detail/heritage/teshari/kamerr
	...
	and often see themselves as superior to teshari who don't share their enthusiasm. \
	Though still treated relatively poorly by the Skrellian caste system, \
	the Ka'merr see integration as the best way for their people to earn \
	the respect of the Skrell and further their place in society."
...
/decl/background_detail/heritage/teshari/autonomist
	...
	if it relies on the 'generosity' of its neighbors. \
	These traditionalist Teshari usually push for the separation of the species, \
	with some going so far as to call for the expulsion of the Skrell from their homeworld. \
	Naturally, Autonomists often lack access to the Skrell's spacefaring technology, \
	and few are both willing and able to venture beyond Sirisai."
...
/decl/background_detail/heritage/teshari/sif
	...
	Though they only make up a small fraction of the planet's overall numbers, \
	Sif is home to one of the largest populations of Teshari outside of skrell space. \
	Sivian teshari tend to veer slightly less traditional than their 'homeworld' counterparts, \
	integrating more with the local 'human' Sivian culture of rugged self-sufficiency and distrust of authority."
...
/decl/background_detail/heritage/teshari/spacer
	...
	Uniquely truly independent of Skrell society, \
	Teshari Spacers usually struggle with lack of access to specialist technology for their people, \
	and are often the ones to provide it to others. \
	Most are still fiercely mutualist, and share many traits with Pack Teshari."
	economic_power = 0.8
