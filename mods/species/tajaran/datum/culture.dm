...
/decl/background_detail/heritage/tajaran
	...
	are based on strong traditions and ideals, and the patchwork of nations and city-states that make up their lands often \
...
/decl/background_detail/heritage/tajaran/njarir
	...
	around generosity, individual heroism, pride, and feuds. In the past, Njarjirii were THE Tajaran trader-explorers, and their \
	shipping routes knitted the islands and coastal settlements of both continents together. They are governed by a \"House\" \
	to each island, and although they feud, form, and break alliances, they resist outside hostilities fiercely as a united front. \
	Njarjirii are proud of their freedom, and historically very hostile to anything they might see as slavery as they regard \
	personal freedom as given."
	language = /decl/language/tajaranakhani
	secondary_langs = list(
...
/decl/background_detail/heritage/tajaran/rhemazar
	...
	tribe in favour of a more conventionally structured society, though they may risk ostracism depending on the tribe they left, \
	and who they left it for. Regardless, the Rhemazar Federation stands strong, contending culturally and industrially with the \
	various Hrararan nations that surround them."
	economic_power = 0.9
...
/decl/background_detail/heritage/tajaran/spacer
	...
	upbringing among the challenges of space travel that can sometimes put them at odds with the dynamics of more conventional \
	terrestrial life."
	economic_power = 0.9
