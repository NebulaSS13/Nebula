...
/obj/item/organ/internal/controller/replace_organ(mob/living/carbon/human/target, obj/item/organ/external/affected)
	. = ..()
	if(. && owner)
		owner.add_language(/decl/language/mantid/worldnet)

/obj/item/organ/internal/controller/remove_organ(mob/living/user, drop_organ, detach)
