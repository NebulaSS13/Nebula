...
/decl/ghosttrap/kharmaani_egg/forced(var/mob/user)
	request_player(new /mob/living/alien/ascent_nymph(get_turf(user)), "A mantid nymph is ready to hatch and needs a player.")
...
/obj/structure/insectoid_egg/proc/hatch(var/client/C)
	...
	var/mob/living/alien/ascent_nymph/new_nymph = new(src, SPECIES_MANTID_NYMPH) // Spawn in the egg.
