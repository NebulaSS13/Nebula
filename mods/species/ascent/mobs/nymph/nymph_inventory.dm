/mob/living/alien/ascent_nymph/drop_from_inventory(var/obj/item/I)
	. = ..()
	if(I == holding_item)
		holding_item = null

/mob/living/alien/ascent_nymph/put_in_hands(var/obj/item/W) // No hands. Use mouth.
	if(can_collect(W))
		collect(W)
	else
...
/mob/living/alien/ascent_nymph/hotkey_drop()
	if(holding_item)
		drop_item()
	else
		to_chat(usr, SPAN_WARNING("You have nothing to drop."))

/mob/living/alien/ascent_nymph/proc/can_collect(var/obj/item/collecting)
	return (!holding_item && \
		istype(collecting) && \
		collecting.loc != src && \
		!collecting.anchored && \
...
/mob/living/alien/ascent_nymph/proc/contains_crystals(var/obj/item/W)
...
/mob/living/alien/ascent_nymph/proc/collect(var/obj/item/collecting)
...
/mob/living/alien/ascent_nymph/verb/drop_item_verb()
...
/mob/living/alien/ascent_nymph/drop_item()
