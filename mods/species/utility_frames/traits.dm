/decl/trait/build_references()
	...
	LAZYDISTINCTADD(blocked_species, /decl/species/utility_frame/positronic::uid)
...
/decl/trait/utility_frame/build_references()
	...
	permitted_species = list(/decl/species/utility_frame::uid, /decl/species/utility_frame/positronic::uid)
