/mob/living/simple_animal/borer
	...
	var/static/list/chemical_types = list(
		"anti-trauma" = /decl/material/brute_meds,
		"amphetamines" =  /decl/material/amphetamines,
		"painkillers" = /decl/material/painkillers
	)
...
/mob/living/simple_animal/borer/Life()
	...
	if(host)
		...
		if(!stat && !host.stat)
			...
			if(host.reagents.has_reagent(/decl/material/nutriment/sugar))
				if(!docile)
					if(controlling)
