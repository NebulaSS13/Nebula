...
/mob/living/alien/diona/get_jump_distance()
	return 3

/mob/living/alien/diona/Login()
	. = ..()
	if(client)
		if(holding_item)
...
/mob/living/alien/diona/sterile
	name = "sterile nymph"

/mob/living/alien/diona/sterile/Initialize(var/mapload)
	. = ..(mapload, 0)

/mob/living/alien/diona/Initialize(var/mapload, var/flower_chance = 15)
...
/mob/living/alien/diona/show_examined_worn_held_items(mob/user, distance, infix, suffix, hideflags, decl/pronouns/pronouns)
	. = ..()
	if(holding_item)
...
/mob/living/alien/diona/has_dexterity()
	return FALSE