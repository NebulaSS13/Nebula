...
/mob/living/carbon/alien/diona/proc/handle_tray_interaction(var/obj/machinery/portable_atmospherics/hydroponics/tray)
	...
	if(tray.dead)
		if(tray.remove_dead(src, silent = TRUE))
			reagents.add_reagent_by_id(/decl/material/liquid/nutriment/glucose, rand(10,20))
	...
	if(tray.weedlevel || tray.pestlevel)
		reagents.add_reagent_by_id(/decl/material/liquid/nutriment/glucose, (tray.weedlevel + tray.pestlevel))
		tray.weedlevel = 0
		tray.pestlevel = 0
