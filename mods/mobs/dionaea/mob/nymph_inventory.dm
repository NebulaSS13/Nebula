/mob/living/simple_animal/alien/diona/drop_from_inventory(var/obj/item/I)
	. = ..()
	if(I == holding_item)
		holding_item = null

/mob/living/simple_animal/alien/diona/put_in_hands(var/obj/item/W) // No hands. Use mouth.
	if(can_collect(W))
		collect(W)
		return TRUE
...
/mob/living/simple_animal/alien/diona/proc/can_collect(var/obj/item/collecting)
...
/mob/living/simple_animal/alien/diona/proc/collect(var/obj/item/collecting)
...
/mob/living/simple_animal/alien/diona/verb/drop_item_verb()
...
/mob/living/simple_animal/alien/diona/drop_item()
...
/mob/living/simple_animal/alien/diona/item_should_have_screen_presence(obj/item/item, slot)
