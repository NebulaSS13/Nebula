...
#define BODY_FLAG_KOBALOI BITFLAG(9)
#define BODY_FLAG_HNOLL   BITFLAG(10)
#define BODY_FLAG_DVERGR  BITFLAG(11)

/decl/modpack/fantasy_species
	name = "Fantasy Species Content"
