...
/obj/item/clothing/suit/toggle/labcoat/rd/corp
	name = "\improper EXO research director's labcoat"
	markings_color = COLOR_BOTTLE_GREEN

/obj/item/clothing/suit/toggle/labcoat/rd/corp/nanotrasen
	name = "\improper NT research director's labcoat"
	markings_color = COLOR_NT_RED

/obj/item/clothing/suit/toggle/labcoat/rd/corp/heph
	name = "\improper HI research director's labcoat"
	markings_color = COLOR_LUMINOL

/obj/item/clothing/suit/toggle/labcoat/rd/corp/zeng
	name = "\improper Z-H research director's labcoat"
	markings_color = COLOR_PALE_YELLOW

/obj/item/clothing/suit/toggle/labcoat/science/corp/nanotrasen
	name = "\improper NanoTrasen labcoat"
	markings_color = COLOR_NT_RED

/obj/item/clothing/suit/toggle/labcoat/science/corp/heph
	name = "\improper Hephaestus Industries labcoat"
	markings_color = COLOR_LUMINOL

/obj/item/clothing/suit/toggle/labcoat/science/corp/zeng
	name = "\improper Zeng-Hu labcoat"
	markings_color = COLOR_PALE_YELLOW

/obj/item/clothing/suit/toggle/labcoat/science/corp/morpheus
	name = "\improper Morpheus Cyberkinetics labcoat"
	markings_color = COLOR_SILVER

/obj/item/clothing/suit/toggle/labcoat/science/corp/dais
