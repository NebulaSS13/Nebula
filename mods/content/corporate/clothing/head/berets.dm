...
/obj/item/clothing/head/beret/corp/sec/navy/officer
	...
	icon = 'mods/content/corporate/icons/clothing/head/beret/officer_navy.dmi'
/obj/item/clothing/head/beret/corp/sec/navy/hos
	...
	icon = 'mods/content/corporate/icons/clothing/head/beret/hos_navy.dmi'
/obj/item/clothing/head/beret/corp/sec/navy/warden
	name = "corporate security warden beret"
	desc = "A navy blue beret with a warden's rank emblem. For officers that are more inclined towards style than safety."
	icon = 'mods/content/corporate/icons/clothing/head/beret/warden_navy.dmi'
/obj/item/clothing/head/beret/corp/sec/corporate/officer
	...
	icon = 'mods/content/corporate/icons/clothing/head/beret/officer.dmi'
/obj/item/clothing/head/beret/corp/sec/corporate/hos
	...
	icon = 'mods/content/corporate/icons/clothing/head/beret/hos.dmi'
/obj/item/clothing/head/beret/corp/sec/corporate/warden
	...
	icon = 'mods/content/corporate/icons/clothing/head/beret/warden.dmi'
/obj/item/clothing/head/beret/corp/centcom/officer
	...
	icon = 'mods/content/corporate/icons/clothing/head/beret/navy.dmi'
/obj/item/clothing/head/beret/corp/centcom/captain
	...
	icon = 'mods/content/corporate/icons/clothing/head/beret/white.dmi'
