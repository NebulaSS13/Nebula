...
/obj/random/sif/spawn_choices()
	var/static/list/spawn_choices = list(
		...
		/mob/living/simple_animal/fowl/crystal_duck       = 15,
		...
		/mob/living/simple_animal/crab/sif/hooligan       = 5,
...
/obj/random/sif/aquatic
	...
	icon = /mob/living/simple_animal/crab/sif::icon
	icon_state = /mob/living/simple_animal/crab/sif::icon_state

/obj/random/sif/aquatic/spawn_choices()
	var/static/list/spawn_choices = list(
		/mob/living/simple_animal/crab/sif             = 30,
		/mob/living/simple_animal/fowl/crystal_duck    = 25,
