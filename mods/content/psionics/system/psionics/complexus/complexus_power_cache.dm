/datum/ability_handler/psionics/proc/rebuild_power_cache()
...
/datum/ability_handler/psionics/proc/get_powers_by_faculty(var/faculty)
	rebuild_power_cache()
	return powers_by_faculty[faculty]

/datum/ability_handler/psionics/proc/get_melee_powers(var/faculty)
	rebuild_power_cache()
	return melee_powers[faculty]

/datum/ability_handler/psionics/proc/get_ranged_powers(var/faculty)
	rebuild_power_cache()
	return ranged_powers[faculty]

/datum/ability_handler/psionics/proc/get_grab_powers(var/faculty)
	rebuild_power_cache()
	return grab_powers[faculty]

/datum/ability_handler/psionics/proc/get_manifestations()
	rebuild_power_cache()
