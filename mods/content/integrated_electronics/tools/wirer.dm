...
/obj/item/wirer/on_update_icon()
	. = ..()
	icon_state = "wirer-[mode]"

/obj/item/wirer/proc/wire(var/datum/integrated_io/io, mob/user)
...
/obj/item/wirer/proc/select_io(datum/integrated_io/io)
	if(selected_io)
		unselect_io(selected_io)
	selected_io = io
...
/obj/item/wirer/proc/unselect_io(datum/integrated_io/io)
	if(selected_io != io)
		return
...
/obj/item/wirer/attack_self(mob/user)
	switch(mode)
		if(WIRE)
			mode = UNWIRE
		if(WIRING)
