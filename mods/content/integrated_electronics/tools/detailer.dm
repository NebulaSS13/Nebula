...
/obj/item/detailer/Initialize()
	.=..()
	update_icon()

/obj/item/detailer/on_update_icon()
	. = ..()
	add_overlay(overlay_image('icons/obj/assemblies/electronic_tools.dmi', "detailer-color", detail_color))

/obj/item/detailer/attack_self(mob/user)
...
/obj/item/detailer/afterattack(atom/target, mob/living/user, proximity)
	. = ..()
...
/obj/item/detailer/get_assembly_detail_color()
	return detail_color
